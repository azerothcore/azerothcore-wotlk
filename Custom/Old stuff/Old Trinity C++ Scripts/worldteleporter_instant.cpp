...
class npc_worldteleporter_instant : public CreatureScript
{
public:
    npc_worldteleporter_instant() : CreatureScript("npc_worldteleporter_instant") { }
	...
	bool OnGossipHello(Player *player, Creature *pCreature)
	{
		if ( player->GetTeam() == ALLIANCE ) // Allianz
		{
			...
			//AddGossipItemFor(player,(GOSSIP_ICON_BATTLE, "[Hinterland Schlachtfeld]"    , GOSSIP_SENDER_MAIN, 12360);
			AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[Pet-Area]"    , GOSSIP_SENDER_MAIN, 12362);
			//AddGossipItemFor(player,7, "Battlegrounds and Arenas"   , GOSSIP_SENDER_MAIN, 5575);
			//AddGossipItemFor(player,(GOSSIP_ICON_BATTLE, "[Schwarzfelsabstieg]", GOSSIP_SENDER_MAIN, 2002);	
		}
		else // Horde
		{
			...
			//AddGossipItemFor(player,(GOSSIP_ICON_BATTLE, "[Hinterland Schlachtfeld]"    , GOSSIP_SENDER_MAIN, 12361);
			AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[Pet-Area]"    , GOSSIP_SENDER_MAIN, 12363);
			//AddGossipItemFor(player,7, "Battlegrounds and Arenen"   , GOSSIP_SENDER_MAIN, 5575);
			//AddGossipItemFor(player,(GOSSIP_ICON_BATTLE, "[Schwarzfelsabstieg]", GOSSIP_SENDER_MAIN, 2002);	
		}		
		AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[PvP-Arena]"      , GOSSIP_SENDER_MAIN, 4015);
		//AddGossipItemFor(player,(GOSSIP_ICON_BATTLE, "[Baradinfestung]", GOSSIP_SENDER_MAIN, 8100);
		//AddGossipItemFor(player,(GOSSIP_ICON_BATTLE, "[Bastion des Zwielichts]", GOSSIP_SENDER_MAIN, 4324);		
	...
	void SendDefaultMenu(Player *player, Creature *pCreature, uint32 action )
	{
		...
		if(!player->getAttackers().empty())
		{
			...
			pCreature->Say("Beende erst deinen Kampf, Feigling", LANG_UNIVERSAL, NULL);
			return;
		}
		...
		switch(action)
		{
			...
			case 5570: // Instanzen 70+
			  ...
			  AddGossipItemFor(player,5, "Hoellenfeuer Zitadelle"   , GOSSIP_SENDER_MAIN, 4009);
			  ...
			  AddGossipItemFor(player,5, "Auchidoun"      		  , GOSSIP_SENDER_MAIN, 4084);
			...
			case 5553: //Raids 80+
			  AddGossipItemFor(player,5, "Naxxaramas"                , GOSSIP_SENDER_MAIN, 4006);
			  AddGossipItemFor(player,5, "Auge der Ewigkeit"         , GOSSIP_SENDER_MAIN, 4031);
			  AddGossipItemFor(player,5, "Obsidian Sanktum"          , GOSSIP_SENDER_MAIN, 4032);
			...
			case 5552: //Zurueck zum Hauptmenue
				...
				else // Horde
				{
					...
					AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[Pet-Area]"    , GOSSIP_SENDER_MAIN, 12363);
					//AddGossipItemFor(player,7, "Battlegrounds and Arenen"     , GOSSIP_SENDER_MAIN, 5575);
					//AddGossipItemFor(player,(GOSSIP_ICON_BATTLE, "[Schwarzfelsabstieg]", GOSSIP_SENDER_MAIN, 3002);	
					}				
				AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[PvP-Arena]"      , GOSSIP_SENDER_MAIN, 4015);
				//AddGossipItemFor(player,(GOSSIP_ICON_BATTLE, "[Baradinfestung]", GOSSIP_SENDER_MAIN, 8100);
				//AddGossipItemFor(player,(GOSSIP_ICON_BATTLE, "[Bastion des Zwielichts]", GOSSIP_SENDER_MAIN, 4324);		
			...
			case 5575: // BG's und Arenen
			  ...
			  AddGossipItemFor(player,5, "PvP-Arena"               , GOSSIP_SENDER_MAIN, 4015);
			...
			case 1234: //Playertreff Allianz
			  ...
			  AddGossipItemFor(player,5, "S8/T10,5"                , GOSSIP_SENDER_MAIN, 12343);
			  AddGossipItemFor(player,5, "Startgear+ Enhancements" , GOSSIP_SENDER_MAIN, 12344);
			  AddGossipItemFor(player,7, "<- [Hauptmenu]"            , GOSSIP_SENDER_MAIN, 5552);
			...
			case 1235: //Playertreff Horde
			  ...
			  AddGossipItemFor(player,5, "S8/T10,5"                , GOSSIP_SENDER_MAIN, 12353);
			  AddGossipItemFor(player,5, "Startgear +  Enhancements" , GOSSIP_SENDER_MAIN, 12354);
			  AddGossipItemFor(player,7, "<- [Hauptmenu]"            , GOSSIP_SENDER_MAIN, 5552);
			...
			case 4015:// Gurubashi
			  CloseGossipMenuFor(player);
			  player->TeleportTo(0, -13307.272461, 129.812378, 26.789516, 4.221101);
			break;
			...
			case 12340: //Playertreff Allianz
				CloseGossipMenuFor(player);
				player->TeleportTo(1, 9714.254883f, 2525.827881f, 1335.687134f, 3.145359f);			
			break;
			
			case 12341: //Playertreff Lehrer
				CloseGossipMenuFor(player);
				player->TeleportTo(1, 9634.741211f, 2482.915527f, 1354.810669f, 1.675430f); 		
			break;

			case 12342: //Playertreff Berufe
				CloseGossipMenuFor(player);
				player->TeleportTo(1, 9628.936523f, 2482.004395f, 1334.570801f, 4.530354f); 		
			break;

			case 12343: //Playertreff Enhancements und Gems
				CloseGossipMenuFor(player);
				player->TeleportTo(1, 9629.376953f, 2569.712402f, 1354.809814f, 4.903418f);	 		
			break;

			case 12344: //Playertreff Ausrüstung
				CloseGossipMenuFor(player);
				player->TeleportTo(1, 9677.166992f, 2525.432861f, 1360.000244f, 3.195176f);			
			break;
			...
			case 4322: //Chillplatz
				CloseGossipMenuFor(player);
				player->TeleportTo(1, -13306.932617f, 129.970291f, 26.943171f, 4.272948f);
			break;
...
void AddSC_npc_worldteleporter_instant()
{
    new npc_worldteleporter_instant();
}
