...
class npc_worldteleporter_kastal : public CreatureScript
{
public:
    npc_worldteleporter_kastal() : CreatureScript("npc_worldteleporter_kastal") { }
	...
	bool OnGossipHello(Player *player, Creature *pCreature)
	{
		if ( player->GetTeam() == ALLIANCE ) // Allianz
		{
			...
			AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[-Custom- Raid 0.5 Instanz]"    , GOSSIP_SENDER_MAIN, 12360);
			AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[-Custom- Raid 1 Instanz]"    , GOSSIP_SENDER_MAIN, 12362);
		...
		else // Horde
		{
			...
			AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[-Custom- Raid 1 Instanz]"    , GOSSIP_SENDER_MAIN, 12361);
			AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[-Custom- Raid 0,5 Instanz]"    , GOSSIP_SENDER_MAIN, 12363);
		...
		switch(action)
		{
			...
			case 5552: //Zurueck zum Hauptmenue
				if ( player->GetTeam() == ALLIANCE ) // Allianz
				{
					...
					AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[Playertreff]"    , GOSSIP_SENDER_MAIN, 1234);
					AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[-Custom- Raid 0.5 Instanz]"    , GOSSIP_SENDER_MAIN, 12360);
					AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[-Custom- Raid 0.5 Instanz]"    , GOSSIP_SENDER_MAIN, 12362);
					//AddGossipItemFor(player, 7, "Battlegrounds and Arenas"     , GOSSIP_SENDER_MAIN, 5575);
					//AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[Schwarzfelsabstieg]", GOSSIP_SENDER_MAIN, 2002);	
				}
				else // Horde
				{
					...
					AddGossipItemFor(player, 7, "[Instanzen WOTLK ] ->"      , GOSSIP_SENDER_MAIN, 5571);
					AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[Playertreff]"    , GOSSIP_SENDER_MAIN, 1235);
					AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[-Custom- Raid 0.5 Instanz]"    , GOSSIP_SENDER_MAIN, 12361);
					AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[-Custom- Raid 0.5 Instanz]"    , GOSSIP_SENDER_MAIN, 12363);
					//AddGossipItemFor(player, 7, "Battlegrounds and Arenen"     , GOSSIP_SENDER_MAIN, 5575);
			...
			case 1234: //Playertreff Allianz
			  ...
			  AddGossipItemFor(player, 5, "Edelteine"                , GOSSIP_SENDER_MAIN, 12343);
			...
			case 1235: //Playertreff Horde
			  ...
			  AddGossipItemFor(player, 5, "Edelsteine"                , GOSSIP_SENDER_MAIN, 12353);
			...
			case 12340: //Playertreff Allianz
				CloseGossipMenuFor(player);
				player->TeleportTo(1, -8024.043457, -5252.437012, 0.587054, 3.658875 );			
			break;
			
			case 12341: //Playertreff Lehrer
				CloseGossipMenuFor(player);
				player->TeleportTo(1, -8050.373047, -5325.227051,  8.178234, 5.398534 ); 		
			break;

			case 12342: //Playertreff Berufe
				CloseGossipMenuFor(player);
				player->TeleportTo(1, -8033.976074 , -5358.941406,  0.993929, 0.878572 ); 		
			break;

			case 12343: //Playertreff Enhancements und Gems
				CloseGossipMenuFor(player);
				player->TeleportTo(1,  -8006.767090, -5203.180664, 4.870582, 4.562088 );		 		
			break;

			case 12344: //Playertreff Ausrüstung
				CloseGossipMenuFor(player);
				player->TeleportTo(1, -8028.777832, -5228.166504, 1.998839, 2.013464 );			
			break;
			...
			case 12360: //Hinterland Allianz
				CloseGossipMenuFor(player);
				player->TeleportTo(530, 6851.779785, -7972.569824, 184.170013, 4.646910); 		
			break;

			case 12361: //Hinterland Horde
				CloseGossipMenuFor(player);
				player->TeleportTo(530, 6851.779785f, -7972.569824f, 184.170013f, 4.646910f);
			break;

			case 12362: //Petarea Alli
				CloseGossipMenuFor(player);
				player->TeleportTo(429, -90.7322f, 46.8737f, 6.77577f,  6.77577f); 		
			break;
...
void AddSC_npc_worldteleporter_kastal()
{
    new npc_worldteleporter_kastal();
}
