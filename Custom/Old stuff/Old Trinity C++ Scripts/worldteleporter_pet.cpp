...
class npc_worldteleporter_pet : public CreatureScript
{
public:
    npc_worldteleporter_pet() : CreatureScript("npc_worldteleporter_pet") { }
	...
	bool OnGossipHello(Player *player, Creature *pCreature)
	{
		if ( player->GetTeam() == ALLIANCE ) // Allianz
		{
			...
			//AddGossipItemFor(pPlayer,GOSSIP_ICON_BATTLE, "[Hinterland Schlachtfeld]"    , GOSSIP_SENDER_MAIN, 12360);
			//AddGossipItemFor(pPlayer,GOSSIP_ICON_BATTLE, "[Pet-Area]"    , GOSSIP_SENDER_MAIN, 12362);
			//AddGossipItemFor(player,7, "[Duell-Platz]"   , GOSSIP_SENDER_MAIN, 5575);
			AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[Duell-Platz]", GOSSIP_SENDER_MAIN, 2002);	
		}
		else // Horde
		{
			...
			//AddGossipItemFor(pPlayer,GOSSIP_ICON_BATTLE, "[Hinterland Schlachtfeld]"    , GOSSIP_SENDER_MAIN, 12361);
			//AddGossipItemFor(pPlayer,GOSSIP_ICON_BATTLE, "[Pet-Area]"    , GOSSIP_SENDER_MAIN, 12363);
		...
		//AddGossipItemFor(pPlayer,GOSSIP_ICON_BATTLE, "[Baradinfestung]", GOSSIP_SENDER_MAIN, 8100);
		//AddGossipItemFor(pPlayer,GOSSIP_ICON_BATTLE, "[Duell-Platz]", GOSSIP_SENDER_MAIN, 4324);		
		...
		switch(action)
		{
			...
			case 5552: //Zurueck zum Hauptmenue
				...
				else // Horde
				{
					...
					//AddGossipItemFor(player,7, "Battlegrounds and Arenen"     , GOSSIP_SENDER_MAIN, 5575);
					AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[Duell-Platz]", GOSSIP_SENDER_MAIN, 3002);	
					}				
				AddGossipItemFor(player,GOSSIP_ICON_BATTLE, "[PvP-Arena]"      , GOSSIP_SENDER_MAIN, 4015);
				//AddGossipItemFor(pPlayer,GOSSIP_ICON_BATTLE, "[Baradinfestung]", GOSSIP_SENDER_MAIN, 8100);
				//AddGossipItemFor(pPlayer,GOSSIP_ICON_BATTLE, "[Bastion des Zwielichts]", GOSSIP_SENDER_MAIN, 4324);		
				//AddGossipItemFor(player,7, "[Markenbox]"      , GOSSIP_SENDER_MAIN, 8015);
				SendGossipMenuFor(player,DEFAULT_GOSSIP_MESSAGE,pCreature->GetGUID());
			...
			case 12340: //Playertreff Allianz
				CloseGossipMenuFor(player);
				player->TeleportTo(1, 9714.254883, 2525.827881, 1335.687134, 3.145359 );			
			break;
			
			case 12341: //Playertreff Lehrer
				CloseGossipMenuFor(player);
				player->TeleportTo(1, 9634.741211, 2482.915527, 1354.810669, 1.675430 ); 		
			break;

			case 12342: //Playertreff Berufe
				CloseGossipMenuFor(player);
				player->TeleportTo(1, 9628.936523, 2482.004395, 1334.570801, 4.530354 ); 		
			break;

			case 12343: //Playertreff Enhancements und Gems
				CloseGossipMenuFor(player);
				player->TeleportTo(1, 9629.376953, 2569.712402, 1354.809814, 4.903418 );	 		
			break;

			case 12344: //Playertreff Ausrüstung
				CloseGossipMenuFor(player);
				player->TeleportTo(1, 9677.166992, 2525.432861, 1360.000244, 3.195176 );			
			break;
			...
			case 4322: //Chillplatz
				CloseGossipMenuFor(player);
				player->TeleportTo(1, -13306.932617, 129.970291, 26.943171, 4.272948);
			break;
			
			case 2002: //Schwarzfelsabstieg
				CloseGossipMenuFor(player);
				player->TeleportTo(0, -5311.540039, 151.080002, 389.920013, 5.869530);
			break;
...
void AddSC_npc_worldteleporter_pet()
{
    new npc_worldteleporter_pet();
}
