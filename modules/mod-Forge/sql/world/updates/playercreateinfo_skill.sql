TRUNCATE acore_world.playercreateinfo_skills;
INSERT INTO acore_world.playercreateinfo_skills (raceMask,classMask,skill,`rank`,comment) VALUES
	 (0,0,95,0,'Defense'),
	 (0,0,162,0,'Unarmed'),
...
INSERT INTO acore_world.playercreateinfo_skills (raceMask,classMask,skill,`rank`,comment) VALUES
	 ...
	 (735,1501,173,0,'Daggers'),
	 (1024,0,759,0,'Language: Draenei'),
	 (1024,4,226,0,'Crossbows'),
	 (1061,1123,160,0,'Two-Handed Maces'),
