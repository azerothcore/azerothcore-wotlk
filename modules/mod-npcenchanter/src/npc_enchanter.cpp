...
class npc_enchantment_world : public WorldScript
{
public:
	npc_enchantment_world() : WorldScript("npc_enchantment_world") { }

	void OnBeforeConfigLoad(bool reload) override
	{
		if (!reload) {
			std::string conf_path = _CONF_DIR;
			std::string cfg_file = conf_path + "Settings/modules/npc_enchanter.conf";
#ifdef WIN32
			cfg_file = "Settings/modules/npc_enchanter.conf";
#endif
