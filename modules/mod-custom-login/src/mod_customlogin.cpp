    ...
    void OnFirstLogin(Player* player)
    {
        ...
        if (LoginEnable)
        {
            ...
            if (LoginSkills)
            {
                ...
                case CLASS_PALADIN:
                    player->learnSpell(31700);    // 2H Mace
                    break;
    ...
    void OnLogin(Player* player)
    {
        ...
        if (LoginEnable)
        {
            ...
            if (LoginPlayerAnnounce)
            {
                ...
                {
                    std::ostringstream ss;
                    ss << "|cffFFFFFF[|cff2897FF Альянс |cffFFFFFF]:|cff4CFF00 " << player->GetName() << "|cffFFFFFF В игре.";
                    sWorld->SendServerMessage(SERVER_MSG_STRING, ss.str().c_str());
                }
                else
                {
                    std::ostringstream ss;
                    ss << "|cffFFFFFF[|cffFF0000 Орда |cffFFFFFF]:|cff4CFF00 " << player->GetName() << "|cffFFFFFF В игре.";
                    sWorld->SendServerMessage(SERVER_MSG_STRING, ss.str().c_str());
                }
            }
        }
    ...
    void OnLogout(Player *player)
    {
        if (LoginEnable)
        {
            ...
            if (LoginPlayerAnnounce)
            {
                ...
                {
                    std::ostringstream ss;
                    ss << "|cffFFFFFF[|cff2897FF Альянс |cffFFFFFF]|cff4CFF00 " << player->GetName() << "|cffFFFFFF вышел из игры.";
                    sWorld->SendServerMessage(SERVER_MSG_STRING, ss.str().c_str());
                }
                else
                {
                    std::ostringstream ss;
                    ss << "|cffFFFFFF[|cffFF0000 Орда |cffFFFFFF]|cff4CFF00 " << player->GetName() << "|cffFFFFFF вышел из игры.";
                    sWorld->SendServerMessage(SERVER_MSG_STRING, ss.str().c_str());
                }
            }
        }
