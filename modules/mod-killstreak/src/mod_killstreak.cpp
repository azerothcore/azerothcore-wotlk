...
class KillstreakWorld : public WorldScript
{
public:
	KillstreakWorld() : WorldScript("KillstreakWorld") { }

	void OnBeforeConfigLoad(bool reload) override
	{
		if (!reload) {
			std::string conf_path = _CONF_DIR;
			std::string cfg_file = conf_path + "Settings/modules/mod_killstreak.conf";
#ifdef WIN32
			cfg_file = "Settings/modules/mod_killstreak.conf";
#endif
...
void AddKillstreakSystemScripts()
{
	new KillstreakWorld;
