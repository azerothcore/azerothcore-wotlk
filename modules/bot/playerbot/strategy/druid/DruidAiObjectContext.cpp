...
{
    strategyContexts.Add(new BotAI::druid::StrategyFactoryInternal());
    strategyContexts.Add(new BotAI::druid::DruidStrategyFactoryInternal());
    actionContexts.Add(new BotAI::druid::AiObjectContextInternal());
    triggerContexts.Add(new BotAI::druid::TriggerFactoryInternal());
}
