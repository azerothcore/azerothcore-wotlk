...
{
    strategyContexts.Add(new BotAI::DK::StrategyFactoryInternal());
    strategyContexts.Add(new BotAI::DK::CombatStrategyFactoryInternal());
    strategyContexts.Add(new BotAI::DK::DKBuffStrategyFactoryInternal());
    actionContexts.Add(new BotAI::DK::AiObjectContextInternal());
    triggerContexts.Add(new BotAI::DK::TriggerFactoryInternal());
}
