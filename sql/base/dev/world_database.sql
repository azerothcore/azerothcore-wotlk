...
MySQL - 5.6.24 : Database - world335
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`world335` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1977345 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
...
CREATE TABLE `world_db_version` (
  `2016_07_14_00` bit(1) DEFAULT NULL
