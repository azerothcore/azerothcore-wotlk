...
void CreatureTextMgr::LoadCreatureTexts()
{
	...
	do
	{
		...
		if (temp.BroadcastTextId)
		{
			...
			{
				sLog->outErrorDb("sql.sql", "CreatureTextMgr: Entry %u, Group %u, Id %u in table `creature_text` has non-existing or incompatible BroadcastTextId %u.", temp.entry, temp.group, temp.id, temp.BroadcastTextId);
