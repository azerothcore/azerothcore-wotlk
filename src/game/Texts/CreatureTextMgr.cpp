...
void CreatureTextMgr::LoadCreatureTexts()
{
    ...
    do
    {
        ...
        if (temp.BroadcastTextId)
        {
            ...
            {
                sLog->outErrorDb("CreatureTextMgr: Entry %u, Group %u, Id %u in table `creature_texts` has non-existing or incompatible BroadcastTextId %u.", temp.entry, temp.group, temp.id, temp.BroadcastTextId);
