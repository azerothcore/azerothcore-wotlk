 ...
 * @brief Comprehensive data-driven tests for ALL 868 spell_proc entries
 *
...
// =============================================================================
// Comprehensive Tests for All 868 Entries
// =============================================================================

TEST_F(SpellProcDatabaseTest, AllEntriesLoaded)
{
    EXPECT_EQ(_allEntries.size(), 868u) << "Should have all 868 spell_proc entries loaded";
}
