...
#ifndef _WORLDSERVER_CONFIG
# define _WORLDSERVER_CONFIG  "worldserver.conf"
#endif
...
extern int main(int argc, char** argv)
{
    ...
    char const* cfg_file = _WORLDSERVER_CONFIG;
    int c = 1;
    while (c < argc)
    {
    ...
    std::string cfg_def_file=_WORLDSERVER_CONFIG;
    cfg_def_file += ".dist";
