...
void ScriptMgr::OnPlayerUnequip(Player* player, Item* it/*uint8 bag, uint8 slot*/)
{
	CALL_ENABLED_HOOKS(PlayerScript, PLAYERHOOK_ON_UNEQUIP, script->OnPlayerUnequip(player, it/*, bag, slot*/));
}
