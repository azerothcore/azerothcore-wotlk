...
public:
    ...
    virtual void OnSocketOpen(std::shared_ptr<WowConnection> /*socket*/) { }

    // Called when a socket is closed. Do not store the socket object, and do not rely on the connection
    // being open; it is not.
    virtual void OnSocketClose(std::shared_ptr<WowConnection> /*socket*/) { }
     ...
     */
    [[nodiscard]] virtual bool CanPacketSend(User* /*session*/, WDataStore& /*packet*/) { return true; }
     ...
     */
    [[nodiscard]] virtual bool CanPacketReceive(User* /*session*/, WDataStore& /*packet*/) { return true; }
};
