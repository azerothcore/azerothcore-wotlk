...
bool ScriptMgr::CanTryExecuteCommand(ChatHandler& handler, std::string_view cmdStr)
{
    CALL_ENABLED_BOOLEAN_HOOKS(AllCommandScript, ALLCOMMANDHOOK_CAN_TRY_EXECUTE_COMMAND, !script->CanTryExecuteCommand(handler, cmdStr));
}
