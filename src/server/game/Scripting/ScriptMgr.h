...
public: /* Initialization */
    ...
    [[nodiscard]] std::string_view ScriptsVersion() const { return "Integrated Azeroth Scripts"; }
    ...
    [[nodiscard]] std::string_view GetCurrentScriptContext() const;
    ...
    static void ReleaseScriptContext(std::string_view context);
    ...
    [[nodiscard]] std::shared_ptr<ModuleReference> AcquireModuleReferenceOfScriptName(std::string_view scriptname) const;
