...
public:
    ...
    // Check is it possible to send an annotation at join arena
    [[nodiscard]] virtual bool CanSendJoinMessageArenaQueue(BattlegroundQueue* /*queue*/, Player* /*leader*/, GroupQueueInfo* /*ginfo*/, PvPDifficultyEntry const* /*bracketEntry*/, bool /*isRated*/) { return true; }

    // Check is it possible to send an annotation at exit arena
    [[nodiscard]] virtual bool CanSendExitMessageArenaQueue(BattlegroundQueue* /*queue*/, GroupQueueInfo* /*ginfo*/) { return true; }
};
...
public: /* BGScript */
    ...
    bool CanSendExitMessageArenaQueue(BattlegroundQueue* queue, GroupQueueInfo* ginfo);
