...
public:
    ...
    virtual bool OnIsAffectedBySpellModCheck(SpellInfo const* /*affectSpell*/, SpellModifier const* /*mod*/) { return true; };
};
...
public: /* GlobalScript */
    ...
    bool OnIsAffectedBySpellModCheck(SpellInfo const* affectSpell, SpellModifier const* mod);
