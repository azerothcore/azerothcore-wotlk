...
{
public:
    GenericCreatureScript(std::string_view name) : CreatureScript(name) { }
...
{
public:
    FactoryCreatureScript(std::string_view name) : CreatureScript(name) { }
...
{
public:
    GenericGameObjectScript(std::string_view name) : GameObjectScript(name) { }
...
{
public:
    FactoryGameObjectScript(std::string_view name) : GameObjectScript(name) {}
