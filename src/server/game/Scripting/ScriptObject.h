...
class AC_GAME_API UpdatableScript
{
protected:
...
{
protected:
    explicit SpellScriptLoader(std::string_view name);
...
{
protected:
    explicit ServerScript(std::string_view name);
...
{
protected:
    explicit WorldScript(std::string_view name);
...
public:
    ...
    // Called when a world shutdown is canceled.
...
{
protected:
    explicit FormulaScript(std::string_view name);
...
{
protected:
    explicit UnitScript(std::string_view name, bool addToScripts = true);
...
{
protected:
    explicit MovementHandlerScript(std::string_view name);
...
{
protected:
    explicit AllMapScript(std::string_view name);
...
{
protected:
    explicit AllCreatureScript(std::string_view name);
...
class AC_GAME_API AllItemScript : public ScriptObject
{
protected:
    explicit AllItemScript(std::string_view name);
...
class AC_GAME_API AllGameObjectScript : public ScriptObject
{
protected:
    explicit AllGameObjectScript(std::string_view name);
...
{
protected:
    explicit CreatureScript(std::string_view name);
...
{
protected:
    explicit GameObjectScript(std::string_view name);
...
{
protected:
    explicit AreaTriggerScript(std::string_view name);
...
class AC_GAME_API OnlyOnceAreaTriggerScript : public AreaTriggerScript
{
...
{
protected:
    explicit BattlegroundScript(std::string_view name);
...
{
protected:
    explicit OutdoorPvPScript(std::string_view name);
...
{
protected:
    explicit CommandScript(std::string_view name);
...
{
protected:
    explicit WeatherScript(std::string_view name);
...
{
protected:
    explicit AuctionHouseScript(std::string_view name);
...
{
protected:
    explicit ConditionScript(std::string_view name);
...
{
protected:
    explicit VehicleScript(std::string_view name);
...
{
protected:
    explicit DynamicObjectScript(std::string_view name);
};

class AC_GAME_API TransportScript : public ScriptObject, public UpdatableScript<Transport>
{
protected:
    explicit TransportScript(std::string_view name);
...
{
protected:
    explicit AchievementCriteriaScript(std::string_view name);
...
{
protected:
    explicit PlayerScript(std::string_view name);
...
{
protected:
    explicit GuildScript(std::string_view name);
...
{
protected:
    explicit GroupScript(std::string_view name);
...
{
protected:
    explicit GlobalScript(std::string_view name);
...
{
protected:
    explicit BGScript(std::string_view name);
...
class AC_GAME_API ArenaTeamScript : public ScriptObject
{
protected:
    explicit ArenaTeamScript(std::string_view name);
...
{
protected:
    explicit SpellSC(std::string_view name);
...
{
protected:
    explicit ModuleScript(std::string_view name);
};

class AC_GAME_API GameEventScript : public ScriptObject
{
protected:
    explicit GameEventScript(std::string_view name);
...
class AC_GAME_API MailScript : public ScriptObject
{
protected:
    explicit MailScript(std::string_view name);
...
class AC_GAME_API AchievementScript : public ScriptObject
{
protected:
    explicit AchievementScript(std::string_view name);
...
class AC_GAME_API PetScript : public ScriptObject
{
protected:
    explicit PetScript(std::string_view name);
...
class AC_GAME_API ArenaScript : public ScriptObject
{
protected:
    explicit ArenaScript(std::string_view name);
...
class AC_GAME_API MiscScript : public ScriptObject
{
protected:
    explicit MiscScript(std::string_view name);
...
class AC_GAME_API CommandSC : public ScriptObject
{
protected:
    explicit CommandSC(std::string_view name);
...
class AC_GAME_API DatabaseScript : public ScriptObject
{
protected:
    explicit DatabaseScript(std::string_view name);
...
class AC_GAME_API WorldObjectScript : public ScriptObject
{
protected:
    explicit WorldObjectScript(std::string_view name);
...
class AC_GAME_API LootScript : public ScriptObject
{
protected:
    explicit LootScript(std::string_view name);
...
class AC_GAME_API ElunaScript : public ScriptObject
{
protected:
    explicit ElunaScript(std::string_view name);
...
{
public:
    explicit GenericCreatureScript(std::string_view name) : CreatureScript(name) { }
...
{
public:
    explicit FactoryCreatureScript(std::string_view name) : CreatureScript(name) { }
...
{
public:
    explicit GenericGameObjectScript(std::string_view name) : GameObjectScript(name) { }
...
{
public:
    explicit FactoryGameObjectScript(std::string_view name) : GameObjectScript(name) {}
