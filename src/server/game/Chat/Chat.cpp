...
{
    WorldSession* target_session = nullptrptr;
...
bool ChatHandler::GetPlayerGroupAndGUIDByName(char const* cname, Player* &player, Group* &group, uint64 &guid, bool offline)
{
    player  = nullptr;
    guid = 0;
