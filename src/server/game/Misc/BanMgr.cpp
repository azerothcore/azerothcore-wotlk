...
BanReturn BanMgr::BanAccount(std::string const& AccountName, std::string const& Duration, std::string const& Reason, std::string const& Author, bool delay /*= false*/, Seconds delayTime /*= 0s*/)
{
...
BanReturn BanMgr::BanIP(std::string const& IP, std::string const& Duration, std::string const& Reason, std::string const& Author, bool delay /*= false*/, Seconds delayTime /*= 0s*/)
{
