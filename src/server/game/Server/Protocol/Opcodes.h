...
enum SessionStatus
{
    STATUS_AUTHED = 0,                                      // Player authenticated (m_player == nullptr, m_playerRecentlyLogout = false or will be reset before handler call, m_GUID have garbage)
    STATUS_LOGGEDIN,                                        // Player in game (m_player != nullptr, m_GUID == m_player->GetGUID(), inWorld())
    STATUS_TRANSFER,                                        // Player transferring to another map (m_player != nullptr, m_GUID == m_player->GetGUID(), !inWorld())
    STATUS_LOGGEDIN_OR_RECENTLY_LOGGOUT,                    // m_player != nullptr or m_player == nullptr && m_playerRecentlyLogout && m_playerLogout, m_GUID store last m_player guid)
