...
{
    std::shared_ptr<WorldAuthSession> authSession = std::make_shared<WorldAuthSession>();
...
void WorldSocket::HandleAuthSessionCallback(std::shared_ptr<WorldAuthSession> authSession, PreparedQueryResult result)
{
