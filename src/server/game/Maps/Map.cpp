...
Map::Map(uint32 id, std::chrono::milliseconds expiry, uint32 InstanceId, uint8 SpawnMode, Map* _parent) :
...
InstanceMap::InstanceMap(uint32 id, std::chrono::milliseconds expiry, uint32 InstanceId, uint8 SpawnMode, Map* _parent)
...
BattlegroundMap::BattlegroundMap(uint32 id, std::chrono::milliseconds expiry, uint32 InstanceId, Map* _parent, uint8 spawnMode)
