...
float Map::GetWaterOrGroundLevel(float x, float y, float z, float* ground /*= NULL*/, bool /*swim = false*/, float maxSearchDist /*= 50.0f*/, float collisionHeight /*= DEFAULT_COLLISION_HEIGHT*/) const
{ 
