...
public:
    ...
    [[nodiscard]] bool CanReachPositionAndGetHeight(Unit* who, float dest_x, float dest_y, float &dest_z, float maxDeviationAngle = M_PI*2, float maxHeight = 3.0f, bool withPath = true) const;
