...
void Player::FitPlayerInTeam(bool action, Battleground* pBattleGround)
{
	...
	if (pBattleGround && action) 
		SendChatMessage("%s You are playing for %s%s in this %s", MSG_COLOR_WHITE, GetTeamId() == TEAM_ALLIANCE ? MSG_COLOR_DARKBLUE"alliance" : MSG_COLOR_RED"horde", MSG_COLOR_WHITE, pBattleGround->GetName());
}
