...
WintergraspTowerCannonData const TowerCannon[WG_MAX_TOWER_CANNON] =
{
    ...
    },
    {
        ...
        4,
        {
            { 4538.8867f, 3601.4148f, 402.888f, 3.998462f },
            { 4579.6943f, 3605.6738f, 402.888f, 5.651723f },
            { 4534.7104f, 3642.0645f, 402.888f, 2.455163f },
            { 4575.2915f, 3646.363f, 402.888f, 0.884366f },
            { 0, 0, 0, 0 },
        },
        4,
        {
            { 4583.152f, 3626.6692f, 426.540f, 0.117806f },
            { 4559.8447f, 3598.097f, 426.540f, 4.780807f },
            { 4531.4473f, 3621.2424f, 426.540f, 3.268910f },
            { 4554.4956f, 3649.5588f, 426.540f, 1.657981f },
            { 0, 0, 0, 0 },
        },
    },
    {
