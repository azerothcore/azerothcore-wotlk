...
enum AcoreStrings
{
    ...
    LANG_ACCOUNT_FLAG_LIST_HEADER       = 35462,
    LANG_ACCOUNT_FLAG_LIST_EMPTY        = 35463,
    LANG_ACCOUNT_FLAG_INVALID           = 35464,
    LANG_ACCOUNT_FLAG_RESERVED          = 35465,
    LANG_ACCOUNT_FLAG_ADDED             = 35466,
    LANG_ACCOUNT_FLAG_REMOVED           = 35467
};
#endif
