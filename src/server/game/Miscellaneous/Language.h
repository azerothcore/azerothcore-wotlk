...
enum AcoreStrings
{
    ...
    // Spell gobject faction commands
    LANG_SPELL_GO_FACTION_INVALID_TEAM   = 35455,
    LANG_SPELL_GO_FACTION_ADDED          = 35456,
    LANG_SPELL_GO_FACTION_UPDATED        = 35457,
    LANG_SPELL_GO_FACTION_NO_RESTRICTION = 35458,
    LANG_SPELL_GO_FACTION_REMOVED        = 35459,
    LANG_SPELL_GO_FACTION_NOT_IN_TABLE   = 35460,
    LANG_SPELL_GO_FACTION_ALREADY_SET    = 35461,
    LANG_SPELL_GO_FACTION_NO_ENTRIES        = 35462,
    LANG_SPELL_GO_FACTION_COUNT             = 35463,
    LANG_SPELL_GO_FACTION_ADD_ALREADY_EXISTS = 35464
    // 35465+ - free
};
#endif
