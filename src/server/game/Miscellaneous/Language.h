...
enum AcoreStrings
{
    ...
    LANG_COMMAND_NOT_DEAD_OR_NO_LOOT    = 35455,
    LANG_COMMAND_NPC_SHOWLOOT_HEADER    = 35456,
    LANG_COMMAND_NPC_SHOWLOOT_MONEY     = 35457,
    LANG_COMMAND_NPC_SHOWLOOT_ITEMS     = 35458,
    LANG_COMMAND_NPC_SHOWLOOT_ENTRY     = 35459,
    LANG_COMMAND_NPC_SHOWLOOT_QUEST     = 35460
};
#endif
