...
enum AcoreStrings
{
    ...
    LANG_ARENA_QUEUE_ANNOUNCE_WORLD_JOIN_NAME = 753,
    LANG_ARENA_QUEUE_ANNOUNCE_WORLD_EXIT_NAME = 754,
    LANG_ARENA_QUEUE_ANNOUNCE_WORLD_JOIN_RATING = 755,
    LANG_ARENA_QUEUE_ANNOUNCE_WORLD_EXIT_RATING = 756,
    LANG_ARENA_QUEUE_ANNOUNCE_WORLD_JOIN = 757,
    LANG_ARENA_QUEUE_ANNOUNCE_WORLD_EXIT = 758,
