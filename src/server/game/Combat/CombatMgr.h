...
// Please check Game/Combat/CombatMgr.h for documentation on how this class works!
...
// Please check Game/Combat/CombatMgr.h for documentation on how this class works!
struct PvPCombatReference : public CombatReference
{
...
public:
    ...
    CombatMgr(Unit* owner) : _owner(owner) { }
    ~CombatMgr();
    ...
    CombatMgr(CombatMgr const&) = delete;
    CombatMgr& operator=(CombatMgr const&) = delete;
