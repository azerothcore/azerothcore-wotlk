...
{ \
    ...
    { \
        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses param {} of type Boolean with value {}, valid values are 0 or 1, skipped.", \
            e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), STRINGIZE(value), value); \
        return false; \
    } \
}
...
void SmartAIMgr::LoadSmartAIFromDB()
{
    ...
    do
    {
        ...
        temp.entry = fields[0].Get<int32>();
        temp.guid = fields[1].Get<int32>();
        ...
        SmartScriptType source_type = (SmartScriptType)fields[2].Get<uint8>();
        ...
        if (temp.entry >= 0)
        {
            switch (source_type)
            {
                case SMART_SCRIPT_TYPE_CREATURE:
                    {
                        if (!sObjectMgr->GetCreatureTemplate((uint32)temp.entry))
                        {
                            LOG_ERROR("sql.sql", "SmartAIMgr::LoadSmartAIFromDB: Creature entry ({}) does not exist, skipped loading.", uint32(temp.entry));
                            continue;
                        }
                        break;
                    }
                case SMART_SCRIPT_TYPE_GAMEOBJECT:
                    {
                        if (!sObjectMgr->GetGameObjectTemplate((uint32)temp.entry))
                        {
                            LOG_ERROR("sql.sql", "SmartAIMgr::LoadSmartAIFromDB: GameObject entry ({}) does not exist, skipped loading.", uint32(temp.entry));
                            continue;
                        }
                        break;
                    }
                case SMART_SCRIPT_TYPE_AREATRIGGER:
                    {
                        if (!sObjectMgr->GetAreaTrigger((uint32)temp.entry))
                        {
                            LOG_ERROR("sql.sql", "SmartAIMgr::LoadSmartAIFromDB: AreaTrigger entry ({}) does not exist, skipped loading.", uint32(temp.entry));
                            continue;
                        }
                        break;
                    }
        ...
        temp.link = fields[4].Get<uint16>();
        temp.event.type = (SMART_EVENT)fields[5].Get<uint8>();
        temp.event.event_phase_mask = fields[6].Get<uint16>();
        temp.event.event_chance = fields[7].Get<uint8>();
        temp.event.event_flags = fields[8].Get<uint16>();

        temp.event.raw.param1 = fields[9].Get<uint32>();
        temp.event.raw.param2 = fields[10].Get<uint32>();
        temp.event.raw.param3 = fields[11].Get<uint32>();
        temp.event.raw.param4 = fields[12].Get<uint32>();
        temp.event.raw.param5 = fields[13].Get<uint32>();
        ...
        if (mEventMap[source_type].find(temp.entry) == mEventMap[source_type].end())
        {
            ++count;
            SmartAIEventList eventList;
            mEventMap[source_type][temp.entry] = eventList;
        }
        // store the new event
        mEventMap[source_type][temp.entry].push_back(temp);
    } while (result->NextRow());
...
bool SmartAIMgr::IsTargetValid(SmartScriptHolder const& e)
{
    ...
    switch (e.GetTargetType())
    {
        ...
        case SMART_TARGET_CREATURE_RANGE:
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Creature entry {} as target_param1, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.target.unitDistance.creature);
                    return false;
                }
                break;
            }
        ...
        case SMART_TARGET_GAMEOBJECT_RANGE:
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent GameObject entry {} as target_param1, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.target.goDistance.entry);
                    return false;
                }
                break;
            }
        ...
        case SMART_TARGET_CLOSEST_PLAYER:
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} has maxDist 0 as target_param1, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
                    return false;
                }
                break;
            }
        ...
        case SMART_TARGET_INVOKER_PARTY:
            ...
            {
                LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} has invoker target, but action does not provide any invoker!", e.entry, e.GetScriptType(), e.GetEventType(), e.GetActionType());
                 return false;
            }
            break;
        ...
        case SMART_TARGET_THREAT_LIST:
            break;
        default:
            LOG_ERROR("sql.sql", "SmartAIMgr: Not handled target_type({}), Entry {} SourceType {} Event {} Action {}, skipped.", e.GetTargetType(), e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
            return false;
    }
...
bool SmartAIMgr::CheckUnusedEventParams(SmartScriptHolder const& e)
{
    size_t paramsStructSize = [&]() -> size_t
    {
        ...
        switch (e.event.type)
        {
            ...
            default:
                LOG_WARN("sql.sql", "SmartAIMgr: entry {} source_type {} id {} action_type {} is using an event {} with no unused params specified in SmartAIMgr::CheckUnusedEventParams(), please report this.",
                            e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.GetEventType());
    ...
    for (size_t index = paramsCount; index < rawCount; index++)
    {
        ...
        if (value != 0)
        {
            LOG_ERROR("sql.sql", "SmartAIMgr: entry {} source_type {} id {} action_type {} has unused event_param{} with value {}, it must be 0, skipped.",
                         e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), index + 1, value);
            valid = false;
        }
    }
...
bool SmartAIMgr::CheckUnusedActionParams(SmartScriptHolder const& e)
{
    size_t paramsStructSize = [&]() -> size_t
    {
        ...
        switch (e.action.type)
        {
            ...
            default:
                LOG_WARN("sql.sql", "SmartAIMgr: entry {} source_type {} id {} action_type {} is using an action with no unused params specified in SmartAIMgr::CheckUnusedActionParams(), please report this.",
                            e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
    ...
    for (size_t index = paramsCount; index < rawCount; index++)
    {
        ...
        if (value != 0)
        {
            LOG_ERROR("sql.sql", "SmartAIMgr: entry {} source_type {} id {} action_type {} has unused action_param{} with value {}, it must be 0, skipped.",
                         e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), index + 1, value);
            valid = false;
        }
    }
...
bool SmartAIMgr::CheckUnusedTargetParams(SmartScriptHolder const& e)
{
    size_t paramsStructSize = [&]() -> size_t
    {
        ...
        switch (e.target.type)
        {
            ...
            default:
                LOG_WARN("sql.sql", "SmartAIMgr: entry {} source_type {} id {} action_type {} is using a target {} with no unused params specified in SmartAIMgr::CheckUnusedTargetParams(), please report this.",
                            e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.GetTargetType());
    ...
    for (size_t index = paramsCount; index < rawCount; index++)
    {
        ...
        if (value != 0)
        {
            LOG_ERROR("sql.sql", "SmartAIMgr: entry {} source_type {} id {} action_type {} has unused target_param{} with value {}, it must be 0, skipped.",
                         e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), index + 1, value);
            valid = false;
        }
    }
...
bool SmartAIMgr::IsEventValid(SmartScriptHolder& e)
{
    ...
    {
        LOG_ERROR("sql.sql", "SmartAIMgr: entry {} using event({}) has invalid event type ({}), skipped.", e.entry, e.event_id, e.GetEventType());
        return false;
    }
    ...
    {
        LOG_ERROR("sql.sql", "SmartAIMgr: entry {}, event type {} can not be used for Script type {}", e.entry, e.GetEventType(), e.GetScriptType());
        return false;
    }
    if (e.action.type <= 0
    ...
    {
        LOG_ERROR("sql.sql", "SmartAIMgr: entry {} using event({}) has an invalid action type ({}), skipped.", e.entry, e.event_id, e.GetActionType());
        return false;
    }
    switch (e.action.type)
    {
        ...
        case SMART_ACTION_SCENE_CANCEL:
            LOG_ERROR("sql.sql", "SmartAIMgr: entry {} using event({}) has an action type that is not supported on 3.3.5a ({}), skipped.",
                             e.entry, e.event_id, e.GetActionType());
            return false;
        ...
        case SMART_ACTION_RESPAWN_BY_SPAWNID:
            LOG_ERROR("sql.sql", "SmartAIMgr: entry {} using event({}) has an action type that is not yet supported on AzerothCore ({}), skipped.",
                             e.entry, e.event_id, e.GetActionType());
            return false;
        default:
            break;
    ...
    {
        LOG_ERROR("sql.sql", "SmartAIMgr: entry {} using event({}) has an invalid target type ({}), skipped.",
                         e.entry, e.event_id, e.GetTargetType());
        return false;
    }
    if (e.target.type == SMART_TARGET_LOOT_RECIPIENTS)
    {
        LOG_ERROR("sql.sql", "SmartAIMgr: entry {} using event({}) has a target type that is not yet supported on AzerothCore ({}), skipped.",
                         e.entry, e.event_id, e.GetTargetType());
        return false;
    }
    if (e.event.event_phase_mask > SMART_EVENT_PHASE_ALL)
    {
        LOG_ERROR("sql.sql", "SmartAIMgr: entry {} using event({}) has invalid phase mask ({}), skipped.", e.entry, e.event_id, e.event.event_phase_mask);
        return false;
    }
    if (e.event.event_flags > SMART_EVENT_FLAGS_ALL)
    {
        LOG_ERROR("sql.sql", "SmartAIMgr: entry {} using event({}) has invalid event flags ({}), skipped.", e.entry, e.event_id, e.event.event_flags);
        return false;
    }
        ...
        switch (type)
        {
            ...
            case SMART_EVENT_SPELLHIT_TARGET:
                if (e.event.spellHit.spell)
                {
                    ...
                    if (!spellInfo)
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Spell entry {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.event.spellHit.spell);
                        return false;
                    }
                    if (e.event.spellHit.school && (e.event.spellHit.school & spellInfo->SchoolMask) != spellInfo->SchoolMask)
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses Spell entry {} with invalid school mask, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.event.spellHit.spell);
                        return false;
                    }
                }
            ...
            case SMART_EVENT_IC_LOS:
                ...
                if (e.event.los.hostilityMode >= AsUnderlyingType(SmartEvent::LOSHostilityMode::End))
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses hostilityMode with invalid value {} (max allowed value {}), skipped.",
                                 e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.event.los.hostilityMode, AsUnderlyingType(SmartEvent::LOSHostilityMode::End) - 1);
                    return false;
                }
            ...
            case SMART_EVENT_RESPAWN:
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Map entry {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.event.respawn.map);
                    return false;
                }
                if (e.event.respawn.type == SMART_SCRIPT_RESPAWN_CONDITION_AREA && !sAreaTableStore.LookupEntry(e.event.respawn.area))
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Area entry {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.event.respawn.area);
                    return false;
                }
                break;
            case SMART_EVENT_FRIENDLY_HEALTH:
            ...
            case SMART_EVENT_VICTIM_CASTING:
                ...
                {
                    LOG_ERROR("scripts.ai.sai", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Spell entry {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.event.spellHit.spell);
                    return false;
                }
            ...
            case SMART_EVENT_MOVEMENTINFORM:
                {
                    ...
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses invalid Motion type {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.event.movementInform.type);
                        return false;
                    }
                    break;
                }
            ...
            case SMART_EVENT_LINK:
                {
                    ...
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {}, Event {}, Link Event is linking self (infinite loop), skipped.", e.entry, e.GetScriptType(), e.event_id);
                        return false;
                    }
                    break;
                }
            case SMART_EVENT_EVENT_PHASE_CHANGE:
                {
                    ...
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} has no param set, event won't be executed!.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
                        return false;
                    }

                    if (e.event.eventPhaseChange.phasemask > SMART_EVENT_PHASE_ALL)
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses invalid phasemask {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.event.eventPhaseChange.phasemask);
                        return false;
                    }

                    if (e.event.event_phase_mask && !(e.event.event_phase_mask & e.event.eventPhaseChange.phasemask))
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses event phasemask {} and incompatible event_param1 {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.event.event_phase_mask, e.event.eventPhaseChange.phasemask);
                        return false;
                    }
                    break;
                }
            ...
            case SMART_EVENT_ACTION_DONE:
                {
                    ...
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses invalid event id {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.event.doAction.eventId);
                        return false;
                    }
                    break;
                }
            case SMART_EVENT_FRIENDLY_HEALTH_PCT:
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} has pct value above 100, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
                    return false;
                }
                ...
                switch (e.GetTargetType())
                {
                    ...
                    case SMART_TARGET_ACTION_INVOKER:
                        ...
                        break;
                    default:
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses invalid target_type {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.GetTargetType());
                        return false;
                }
                break;
            case SMART_EVENT_DISTANCE_CREATURE:
            ...
            case SMART_EVENT_ON_SPELLCLICK:
                break;
            default:
                LOG_ERROR("sql.sql", "SmartAIMgr: Not handled event_type({}), Entry {} SourceType {} Event {} Action {}, skipped.", e.GetEventType(), e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
                return false;
        }
    }
    ...
    switch (e.GetActionType())
    {
        case SMART_ACTION_SET_FACTION:
            ...
            {
                LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Faction {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.faction.factionID);
                return false;
            }
            break;
        ...
        case SMART_ACTION_MOUNT_TO_ENTRY_OR_MODEL:
            if (e.action.morphOrMount.creature || e.action.morphOrMount.model)
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Creature entry {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.morphOrMount.creature);
                    return false;
                }
                ...
                if (e.action.morphOrMount.model)
                {
                    ...
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} has ModelID set with also set CreatureId, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
                        return false;
                    }
                    else if (!sCreatureDisplayInfoStore.LookupEntry(e.action.morphOrMount.model))
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Model id {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.morphOrMount.model);
                        return false;
                    }
                }
            }
        ...
        case SMART_ACTION_ACTIVATE_TAXI:
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses invalid Taxi path ID {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.taxi.id);
                    return false;
                }
                break;
            }
        ...
        case SMART_ACTION_CALL_GROUPEVENTHAPPENS:
            if (Quest const* qid = sObjectMgr->GetQuestTemplate(e.action.quest.quest))
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} SpecialFlags for Quest entry {} does not include FLAGS_EXPLORATION_OR_EVENT(2), skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.quest.quest);
                    return false;
                }
            }
            else
            {
                LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Quest entry {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.quest.quest);
                return false;
            }
            break;
        case SMART_ACTION_SET_EVENT_PHASE:
            ...
            {
                LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} attempts to set phase {}. Phase mask cannot be used past phase {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.setEventPhase.phase, SMART_EVENT_PHASE_MAX - 1);
                return false;
            }
            break;
        case SMART_ACTION_INC_EVENT_PHASE:
            ...
            {
                LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} is incrementing phase by 0, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
                return false;
            }
            else if (e.action.incEventPhase.inc > SMART_EVENT_PHASE_MAX || e.action.incEventPhase.dec > SMART_EVENT_PHASE_MAX)
            {
                LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} attempts to increment phase by too large value, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
                return false;
            }
            break;
        ...
        case SMART_ACTION_RANDOM_PHASE:
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} attempts to set invalid phase, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
                    return false;
                }
                break;
            }
        ...
        case SMART_ACTION_SUMMON_CREATURE:
            ...
            {
                LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses incorrect TempSummonType {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.summonCreature.type);
                return false;
            }
        ...
        case SMART_ACTION_SET_SHEATH:
            ...
            {
                LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses incorrect Sheath state {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.setSheath.sheath);
                return false;
            }
            break;
        case SMART_ACTION_SET_REACT_STATE:
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Creature {} Event {} Action {} uses invalid React State {}, skipped.", e.entry, e.event_id, e.GetActionType(), e.action.react.state);
                    return false;
                }
                break;
            }
        ...
        case SMART_ACTION_TELEPORT:
            ...
            {
                LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Map entry {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.teleport.mapID);
                return false;
            }
            break;
        case SMART_ACTION_INSTALL_AI_TEMPLATE:
            ...
            {
                LOG_ERROR("sql.sql", "SmartAIMgr: Creature {} Event {} Action {} uses non-existent AI template id {}, skipped.", e.entry, e.event_id, e.GetActionType(), e.action.installTtemplate.id);
                return false;
            }
            break;
        ...
        case SMART_ACTION_WP_START:
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Creature {} Event {} Action {} uses non-existent WaypointPath id {}, skipped.", e.entry, e.event_id, e.GetActionType(), e.action.wpStart.pathID);
                    return false;
                }
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Creature {} Event {} Action {} uses invalid React State {}, skipped.", e.entry, e.event_id, e.GetActionType(), e.action.wpStart.reactState);
                    return false;
                }
        ...
        case SMART_ACTION_REMOVE_POWER:
            ...
            {
                LOG_ERROR("scripts.ai.sai", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent Power {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.power.powerType);
                return false;
            }
            break;
        case SMART_ACTION_GAME_EVENT_STOP:
            {
                ...
                {
                    LOG_ERROR("scripts.ai.sai", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent event, eventId {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.gameEventStop.id);
                    return false;
                }
        ...
        case SMART_ACTION_GAME_EVENT_START:
            {
                ...
                if (eventId < 1 || eventId >= events.size())
                {
                    LOG_ERROR("scripts.ai.sai", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses non-existent event, eventId {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.gameEventStart.id);
                    return false;
                }
        ...
        case SMART_ACTION_EQUIP:
            {
                if (e.GetScriptType() == SMART_SCRIPT_TYPE_CREATURE)
                {
                    ...
                    {
                        EquipmentInfo const* eInfo = sObjectMgr->GetEquipmentInfo(e.entry, equipId);
                        if (!eInfo)
                        {
                            LOG_ERROR("scripts.ai.sai", "SmartScript: SMART_ACTION_EQUIP uses non-existent equipment info id {} for creature {}, skipped.", equipId, e.entry);
                            return false;
                        }
                    }
                }
        ...
        case SMART_ACTION_LOAD_GRID:
            {
                ...
                {
                    LOG_ERROR("scripts.ai.sai", "SmartScript: SMART_ACTION_LOAD_GRID uses invalid map coords: {}, skipped.", e.entry);
                    return false;
                }
                break;
            }
        case SMART_ACTION_SET_IN_COMBAT_WITH_ZONE:
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartScript: action_type {} is not allowed with source_type {}. Entry {}, skipped.", e.GetActionType(), e.GetScriptType(), e.entry);
                    return false;
                }
                break;
            }
        case SMART_ACTION_SET_INST_DATA:
            {
                if (e.action.setInstanceData.type == 1)
                {
                    ...
                    {
                        LOG_ERROR("sql.sql", "SmartScript: SMART_ACTION_SET_INST_DATA with type 1 (bossState) uses invalid encounter state {}. Source entry {}, type {}", e.action.setInstanceData.data, e.entry, e.GetScriptType());
                        return false;
                    }
                }
                else if (e.action.setInstanceData.type > 1)
                {
                    LOG_ERROR("sql.sql", "SmartScript: SMART_ACTION_SET_INST_DATA uses unsupported data type {}. Source entry {}, type {}", e.action.setInstanceData.type, e.entry, e.GetScriptType());
                    return false;
                }
                break;
            }
        case SMART_ACTION_SET_HEALTH_PCT:
            {
                if (e.action.setHealthPct.percent > 100 || !e.action.setHealthPct.percent)
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} is trying to set invalid HP percent {}, skipped.",
                                 e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.setHealthPct.percent);
                    return false;
                }
                break;
            }
        case SMART_ACTION_SET_MOVEMENT_SPEED:
            {
                ...
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses invalid movementType {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), e.action.movementSpeed.movementType);
                    return false;
                }

                if (!e.action.movementSpeed.speedInteger && !e.action.movementSpeed.speedFraction)
                {
                    LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses speed 0, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType());
                    return false;
                }
                break;
            }
        ...
        case SMART_ACTION_PLAY_CINEMATIC:
            break;
        default:
            LOG_ERROR("sql.sql", "SmartAIMgr: Not handled action_type({}), event_type({}), Entry {} SourceType {} Event {}, skipped.", e.GetActionType(), e.GetEventType(), e.entry, e.GetScriptType(), e.event_id);
            return false;
    }
...
bool SmartAIMgr::IsTextValid(SmartScriptHolder const& e, uint32 id)
{
    ...
    else
    {
        switch (e.GetTargetType())
        {
            ...
            default:
                if (e.entry < 0)
                {
                    ObjectGuid::LowType guid = ObjectGuid::LowType(-e.entry);
                    CreatureData const* data = sObjectMgr->GetCreatureData(guid);
                    if (!data)
                    {
                        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} using non-existent Creature guid {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), guid);
                        return false;
                    }
                    else
                        entry = data->id1;
    ...
    {
        LOG_ERROR("sql.sql", "SmartAIMgr: Entry {} SourceType {} Event {} Action {} using non-existent Text id {}, skipped.", e.entry, e.GetScriptType(), e.event_id, e.GetActionType(), id);
        return false;
    }
