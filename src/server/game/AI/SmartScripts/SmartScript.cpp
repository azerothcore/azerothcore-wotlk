        ...
        case SMART_ACTION_SET_INST_DATA:
            {
                ...
                switch (e.action.setInstanceData.type)
                {
                    ...
                    case 1:
                    {
                        ...
                        LOG_DEBUG("scripts.ai.sai", "SmartScript::ProcessAction: SMART_ACTION_SET_INST_DATA: SetBossState BossId: %u, State: %u (%s)", e.action.setInstanceData.field, InstanceScript::GetBossStateName(e.action.setInstanceData.data));
                    }break;
                    default:
                    {
                        break;
