...
void CreatureAI::DoZoneInCombat(Creature* creature /*= nullptr*/, float maxRangeToNearestTarget /*= 250.0f*/)
{
    ...
    {
        LOG_ERROR("entities.unit.ai", "DoZoneInCombat call for map {} that isn't an instance (creature entry = {})", map, creature->GetTypeId() == TYPEID_UNIT ? creature->ToCreature()->GetEntry() : 0);
        return;
    }
