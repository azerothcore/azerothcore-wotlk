...
void CreatureAI::DoZoneInCombat(Creature* creature /*= NULL*/, float maxRangeToNearestTarget /* = 50.0f*/)
{
    ...
    {
        LOG_ERROR("root", "DoZoneInCombat call for map that isn't an instance (creature entry = %d)", creature->GetTypeId() == TYPEID_UNIT ? creature->ToCreature()->GetEntry() : 0);
        return;
    }
    ...
    {
        LOG_ERROR("root", "DoZoneInCombat called for creature that has empty threat list (creature entry = %u)", creature->GetEntry());
        return;
    }
...
void CreatureAI::EnterEvadeMode()
{
    ...
    LOG_DEBUG("root", "Creature %u enters evade mode.", me->GetEntry());
#endif
