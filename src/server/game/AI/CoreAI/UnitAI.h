...
{
    FarthestTargetSelector(Unit const* unit, float maxDist, bool playerOnly, bool inLos, float minDist = 0.f) : _me(unit), _maxDist(maxDist), _playerOnly(playerOnly), _inLos(inLos), _minDist(minDist) {}
