...
namespace FactorySelector
{
    CreatureAI* selectAI(Creature* creature)
    {
        ...
        sLog->outDebug(LOG_FILTER_TSCR, "Creature %s used AI is %s.", creature->GetGUID().ToString().c_str(), ainame.c_str());
#endif
    ...
    GameObjectAI* SelectGameObjectAI(GameObject* go)
    {
        ...
        sLog->outDebug(LOG_FILTER_TSCR, "GameObject %s used AI is %s.", go->GetGUID().ToString().c_str(), ainame.c_str());
#endif
