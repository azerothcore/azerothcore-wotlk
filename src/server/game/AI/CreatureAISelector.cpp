...
namespace FactorySelector
{
    CreatureAI* selectAI(Creature* creature)
    {
        ...
        LOG_DEBUG("entities.unit", "Creature %u used AI is %s.", creature->GetGUIDLow(), ainame.c_str());
    ...
    GameObjectAI* SelectGameObjectAI(GameObject* go)
    {
        ...
        LOG_DEBUG("entities.unit", "GameObject %u used AI is %s.", go->GetGUIDLow(), ainame.c_str());
#endif
