...
struct npc_escortAI : public ScriptedAI
{
    public:
        ...
        void Start(bool isActiveAttacker = true, bool run = false, ObjectGuid ObjectGuid::Empty, Quest const* quest = NULL, bool instantRespawn = false, bool canLoopPath = false, bool resetWaypoints = true);
