...
void WorldSession::HandleDismissControlledVehicle(WorldPacket &recvData)
{
    ...
    LOG_DEBUG("server", "WORLD: Recvd CMSG_DISMISS_CONTROLLED_VEHICLE");
#endif
...
{
#if defined(ENABLE_EXTRAS) && defined(ENABLE_EXTRA_LOGS)
    LOG_DEBUG("server", "WORLD: Recvd CMSG_CHANGE_SEATS_ON_CONTROLLED_VEHICLE");
#endif
...
{
#if defined(ENABLE_EXTRAS) && defined(ENABLE_EXTRA_LOGS)
    LOG_DEBUG("server", "WORLD: Recvd CMSG_REQUEST_VEHICLE_EXIT");
#endif
