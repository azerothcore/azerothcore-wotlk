...
void WorldSession::HandleCharCreateOpcode(WorldPacket &recvData)
{
    ...
    recvData >> createInfo->Name >> createInfo->Race >> createInfo->Class >> createInfo->Gender >> createInfo->Skin >> createInfo->Face >> createInfo->HairStyle >> createInfo->HairColor >> createInfo->FacialHair >> createInfo->OutfitId;
...
void WorldSession::HandlePlayerLoginFromDB(LoginQueryHolder const &holder)
{
    ...
    if (pCurrChar->HasAtLoginFlag(AT_LOGIN_CHECK_ACHIEVS))
    {
        ...
        pCurrChar->m_Events.AddEventAtOffset([pCurrChar]
            ...
            pCurrChar->CheckAllAchievementCriteria(); }, 1s);
    }
...
void WorldSession::HandleCharFactionOrRaceChange(WorldPacket &recvData)
{
    ...
    recvData >> factionChangeInfo->Name >> factionChangeInfo->Gender >> factionChangeInfo->Skin >> factionChangeInfo->HairColor >> factionChangeInfo->HairStyle >> factionChangeInfo->FacialHair >> factionChangeInfo->Face >> factionChangeInfo->Race;
