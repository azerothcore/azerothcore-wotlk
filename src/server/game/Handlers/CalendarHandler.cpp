...
void WorldSession::HandleCalendarGetCalendar(WorldPacket& /*recvData*/)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_GET_CALENDAR [" UI64FMTD "]", guid);
...
void WorldSession::HandleCalendarGetEvent(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_GET_EVENT. Player ["
...
{
    LOG_DEBUG("server", "CMSG_CALENDAR_GUILD_FILTER [" UI64FMTD "]", _player->GetGUID());
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_GUILD_FILTER: Min level [%d], Max level [%d], Min rank [%d]", minLevel, maxLevel, minRank);
}

void WorldSession::HandleCalendarArenaTeam(WorldPacket& recvData)
{
    LOG_DEBUG("server", "CMSG_CALENDAR_ARENA_TEAM [" UI64FMTD "]", _player->GetGUID());
...
void WorldSession::HandleCalendarUpdateEvent(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_UPDATE_EVENT [" UI64FMTD "] EventId [" UI64FMTD
...
void WorldSession::HandleCalendarCopyEvent(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_COPY_EVENT [" UI64FMTD "], EventId [" UI64FMTD
...
{
    LOG_DEBUG("server", "CMSG_CALENDAR_EVENT_INVITE");
...
void WorldSession::HandleCalendarEventSignup(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_EVENT_SIGNUP [" UI64FMTD "] EventId [" UI64FMTD "] Tentative %u", guid, eventId, tentative);
...
void WorldSession::HandleCalendarEventRsvp(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_EVENT_RSVP [" UI64FMTD"] EventId ["
...
void WorldSession::HandleCalendarEventRemoveInvite(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_EVENT_REMOVE_INVITE ["
...
void WorldSession::HandleCalendarEventStatus(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_EVENT_STATUS [" UI64FMTD"] EventId ["
...
void WorldSession::HandleCalendarEventModeratorStatus(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_EVENT_MODERATOR_STATUS [" UI64FMTD "] EventId ["
        UI64FMTD "] ownerInviteId [" UI64FMTD "], Invitee ([" UI64FMTD "] id: ["
...
void WorldSession::HandleCalendarComplain(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_COMPLAIN [" UI64FMTD "] EventId ["
...
void WorldSession::HandleCalendarGetNumPending(WorldPacket& /*recvData*/)
{
    ...
    LOG_DEBUG("server", "CMSG_CALENDAR_GET_NUM_PENDING: [" UI64FMTD
...
{
    LOG_DEBUG("server", "%s", add ? "SMSG_CALENDAR_RAID_LOCKOUT_ADDED" : "SMSG_CALENDAR_RAID_LOCKOUT_REMOVED");
    time_t currTime = time(NULL);
