...
void WorldSession::HandleAcceptTradeOpcode(WorldPacket& /*recvPacket*/)
{
    ...
    {
        Acore::Text::SendNotification(this, LANG_NOT_ENOUGH_GOLD);
    ...
    {
        Acore::Text::SendNotification(trader->GetSession(), LANG_NOT_ENOUGH_GOLD);
    ...
    if (his_trade->IsAccepted())
    {
        ...
        if (!myCanCompleteTrade)
        {
            ...
            Acore::Text::SendNotification(this, LANG_NOT_FREE_TRADE_SLOTS);
            Acore::Text::SendNotification(trader->GetSession(), LANG_NOT_PARTNER_FREE_TRADE_SLOTS);
        ...
        else if (!hisCanCompleteTrade)
        {
            ...
            Acore::Text::SendNotification(this, LANG_NOT_PARTNER_FREE_TRADE_SLOTS);
            Acore::Text::SendNotification(trader->GetSession(), LANG_NOT_FREE_TRADE_SLOTS);
            my_trade->SetAccepted(false);
            his_trade->SetAccepted(false);
            delete my_spell;
            delete his_spell;
...
void WorldSession::HandleInitiateTradeOpcode(WorldPacket& recvPacket)
{
    ...
    {
        Acore::Text::SendNotification(this, LANG_TRADE_REQ, sWorld->getIntConfig(CONFIG_TRADE_LEVEL_REQ));
        return;
    }
    ...
    {
        Acore::Text::SendNotification(this, LANG_TRADE_OTHER_REQ, sWorld->getIntConfig(CONFIG_TRADE_LEVEL_REQ));
        return;
    }
