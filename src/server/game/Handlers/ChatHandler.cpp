...
void WorldSession::HandleMessagechatOpcode(WorldPacket& recvData)
{
    ...
    else
    {
        ...
        else
        {
            ...
            if (sWorld->getBoolConfig(CONFIG_ALLOW_TWO_SIDE_INTERACTION_CHAT) || HasPermission(rbac::RBAC_PERM_TWO_SIDE_INTERACTION_CHAT))
                lang = LANG_UNIVERSAL;
            else
            {
                switch (type)
        ...
        case CHAT_MSG_WHISPER:
            {
                ...
                if (!(sWorld->getBoolConfig(CONFIG_ALLOW_TWO_SIDE_INTERACTION_CHAT) || HasPermission(rbac::RBAC_PERM_TWO_SIDE_INTERACTION_CHAT)) && senderIsPlayer && receiverIsPlayer)
