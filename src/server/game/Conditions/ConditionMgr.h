...
{                                                              // value1           value2         value3
    ...
    CONDITION_UNUSED_41                = 41,                   // placeholder
    ...
    CONDITION_UNUSED_49                = 49,                   // placeholder
...
enum ConditionSourceType
{
    ...
    CONDITION_SOURCE_TYPE_UNUSED_25                      = 25, // placeholder
    CONDITION_SOURCE_TYPE_UNUSED_26                      = 26, // placeholder
    CONDITION_SOURCE_TYPE_UNUSED_27                      = 27, // placeholder
