...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_SPELL_GOBJECT_FACTION_ADD              = 924,
    RBAC_PERM_COMMAND_SPELL_GOBJECT_FACTION_REMOVE           = 925,
    RBAC_PERM_COMMAND_SPELL_GOBJECT_FACTION_LIST             = 926,
    RBAC_PERM_COMMAND_SPELL_GOBJECT_FACTION_UPDATE           = 927,
