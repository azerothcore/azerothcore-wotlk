...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_WORLDSTATE                             = 912,
    RBAC_PERM_COMMAND_WORLDSTATE_SCOURGEINVASION             = 913,
    RBAC_PERM_COMMAND_WORLDSTATE_SCOURGEINVASION_SHOW        = 914,
    RBAC_PERM_COMMAND_WORLDSTATE_SCOURGEINVASION_STATE       = 915,
    RBAC_PERM_COMMAND_WORLDSTATE_SCOURGEINVASION_BATTLESWON  = 916,
    RBAC_PERM_COMMAND_WORLDSTATE_SCOURGEINVASION_STARTZONE   = 917,
    RBAC_PERM_COMMAND_WORLDSTATE_SUNSREACH                   = 918,
    RBAC_PERM_COMMAND_WORLDSTATE_SUNSREACH_STATUS            = 919,
    RBAC_PERM_COMMAND_WORLDSTATE_SUNSREACH_PHASE             = 920,
    RBAC_PERM_COMMAND_WORLDSTATE_SUNSREACH_SUBPHASE          = 921,
