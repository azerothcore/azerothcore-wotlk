...
public:
    GridInfo();
    GridInfo(std::chrono::milliseconds expiry, bool unload = true);
...
public:
    ...
    NGrid(uint32 id, int32 x, int32 y, std::chrono::milliseconds expiry, bool unload = true) :
    ...
    void ResetTimeTracker(std::chrono::milliseconds interval) { i_GridInfo.ResetTimeTracker(interval.count()); }
    void UpdateTimeTracker(std::chrono::milliseconds diff) { i_GridInfo.UpdateTimeTracker(diff.count()); }
