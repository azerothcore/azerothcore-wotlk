...
void GuildMgr::LoadGuilds()
{
    ...
    LOG_INFO("server.loading", "Loading guild event logs...");
    {
        ...
        CharacterDatabase.DirectPExecute(Acore::StringFormatFmt("DELETE FROM guild_eventlog WHERE LogGuid > {}", sWorld->getIntConfig(CONFIG_GUILD_EVENT_LOG_COUNT)));
    ...
    LOG_INFO("server.loading", "Loading guild bank event logs...");
    {
        ...
        CharacterDatabase.DirectPExecute(Acore::StringFormatFmt("DELETE FROM guild_bank_eventlog WHERE LogGuid > {}", sWorld->getIntConfig(CONFIG_GUILD_BANK_EVENT_LOG_COUNT)));
