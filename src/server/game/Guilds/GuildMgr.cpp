...
void GuildMgr::LoadGuilds()
{
    ...
    sLog->outString("Loading guilds definitions...");
    {
        ...
        CharacterDatabase.DirectExecute("DELETE g FROM guild g LEFT JOIN guild_member gm ON g.guildid = gm.guildid WHERE gm.guildid IS nullptr");
    ...
    sLog->outString("Loading guild members...");
    {
        ...
        CharacterDatabase.DirectExecute("DELETE gm FROM guild_member_withdraw gm LEFT JOIN guild_member g ON gm.guid = g.guid WHERE g.guid IS nullptr");
