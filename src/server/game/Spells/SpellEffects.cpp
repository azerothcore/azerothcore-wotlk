...
void Spell::EffectTameCreature(SpellEffIndex /*effIndex*/)
{
    ...
    if (!m_caster->IsClass(CLASS_HUNTER, CLASS_CONTEXT_ABILITY))
        return;
...
void Spell::EffectSummonPet(SpellEffIndex effIndex)
{
    ...
    // Reset cooldowns
    if (!owner->IsClass(CLASS_HUNTER, CLASS_CONTEXT_ABILITY))
    {
...
void Spell::EffectCreateTamedPet(SpellEffIndex effIndex)
{
    ...
    if (!unitTarget || unitTarget->GetTypeId() != TYPEID_PLAYER || unitTarget->GetPetGUID() || !unitTarget->IsClass(CLASS_HUNTER, CLASS_CONTEXT_ABILITY))
        return;
