...
void Spell::EffectTameCreature(SpellEffIndex /*effIndex*/)
{
    ...
    if (!m_caster->IsClass(CLASS_HUNTER))
        return;
...
void Spell::EffectCreateTamedPet(SpellEffIndex effIndex)
{
    ...
    if (!unitTarget || unitTarget->GetTypeId() != TYPEID_PLAYER || unitTarget->GetPetGUID() || !unitTarget->IsClass(CLASS_HUNTER))
        return;
