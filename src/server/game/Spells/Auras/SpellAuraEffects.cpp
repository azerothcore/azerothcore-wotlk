...
pAuraEffectHandler AuraEffectHandler[TOTAL_AURAS] =
{
    ...
    &AuraEffect::HandleAuraModIncreaseMountedFlightSpeed,         //173 SPELL_AURA_MOD_MOUNTED_AND_FLIGHT_SPEED_NOT_STACK
...
void AuraEffect::HandleAuraModIncreaseMountedFlightSpeed(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    Unit* target = aurApp->GetTarget();
