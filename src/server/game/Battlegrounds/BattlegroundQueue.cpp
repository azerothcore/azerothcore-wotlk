...
void BattlegroundQueue::SendJoinMessageArenaQueue(Player* leader, GroupQueueInfo* ginfo, PvPDifficultyEntry const* bracketEntry, bool isRated)
{
    ...
    else
    {
        ...
        case 3:
            ...
            break;
        case 2:
            ChatHandler(nullptr).SendWorldTextOptional(LANG_ARENA_QUEUE_ANNOUNCE_WORLD_JOIN_NAME, ANNOUNCER_FLAG_DISABLE_ARENA_QUEUE, TeamName.c_str(), ArenaType, ArenaType);
            break;
        case 1:
...
void BattlegroundQueue::SendExitMessageArenaQueue(GroupQueueInfo* ginfo)
{
    ...
    if (ArenaType && ginfo->Players.empty())
    {
        ...
        case 3:
            ...
            break;
        case 2:
            ChatHandler(nullptr).SendWorldTextOptional(LANG_ARENA_QUEUE_ANNOUNCE_WORLD_EXIT_NAME, ANNOUNCER_FLAG_DISABLE_ARENA_QUEUE, TeamName.c_str(), ArenaType, ArenaType);
            break;
        case 1:
