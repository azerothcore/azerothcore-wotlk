...
enum BG_AV_HERALD
{
    ...
    AV_TEXT_H_HERALD_ICEBLOOD_TOWER_ATTACK        = 43,
    AV_TEXT_H_HERALD_ICEBLOOD_TOWER_TAKEN         = 44,
    AV_TEXT_A_HERALD_ICEBLOOD_TOWER_ATTACK        = 45,
    AV_TEXT_A_HERALD_ICEBLOOD_TOWER_TAKEN         = 46,
    AV_TEXT_H_HERALD_STORMPIKE_AID_STATION_TAKEN  = 47,
    AV_TEXT_H_HERALD_STORMPIKE_AID_STATION_ATTACK = 48,
    AV_TEXT_A_HERALD_STORMPIKE_AID_STATION_TAKEN  = 49,
    AV_TEXT_A_HERALD_STORMPIKE_AID_STATION_ATTACK = 50,
    AV_TEXT_H_HERALD_FROSTWOLF_RELIEF_HUT_TAKEN   = 51,
    AV_TEXT_H_HERALD_FROSTWOLF_RELIEF_HUT_ATTACK  = 52,
    AV_TEXT_A_HERALD_FROSTWOLF_RELIEF_HUT_TAKEN   = 53,
    AV_TEXT_A_HERALD_FROSTWOLF_RELIEF_HUT_ATTACK  = 54,
    AV_TEXT_H_HERALD_STONEHEARTH_GRAVEYARD_TAKEN  = 55,
    AV_TEXT_H_HERALD_STONEHEARTH_GRAVEYARD_ATTACK = 56,
    AV_TEXT_A_HERALD_STONEHEARTH_GRAVEYARD_TAKEN  = 57,
    AV_TEXT_A_HERALD_STONEHEARTH_GRAVEYARD_ATTACK = 58,
    AV_TEXT_H_HERALD_ICEBLOOD_GRAVEYARD_TAKEN     = 59,
    AV_TEXT_H_HERALD_ICEBLOOD_GRAVEYARD_ATTACK    = 60,
    AV_TEXT_A_HERALD_ICEBLOOD_GRAVEYARD_TAKEN     = 61,
    AV_TEXT_A_HERALD_ICEBLOOD_GRAVEYARD_ATTACK    = 62,
    AV_TEXT_A_HERALD_COLDTOOTH_MINE_TAKEN         = 63,
    AV_TEXT_A_HERALD_IRONDEEP_MINE_TAKEN          = 64,
    AV_TEXT_H_HERALD_COLDTOOTH_MINE_TAKEN         = 65,
    AV_TEXT_H_HERALD_IRONDEEP_MINE_TAKEN          = 66,
    AV_TEXT_HERALD_FROSTWOLF_GENERAL_DEAD         = 67,
    AV_TEXT_HERALD_STORMPIKE_GENERAL_DEAD         = 68,
    AV_TEXT_A_HERALD_WIN                          = 69,
    AV_TEXT_H_HERALD_WIN                          = 70
};
