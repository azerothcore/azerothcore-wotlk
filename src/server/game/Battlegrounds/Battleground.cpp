    ...
    if (IsRandom() || BattlegroundMgr::IsBGWeekend(GetBgTypeID(true)))
    {
        ...
        switch (GetBgTypeID(true))
        {
            case BATTLEGROUND_AB:
                ...
                CastSpellOnTeam(SPELL_AB_QUEST_REWARD, GetTeamId(winnerTeamId));
                break;
            case BATTLEGROUND_AV:
                // Call to Arms: Alterac Valley
                CastSpellOnTeam(SPELL_AV_QUEST_REWARD, GetTeamId(winnerTeamId));
                break;
            case BATTLEGROUND_EY:
                // Call to Arms: Eye of the Storm
                CastSpellOnTeam(SPELL_EY_QUEST_REWARD, GetTeamId(winnerTeamId));
                break;
            case BATTLEGROUND_WS:
                // Call to Arms: Warsong Gulch
                CastSpellOnTeam(SPELL_WS_QUEST_REWARD, GetTeamId(winnerTeamId));
                break;
            default:
                break;
        }
