...
void ObjectMgr::LoadCreatureTemplate(Field* fields)
{
    ...
    creatureTemplate.PetSpellDataId        = fields[40].GetUInt32();
    ...
    creatureTemplate.InhabitType           = uint32(fields[46].GetUInt8());
    creatureTemplate.HoverHeight           = fields[47].GetFloat();
    creatureTemplate.ModHealth             = fields[48].GetFloat();
    creatureTemplate.ModMana               = fields[49].GetFloat();
    creatureTemplate.ModArmor              = fields[50].GetFloat();
    creatureTemplate.ModExperience         = fields[51].GetFloat();
    creatureTemplate.RacialLeader          = fields[52].GetBool();
    creatureTemplate.movementId            = fields[53].GetUInt32();
    creatureTemplate.RegenHealth           = fields[54].GetBool();
    creatureTemplate.MechanicImmuneMask    = fields[55].GetUInt32();
    creatureTemplate.SpellSchoolImmuneMask = fields[56].GetUInt8();
    creatureTemplate.flags_extra           = fields[57].GetUInt32();
    creatureTemplate.ScriptID              = GetScriptId(fields[58].GetCString());
}
...
void ObjectMgr::LoadCreatureDefaultTrainers()
{
    ...
    if (QueryResult result = WorldDatabase.Query("SELECT CreatureId, TrainerId FROM creature_default_trainer"))
    {
        do
        {
            ...
            Trainer::Trainer* trainer = Acore::Containers::MapGetValuePtr(_trainers, trainerId);
            if (!trainer)
            {
