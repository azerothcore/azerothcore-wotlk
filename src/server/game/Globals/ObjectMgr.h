...
class ObjectMgr
{
    ...
    public:
        ...
        bool IsVendorItemValid(uint32 vendor_entry, uint32 item, int32 maxcount, uint32 ptime, uint32 ExtendedCost, Player* player = NULL, [[maybe_unused]] std::set<uint32>* skip_vendors = NULL, [[maybe_unused]] uint32 ORnpcflag = 0) const;
