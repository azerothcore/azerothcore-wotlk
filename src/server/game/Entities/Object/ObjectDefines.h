...
inline auto PAIR64_HIPART(uint64 x) -> uint32;
inline auto PAIR64_LOPART(uint64 x) -> uint32;
inline auto MAKE_PAIR16(uint8 l, uint8 h) -> uint16;
inline auto MAKE_PAIR32(uint16 l, uint16 h) -> uint32;
inline auto PAIR32_HIPART(uint32 x) -> uint16;
inline auto PAIR32_LOPART(uint32 x) -> uint16;
...
auto PAIR64_HIPART(uint64 x) -> uint32
{
    return (uint32)((x >> 32) & UI64LIT(0x00000000FFFFFFFF));
}

auto PAIR64_LOPART(uint64 x) -> uint32
{
    return (uint32)(x & UI64LIT(0x00000000FFFFFFFF));
}

auto MAKE_PAIR16(uint8 l, uint8 h) -> uint16
{
    return uint16(l | (uint16(h) << 8));
}

auto MAKE_PAIR32(uint16 l, uint16 h) -> uint32
{
    return uint32(l | (uint32(h) << 16));
}

auto PAIR32_HIPART(uint32 x) -> uint16
{
    return (uint16)((x >> 16) & 0x0000FFFF);
}

auto PAIR32_LOPART(uint32 x) -> uint16
{
