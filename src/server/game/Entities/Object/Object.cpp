...
WorldObject::WorldObject(bool isWorldObject) : WorldLocation(),
    LastUsedScriptID(0), _heartbeatTimer(HEARTBEAT_INTERVAL), m_name(""), m_isActive(false), m_visibilityDistanceOverride(), m_isWorldObject(isWorldObject), m_zoneScript(nullptr),
