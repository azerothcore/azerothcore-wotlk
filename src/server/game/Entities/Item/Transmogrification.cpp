...
void Transmogrification::LoadConfig(bool /*reload*/)
{
    ...
    SetNpcText = uint32(sConfigMgr->GetOption<int32>("Transmogrification.SetNpcText", 65001));
    ...
    TransmogNpcText = uint32(sConfigMgr->GetOption<int32>("Transmogrification.TransmogNpcText", 65000));
    ...
    ScaledCostModifier = sConfigMgr->GetOption<bool>("Transmogrification.ScaledCostModifier", 1.0f);
    ...
    AllowMixedInventoryTypes = sConfigMgr->GetOption<bool>("Transmogrification.AllowMixedInventoryTypes", false);
    ...
    IgnorePlayerMissingProfiency = sConfigMgr->GetOption<bool>("Transmogrification.IgnorePlayerMissingProfiency", false);
    IgnoreReqFaction = sConfigMgr->GetOption<bool>("Transmogrification.IgnoreReqFaction", false);
    IgnoreReqBound = sConfigMgr->GetOption<int32>("Transmogrification.IgnoreReqBound", 0);
}
