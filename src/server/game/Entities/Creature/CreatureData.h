...
enum CreatureFlagsExtra : uint32
{
    ...
    // Masks
    //npcbot
    CREATURE_FLAG_EXTRA_NPCBOT                          = (CREATURE_FLAG_EXTRA_DONT_CALL_ASSISTANCE | CREATURE_FLAG_DONT_OVERRIDE_ENTRY_SAI | CREATURE_FLAG_EXTRA_IGNORE_ALL_ASSISTANCE_CALLS),
    CREATURE_FLAG_EXTRA_NPCBOT_PET                      = (CREATURE_FLAG_EXTRA_DONT_CALL_ASSISTANCE | CREATURE_FLAG_DONT_OVERRIDE_ENTRY_SAI),
    //end npcbot
