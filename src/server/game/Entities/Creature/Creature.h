...
public:
    ...
    */
    ...
    [[nodiscard]] uint32 GetGossipMenuId() const { return m_gossipMenuId ? m_gossipMenuId : GetCreatureTemplate()->GossipMenuId; }
    void SetGossipMenuId(uint32 gossipMenuId) { m_gossipMenuId = gossipMenuId; }
