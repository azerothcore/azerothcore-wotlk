...
public:
    ...
    void SendMessageToSetInRange(WorldPacket const* data, float dist, bool self, bool required3dDist /*= false*/, bool includeMargin = false, Player const* skipped_rcvr = nullptr) const; // pussywizard!
