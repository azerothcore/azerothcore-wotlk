...
public:
    ...
    static bool HasSpellMod(SpellModifier* mod, Spell* spell);

    template <class T>
    void ApplySpellMod(uint32 spellId, SpellModOp op, T& basevalue, Spell* spell = nullptr, bool temporaryPet = false) const;

    void RemoveSpellMods(Spell* spell);
    void RestoreSpellMods(Spell* spell, uint32 ownerAuraId = 0, Aura* aura = nullptr);
    void RestoreAllSpellMods(uint32 ownerAuraId = 0, Aura* aura = nullptr);
    static void DropModCharge(SpellModifier* mod, Spell* spell);
