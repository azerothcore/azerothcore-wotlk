...
Creature* Player::GetNPCIfCanInteractWith(ObjectGuid guid, uint32 npcflagmask)
{
    ...
    if (npcflagmask & (UNIT_NPC_FLAG_TRAINER | UNIT_NPC_FLAG_TRAINER_CLASS) && creature->GetCreatureTemplate()->trainer_type == TrainerType::Class && getClass() != creature->GetCreatureTemplate()->trainer_class)
        return nullptr;
...
void Player::DuelComplete(DuelCompleteType type)
{
    ...
    data << (uint8)((type != DuelCompleteType::Interrupted) ? 1 : 0);
    GetSession()->SendPacket(&data);
    ...
    if (type != DuelCompleteType::Interrupted)
    {
        ...
        data << uint8(type == DuelCompleteType::Won ? 0 : 1);            // 0 = just won; 1 = fled
    ...
    // Victory emote spell
    if (type != DuelCompleteType::Interrupted && duel->opponent)
