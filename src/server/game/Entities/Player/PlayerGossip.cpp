            ...
            switch (itr->second.OptionType)
            {
                ...
                case GOSSIP_OPTION_VENDOR:
                {
                    if (!creature->isVendorWithIconSpeak())
                    {
                        ...
                        {
                            LOG_ERROR("db.query", "Creature {} have UNIT_NPC_FLAG_VENDOR but have empty trading item list.", creature->GetGUID().ToString());
                            canTalk = false;
                        }
                        break;
                    }
                ...
                case GOSSIP_OPTION_OUTDOORPVP:
                    ...
                    break;
                default:
                    LOG_ERROR("db.query", "Creature entry {} has unknown OptionType {} for menu {}", creature->GetEntry(), itr->second.OptionType, itr->second.MenuID);
                    canTalk = false;
                    break;
            }
        }
