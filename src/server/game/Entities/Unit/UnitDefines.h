...
enum UnitState
{
    ...
    UNIT_STATE_NO_COMBAT_MOVEMENT       = 0x40000000,       // serverside only - should never be changed outside of core and hence shouldnt have a defined static value and be at the end
