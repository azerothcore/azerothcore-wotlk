...
enum ClassContext : uint8
{
    ...
    CLASS_CONTEXT_EQUIP_RELIC       = 11,
    CLASS_CONTEXT_EQUIP_SHIELDS     = 12,
    CLASS_CONTEXT_EQUIP_ARMOR_CLASS = 13,
    CLASS_CONTEXT_WEAPON_SWAP       = 14,
    CLASS_CONTEXT_GRAVEYARD         = 15,
    CLASS_CONTEXT_CLASS_TRAINER     = 16
};
