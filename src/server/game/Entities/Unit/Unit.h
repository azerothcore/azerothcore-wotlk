...
public:
    ...
    [[nodiscard]] bool IsLevitating() const { return (m_movement.m_moveFlags & MOVEMENTFLAG_DISABLE_GRAVITY) != 0; }
    [[nodiscard]] bool IsWalking() const { return (m_movement.m_moveFlags & MOVEMENTFLAG_WALKING) != 0; }
    [[nodiscard]] bool isMoving() const { return (m_movement.m_moveFlags & MOVEMENTFLAG_MASK_MOVING) != 0; }
    [[nodiscard]] bool isTurning() const { return (m_movement.m_moveFlags & MOVEMENTFLAG_MASK_TURNING) != 0; }
    [[nodiscard]] bool IsHovering() const { return (m_movement.m_moveFlags & MOVEMENTFLAG_HOVER) != 0; }
    [[nodiscard]] bool isSwimming() const { return (m_movement.m_moveFlags & MOVEMENTFLAG_SWIMMING) != 0; }
    [[nodiscard]] virtual bool CanFly() const = 0;
    [[nodiscard]] bool IsFlying() const { return (m_movement.m_moveFlags & (MOVEMENTFLAG_FLYING | MOVEMENTFLAG_DISABLE_GRAVITY)) != 0; }
