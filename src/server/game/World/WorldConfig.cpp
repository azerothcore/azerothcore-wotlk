...
void WorldConfig::BuildConfigCache()
{
    ...
    SetConfigValue<float>(CONFIG_TAXI_FLIGHT_SPEED, "TaxiFlightSpeed", 32.0f, ConfigValueCache::Reloadable::Yes, [](float const& value) { return value > 0.0f && value <= 50.0f; }, "> 0 && <= 50");
