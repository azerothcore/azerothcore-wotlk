...
private:
    ...
    auto operator=(CliCommandHolder const& right) -> CliCommandHolder& = delete;
};
...
public:
    ...
    [[nodiscard]] virtual auto FindSession(uint32 id) const -> WorldSession* = 0;
    [[nodiscard]] virtual auto FindOfflineSession(uint32 id) const -> WorldSession* = 0;
    [[nodiscard]] virtual auto FindOfflineSessionForCharacterGUID(ObjectGuid::LowType guidLow) const -> WorldSession* = 0;
    virtual void AddSession(WorldSession* s) = 0;
    virtual void SendAutoBroadcast() = 0;
    virtual auto KickSession(uint32 id) -> bool = 0;
    virtual void UpdateMaxSessionCounters() = 0;
    [[nodiscard]] virtual auto GetAllSessions() const -> const SessionMap& = 0;
    [[nodiscard]] virtual auto GetActiveAndQueuedSessionCount() const -> uint32 = 0;
    [[nodiscard]] virtual auto GetActiveSessionCount() const -> uint32 = 0;
    [[nodiscard]] virtual auto GetQueuedSessionCount() const -> uint32 = 0;
    [[nodiscard]] virtual auto GetMaxQueuedSessionCount() const -> uint32 = 0;
    [[nodiscard]] virtual auto GetMaxActiveSessionCount() const -> uint32 = 0;
    [[nodiscard]] virtual auto GetPlayerCount() const -> uint32 = 0;
    [[nodiscard]] virtual auto GetMaxPlayerCount() const -> uint32 = 0;
    virtual void IncreasePlayerCount() = 0;
    virtual void DecreasePlayerCount() = 0;
    virtual auto FindPlayerInZone(uint32 zone) -> Player* = 0;
    [[nodiscard]] virtual auto IsClosed() const -> bool = 0;
    virtual void SetClosed(bool val) = 0;
    [[nodiscard]] virtual auto GetPlayerSecurityLimit() const -> AccountTypes = 0;
    ...
    [[nodiscard]] virtual auto GetPlayerAmountLimit() const -> uint32 = 0;
    virtual void AddQueuedPlayer(WorldSession*) = 0;
    virtual auto RemoveQueuedPlayer(WorldSession* session) -> bool = 0;
    virtual auto GetQueuePos(WorldSession*) -> int32 = 0;
    virtual auto HasRecentlyDisconnected(WorldSession*) -> bool = 0;
    [[nodiscard]] virtual auto getAllowMovement() const -> bool = 0;
    virtual void SetAllowMovement(bool allow) = 0;
    virtual void SetNewCharString(std::string const& str) = 0;
    [[nodiscard]] virtual auto GetNewCharString() const -> std::string const& = 0;
    [[nodiscard]] virtual auto GetDefaultDbcLocale() const -> LocaleConstant = 0;
    [[nodiscard]] virtual auto GetDataPath() const -> std::string const& = 0;
    [[nodiscard]] virtual auto GetStartTime() const -> time_t const& = 0;
    [[nodiscard]] virtual auto GetGameTime() const -> time_t const& = 0;
    [[nodiscard]] virtual auto GetUptime() const -> uint32 = 0;
    [[nodiscard]] virtual auto GetUpdateTime() const -> uint32 = 0;
    virtual void SetRecordDiffInterval(int32 t)  = 0;
    [[nodiscard]] virtual auto GetNextDailyQuestsResetTime() const -> time_t = 0;
    [[nodiscard]] virtual auto GetNextWeeklyQuestsResetTime() const -> time_t = 0;
    [[nodiscard]] virtual auto GetNextRandomBGResetTime() const -> time_t = 0;
    [[nodiscard]] virtual auto GetConfigMaxSkillValue() const -> uint16 = 0;
    ...
    virtual auto SendZoneMessage(uint32 zone, WorldPacket* packet, WorldSession* self = nullptr, TeamId teamId = TEAM_NEUTRAL) -> bool = 0;
    ...
    [[nodiscard]] virtual auto IsShuttingDown() const -> bool = 0;
    [[nodiscard]] virtual auto GetShutDownTimeLeft() const -> uint32 = 0;
    ...
    [[nodiscard]] virtual auto getRate(Rates rate) const -> float = 0;
    virtual void setBoolConfig(WorldBoolConfigs index, bool value) = 0;
    [[nodiscard]] virtual auto getBoolConfig(WorldBoolConfigs index) const -> bool = 0;
    virtual void setFloatConfig(WorldFloatConfigs index, float value) = 0;
    [[nodiscard]] virtual auto getFloatConfig(WorldFloatConfigs index) const -> float = 0;
    virtual void setIntConfig(WorldIntConfigs index, uint32 value) = 0;
    [[nodiscard]] virtual auto getIntConfig(WorldIntConfigs index) const -> uint32 = 0;
    virtual void setWorldState(uint32 index, uint64 value) = 0;
    [[nodiscard]] virtual auto getWorldState(uint32 index) const -> uint64 = 0;
    virtual void LoadWorldStates() = 0;
    [[nodiscard]] virtual auto IsPvPRealm() const -> bool = 0;
    [[nodiscard]] virtual auto IsFFAPvPRealm() const -> bool = 0;
    virtual void KickAll() = 0;
    virtual void KickAllLess(AccountTypes sec) = 0;
    virtual auto GetNextWhoListUpdateDelaySecs() -> uint32 = 0;
    ...
    [[nodiscard]] virtual auto GetAvailableDbcLocale(LocaleConstant locale) const -> LocaleConstant = 0;
    virtual void LoadDBVersion() = 0;
    virtual void LoadDBRevision() = 0;
    [[nodiscard]] virtual auto GetDBVersion() const -> char const* = 0;
    [[nodiscard]] virtual auto GetWorldDBRevision() const -> char const* = 0;
    [[nodiscard]] virtual auto GetCharacterDBRevision() const -> char const* = 0;
    [[nodiscard]] virtual auto GetAuthDBRevision() const -> char const* = 0;
    virtual void LoadAutobroadcasts() = 0;
    virtual void UpdateAreaDependentAuras() = 0;
    [[nodiscard]] virtual auto GetCleaningFlags() const -> uint32 = 0;
    virtual void   SetCleaningFlags(uint32 flags) = 0;
    virtual void   ResetEventSeasonalQuests(uint16 event_id) = 0;
    virtual auto GetNextTimeWithDayAndHour(int8 dayOfWeek, int8 hour) -> time_t = 0;
    virtual auto GetNextTimeWithMonthAndHour(int8 month, int8 hour) -> time_t = 0;
    [[nodiscard]] virtual auto GetRealmName() const -> std::string const& = 0;
