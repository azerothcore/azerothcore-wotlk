...
enum ServerConfigs
{
    ...
    CONFIG_PREVENT_ITEM_UNEQUIP,
    CONFIG_RACE_CUSTOMIZATION,
    CONFIG_WEB_SERVICE_DELETE_ALL_CHARS, // WSC-CL
    CONFIG_WEB_SERVICE_ONLY_CREATION, // WSC-CL
    ...
    CONFIG_BATTLEGROUND_WARSONG_TIMER_ACTIVE,
    CONFIG_BATTLEGROUND_WARSONG_MAX_TEAM_SCORE,
    CONFIG_BATTLEGROUND_WARSONG_MAX_TIME,
    CONFIG_BATTLEGROUND_WARSONG_BERSERKER_HUTS_ENABLED,
    CONFIG_BATTLEGROUND_WARSONG_BERSERKER_HUTS_TIMER,
    CONFIG_BATTLEGROUND_WARSONG_LEAFS_ENABLED,
    CONFIG_BATTLEGROUND_WARSONG_LEAFS_TIMER,
    CONFIG_BATTLEGROUND_WARSONG_BOOTS_ENABLED,
    CONFIG_BATTLEGROUND_WARSONG_BOOTS_TIMER,
    CONFIG_BATTLEGROUND_WARSONG_RANDOM_BUFFS_ENABLED,
    CONFIG_BATTLEGROUND_WARSONG_MAX_OFFLINE_TIME,
