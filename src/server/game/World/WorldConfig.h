...
enum ServerConfigs
{
    ...
    CONFIG_MAIL_PUSH_INBOX_ON_DELIVERY,
    ...
    RATE_DROP_MONEY,
    RATE_MINING_DROP_AMOUNT,
    RATE_HERBALISM_DROP_AMOUNT,
    RATE_SKINNING_DROP_AMOUNT,
    RATE_FISHING_DROP_AMOUNT,
    RATE_MILLING_DROP_AMOUNT,
    RATE_PROSPECTING_DROP_AMOUNT,
    RATE_DISENCHANTING_DROP_AMOUNT,
    RATE_PICKPOCKETING_DROP_AMOUNT,
