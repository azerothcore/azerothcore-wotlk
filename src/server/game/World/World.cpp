...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_WATER_BREATH_TIMER]                       = sConfigMgr->GetOption<uint32>("WaterBreath.Timer", 3000.0f);
    if (m_int_configs[CONFIG_WATER_BREATH_TIMER] <= 0)
    {
        LOG_ERROR("server.loading", "WaterBreath.Timer ({}) must be > 0. Using 3000 instead.", m_int_configs[CONFIG_WATER_BREATH_TIMER]);
        m_int_configs[CONFIG_WATER_BREATH_TIMER] = 3000;
    }
