...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_DISABLE_FATIGUE] = sConfigMgr->GetOption<int32>("DisableFatigue", SEC_CONSOLE); //Disable Fatigue
...
void World::ShutdownMsg(bool show, Player* player, const std::string& reason)
{
    ...
    if (show ||
            (m_ShutdownTimer < 2 * MINUTE && (m_ShutdownTimer % 15) == 0) || // < 5 min; every 15 sec
