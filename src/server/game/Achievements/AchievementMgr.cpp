...
void AchievementGlobalMgr::CompletedAchievementForOfflinePlayer(WOWGUID::LowType playerLowGuid, AchievementEntry const* entry)
{
...
void AchievementGlobalMgr::UpdateAchievementCriteriaForOfflinePlayer(WOWGUID::LowType playerLowGuid, AchievementCriteriaTypes type, uint32 miscValue1, uint32 miscValue2)
{
    CharacterDatabasePreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_INS_CHAR_ACHIEVEMENT_OFFLINE_UPDATES);
    stmt->SetData(0, playerLowGuid);
