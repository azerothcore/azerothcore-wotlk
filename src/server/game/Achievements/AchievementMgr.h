...
public:
    ...
    void CompletedAchievementForOfflinePlayer(WOWGUID::LowType playerLowGuid, AchievementEntry const* entry);
    void UpdateAchievementCriteriaForOfflinePlayer(WOWGUID::LowType playerLowGuid, AchievementCriteriaTypes type, uint32 miscValue1 = 0, uint32 miscValue2 = 0);
private:
