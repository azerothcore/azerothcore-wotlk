...
public:
    ...
    struct boss_anzuAI : public ScriptedAI
    {
        ...
        void SummonBroods()
        {
            ...
            for (uint8 i = 0; i < 5; ++i)
                me->SummonCreature(23132 /*NPC_BROOD_OF_ANZU*/, me->GetPositionX() + 20 * std::cos((float)i), me->GetPositionY() + 20 * std::sin((float)i), me->GetPositionZ() + 25.0f, 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 30000);
        }
