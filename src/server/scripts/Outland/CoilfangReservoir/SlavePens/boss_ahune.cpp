            ...
            switch(events.ExecuteEvent())
            {
                ...
                case EVENT_SPELL_SUMMON_HAILSTONE:
                    {
                        ...
                        me->CastSpell(MinionSummonPos.GetPositionX() + std::cos(angle)*dist, MinionSummonPos.GetPositionY() + sin(angle)*dist, MinionSummonPos.GetPositionZ(), SPELL_SUMMON_HAILSTONE, false);
                ...
                case EVENT_SPELL_SUMMON_COLDWAVE:
                    for (uint8 i = 0; i < 2; ++i)
                    {
                        float dist = (float)urand(3, 10);
                        float angle = rand_norm() * 2 * M_PI;
                        me->CastSpell(MinionSummonPos.GetPositionX() + std::cos(angle)*dist, MinionSummonPos.GetPositionY() + sin(angle)*dist, MinionSummonPos.GetPositionZ(), SPELL_SUMMON_COLDWAVE, false);
                    }
                    {
                        float dist = (float)urand(3, 10);
                        float angle = rand_norm() * 2 * M_PI;
                        me->CastSpell(MinionSummonPos.GetPositionX() + std::cos(angle)*dist, MinionSummonPos.GetPositionY() + sin(angle)*dist, MinionSummonPos.GetPositionZ(), SPELL_SUMMON_FROSTWIND, false);
                    }
