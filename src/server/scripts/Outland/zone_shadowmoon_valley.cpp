...
public:
    ...
    struct npc_drake_dealer_hurlunkAI : ScriptedAI
    {
        npc_drake_dealer_hurlunkAI(Creature* c) : ScriptedAI(c) { }
...
public:
    ...
    struct npcs_flanis_swiftwing_and_kagroshAI : ScriptedAI
    {
        npcs_flanis_swiftwing_and_kagroshAI(Creature* c) : ScriptedAI(c) { }
