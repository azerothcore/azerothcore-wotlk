...
public:
    ...
    struct npc_akamaAI : public ScriptedAI
    {
        ...
        void JustSummoned(Creature* summon) override
        {
            ...
            summon->SetWalk(true);
            summon->GetMotionMaster()->MovePoint(POINT_START, summon->GetPositionX() + dist * std::cos(summon->GetOrientation()), summon->GetPositionY() + dist * sin(summon->GetOrientation()), summon->GetPositionZ(), false);
