...
struct go_transport_the_iron_eagle : GameObjectAI
{
    ...
    {
        sWorld->setWorldState(WORLD_STATE_THE_IRON_EAGLE, eventId);
        switch (eventId)
        {
...
struct go_transport_the_thundercaller : GameObjectAI
{
    ...
    void EventInform(uint32 eventId) override
    {
        sWorld->setWorldState(WORLD_STATE_THE_THUNDERCALLER, eventId);
        switch (eventId)
        {
...
struct go_transport_the_purple_princess : GameObjectAI
{
    ...
    void EventInform(uint32 eventId) override
    {
        sWorld->setWorldState(WORLD_STATE_THE_PURPLE_PRINCESS, eventId);
        switch (eventId)
        {
