                            ...
                            case EVENT_SPAWN_WAVE_1:
                                {
                                    ...
                                    spawnPos.m_positionX += 5.0f * std::cos(4.5f);
                                    ...
                                    for (uint8 i = 0; i < 5; ++i)
                                        ...
                                        {
                                            spawnPos.m_positionX += 2.5f * std::cos(4.5f);
                            ...
                            case EVENT_SPAWN_WAVE_2:
                                {
                                    Position spawnPos = c->GetPosition();
                                    spawnPos.SetOrientation(5.80f);
                                    spawnPos.m_positionX += 7.0f * std::cos(4.0f);
                                    ...
                                    for (uint8 i = 0; i < 3; ++i)
                                        if (Creature* s = me->SummonCreature(NPC_GHOUL_INVADER, spawnPos, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 2000))
                                        {
                                            ...
                                            spawnPos.m_positionX += 4.0f * std::cos(4.5f);
                            ...
                            case EVENT_SPAWN_WAVE_3:
                                {
                                    Position spawnPos = c->GetPosition();
                                    spawnPos.SetOrientation(5.80f);
                                    spawnPos.m_positionX += 8.0f * std::cos(4.0f);
