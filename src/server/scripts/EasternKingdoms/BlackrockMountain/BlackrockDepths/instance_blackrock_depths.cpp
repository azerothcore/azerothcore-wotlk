...
struct instance_blackrock_depths : public InstanceScript
{
    instance_blackrock_depths(Map* map) : InstanceScript(map)
    {
...
{
    RegisterInstanceScript(instance_blackrock_depths, MAP_BLACKROCK_DEPTHS);
}
