...
struct instance_blackrock_spire : public InstanceScript
{
...
struct npc_vaelastrasz_the_red : public CreatureAI
{
    npc_vaelastrasz_the_red(Creature* creature) : CreatureAI(creature) { }
...
{
    RegisterInstanceScript(instance_blackrock_spire, MAP_BLACKROCK_SPIRE);
    ...
    RegisterBlackrockSpireCreatureAI(npc_vaelastrasz_the_red);
}
