...
constexpr std::array<std::string, MAX_ITEM_SUBCLASS_CONTAINER> bagSpecsToString =
{
    "normal",
    "soul",
    "herb",
...
constexpr std::array<std::string, MAX_ITEM_SUBCLASS_CONTAINER> bagSpecsColorToString =
{
    "normal",
    "soul",
    "herb",
