...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "dev",                SEC_DEVS,               false, &HandleDevCommand,                   "" },
            ...
            { "appear",             SEC_TrialGM,                false, &HandleAppearCommand,                "" },
            ...
            { "cooldown",           SEC_Fulltester,         false, &HandleCooldownCommand,              "" },
            { "distance",           SEC_ADMINISTRATOR,      false, &HandleGetDistanceCommand,           "" },
            { "recall",             SEC_Fulltester,         false, &HandleRecallCommand,                "" },
            ...
            { "pinfo",              SEC_TrialGM,            true,  &HandlePInfoCommand,                 "" },
