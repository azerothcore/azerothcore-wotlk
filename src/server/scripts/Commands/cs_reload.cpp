...
public:
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            cInfo->unit_class               = fields[26].GetUInt8();
            cInfo->unit_flags               = fields[27].GetUInt32();
            cInfo->unit_flags2              = fields[28].GetUInt32();
            cInfo->dynamicflags             = fields[29].GetUInt32();
            cInfo->family                   = fields[30].GetUInt8();
            cInfo->trainer_type             = fields[31].GetUInt8();
            cInfo->trainer_spell            = fields[32].GetUInt32();
            cInfo->trainer_class            = fields[33].GetUInt8();
            cInfo->trainer_race             = fields[34].GetUInt8();
            cInfo->type                     = fields[35].GetUInt8();
            cInfo->type_flags               = fields[36].GetUInt32();
            cInfo->lootid                   = fields[37].GetUInt32();
            cInfo->pickpocketLootId         = fields[38].GetUInt32();
            cInfo->SkinLootId               = fields[39].GetUInt32();
            ...
            cInfo->maxgold                  = fields[57].GetUInt32();
            cInfo->AIName                   = fields[58].GetString();
            cInfo->MovementType             = fields[59].GetUInt8();
            cInfo->InhabitType              = fields[60].GetUInt8();
            cInfo->HoverHeight              = fields[61].GetFloat();
            cInfo->ModHealth                = fields[62].GetFloat();
            cInfo->ModMana                  = fields[63].GetFloat();
            cInfo->ModArmor                 = fields[64].GetFloat();
            cInfo->RacialLeader             = fields[65].GetBool();
            cInfo->movementId               = fields[66].GetUInt32();
            cInfo->RegenHealth              = fields[67].GetBool();
            cInfo->MechanicImmuneMask       = fields[68].GetUInt32();
            cInfo->SpellSchoolImmuneMask    = fields[69].GetUInt32();
            cInfo->flags_extra              = fields[70].GetUInt32();
            cInfo->ScriptID                 = sObjectMgr->GetScriptId(fields[71].GetCString());
