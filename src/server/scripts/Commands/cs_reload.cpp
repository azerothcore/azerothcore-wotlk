...
public:
    ...
    {
        LOG_INFO("root", "Re-Loading Battleground Templates...");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables...");
        LoadLootTables();
    ...
    static bool HandleReloadAllQuestCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        LOG_INFO("root", "Re-Loading Quests Relations...");
    ...
    static bool HandleReloadAllScriptsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        LOG_INFO("root", "Re-Loading Scripts...");
    ...
    {
        LOG_INFO("root", "Re-Loading config settings...");
    ...
    {
        LOG_INFO("root", "Re-Loading Access Requirement definitions...");
    ...
    {
        LOG_INFO("root", "Re-Loading Additional Achievement Criteria Data...");
    ...
    {
        LOG_INFO("root", "Re-Loading Achievement Reward Data...");
    ...
    {
        LOG_INFO("root", "Re-Loading Tavern Area Triggers...");
    ...
    {
        LOG_INFO("root", "Re-Loading Area Trigger definitions...");
    ...
    {
        LOG_INFO("root", "Re-Loading Area Trigger teleport definitions...");
    ...
    {
        LOG_INFO("root", "Re-Loading Autobroadcasts...");
    ...
    {
        LOG_INFO("root", "Re-Loading Broadcast texts...");
    ...
    {
        LOG_INFO("root", "Re-Loading creature award reputation definitions...");
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            LOG_INFO("root", "Reloading creature template entry %u", entry);
    ...
    {
        LOG_INFO("root", "Loading Quests Relations... (`creature_queststarter`)");
    ...
    {
        LOG_INFO("root", "Loading Linked Respawns... (`creature_linked_respawn`)");
    ...
    {
        LOG_INFO("root", "Loading Quests Relations... (`creature_questender`)");
    ...
    {
        LOG_INFO("root", "Re-Loading `gossip_menu` Table!");
    ...
    {
        LOG_INFO("root", "Re-Loading `gossip_menu_option` Table!");
    ...
    {
        LOG_INFO("root", "Loading Quests Relations... (`gameobject_queststarter`)");
    ...
    {
        LOG_INFO("root", "Loading Quests Relations... (`gameobject_questender`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Quest Area Triggers...");
    ...
    {
        LOG_INFO("root", "Re-Loading Quest Templates...");
        sObjectMgr->LoadQuests();
        handler->SendGlobalGMSysMessage("DB table `quest_template` (quest definitions) reloaded.");

        /// dependent also from `gameobject` but this table not reloaded anyway
        LOG_INFO("root", "Re-Loading GameObjects for quests...");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`creature_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`disenchant_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`fishing_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`gameobject_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`item_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`milling_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`pickpocketing_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`prospecting_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`mail_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`reference_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`skinning_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading Loot Tables... (`spell_loot_template`)");
    ...
    {
        LOG_INFO("root", "Re-Loading trinity_string Table!");
    ...
    static bool HandleReloadWardenactionCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        LOG_INFO("root", "Re-Loading warden_action Table!");
    ...
    {
        LOG_INFO("root", "Re-Loading `npc_trainer` Table!");
    ...
    {
        LOG_INFO("root", "Re-Loading `npc_vendor` Table!");
    ...
    {
        LOG_INFO("root", "Re-Loading `points_of_interest` Table!");
    ...
    {
        LOG_INFO("root",  "Re-Loading Quest POI ..." );
    ...
    {
        LOG_INFO("root", "Re-Loading `npc_spellclick_spells` Table!");
    ...
    {
        LOG_INFO("root", "Loading ReservedNames... (`reserved_name`)");
    ...
    {
        LOG_INFO("root",  "Re-Loading `reputation_reward_rate` Table!" );
    ...
    {
        LOG_INFO("root",  "Re-Loading `reputation_spillover_template` Table!" );
    ...
    {
        LOG_INFO("root", "Re-Loading Skill Discovery Table...");
    ...
    static bool HandleReloadSkillPerfectItemTemplateCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        LOG_INFO("root", "Re-Loading Skill Perfection Data Table...");
    ...
    {
        LOG_INFO("root", "Re-Loading Skill Extra Item Table...");
    ...
    {
        LOG_INFO("root", "Re-Loading Skill Fishing base level requirements...");
    ...
    {
        LOG_INFO("root", "Re-Loading SpellArea Data...");
    ...
    {
        LOG_INFO("root", "Re-Loading Spell Required Data... ");
    ...
    {
        LOG_INFO("root", "Re-Loading Spell Groups...");
    ...
    {
        LOG_INFO("root", "Re-Loading Spell Linked Spells...");
    ...
    {
        LOG_INFO("root", "Re-Loading Spell Proc Event conditions...");
    ...
    {
        LOG_INFO("root", "Re-Loading Spell Proc conditions and data...");
    ...
    {
        LOG_INFO("root", "Re-Loading Spell Bonus Data...");
    ...
    {
        LOG_INFO("root", "Re-Loading Spell target coordinates...");
    ...
    {
        LOG_INFO("root", "Re-Loading Aggro Spells Definitions...");
    ...
    {
        LOG_INFO("root", "Re-Loading Spell Group Stack Rules...");
    ...
    {
        LOG_INFO("root", "Re-Loading Spell pet auras...");
    ...
    {
        LOG_INFO("root", "Re-Loading Page Texts...");
    ...
    {
        LOG_INFO("root", "Re-Loading Item Random Enchantments Table...");
    ...
    {
        LOG_INFO("root", "Re-Loading Item set names...");
    ...
    static bool HandleReloadEventScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            LOG_INFO("root", "Re-Loading Scripts from `event_scripts`...");
    ...
    static bool HandleReloadWpScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            LOG_INFO("root", "Re-Loading Scripts from `waypoint_scripts`...");
    ...
    {
        if (*args != 'a')
            LOG_INFO("root", "Re-Loading Waypoints data from 'waypoints_data'");
    ...
    static bool HandleReloadSpellScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            LOG_INFO("root", "Re-Loading Scripts from `spell_scripts`...");
    ...
    {
        LOG_INFO("root", "Re-Loading Graveyard-zone links...");
    ...
    {
        LOG_INFO("root", "Re-Loading Game Tele coordinates...");
    ...
    {
        LOG_INFO("root", "Re-Loading disables table...");
    ...
    {
        LOG_INFO("root", "Re-Loading Achievement Reward Data Locale...");
    ...
    {
        LOG_INFO("root", "Re-Loading lfg dungeon rewards...");
        sLFGMgr->LoadRewards();
    ...
    {
        LOG_INFO("root", "Re-Loading Creature Template Locale...");
    ...
    {
        LOG_INFO("root", "Re-Loading Creature Texts Locale...");
    ...
    {
        LOG_INFO("root", "Re-Loading Gameobject Template Locale ... ");
    ...
    {
        LOG_INFO("root",  "Re-Loading Gossip Menu Option Locale ... ");
    ...
    {
        LOG_INFO("root", "Re-Loading Item Template Locale ... ");
    ...
    {
        LOG_INFO("root", "Re-Loading Item set name Locale... ");
    ...
    {
        LOG_INFO("root", "Re-Loading NPC Text Locale ... ");
    ...
    {
        LOG_INFO("root", "Re-Loading Page Text Locale ... ");
    ...
    {
        LOG_INFO("root", "Re-Loading Points Of Interest Locale ... ");
    ...
    {
        LOG_INFO("root", "Re-Loading Locales Quest ... ");
    ...
    {
        LOG_INFO("root", "Re-Loading Quest Offer Reward Locale... ");
    ...
    {
        LOG_INFO("root", "Re-Loading Quest Request Item Locale... ");
    ...
    {
        LOG_INFO("root", "Re-Loading Player level dependent mail rewards...");
    ...
    static bool HandleReloadAuctionsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        LOG_INFO("root", "Re-Loading Auctions...");
    ...
    {
        LOG_INFO("root", "Re-Loading Conditions...");
        sConditionMgr->LoadConditions(true);
    ...
    {
        LOG_INFO("root", "Re-Loading Creature Texts...");
    ...
    {
        LOG_INFO("root", "Re-Loading Smart Scripts...");
    ...
    {
        LOG_INFO("root", "Reloading vehicle_accessory table...");
    ...
    {
        LOG_INFO("root", "Reloading vehicle_template_accessory table...");
    ...
    {
        LOG_INFO("root", "Reloading game_graveyard table...");
