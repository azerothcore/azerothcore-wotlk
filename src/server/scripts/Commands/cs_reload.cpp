...
public:
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            cInfo->KillCredit[0]            = fields[4].GetUInt32();
            cInfo->KillCredit[1]            = fields[5].GetUInt32();
            cInfo->Modelid1                 = fields[6].GetUInt32();
            cInfo->Modelid2                 = fields[7].GetUInt32();
            cInfo->Modelid3                 = fields[8].GetUInt32();
            cInfo->Modelid4                 = fields[9].GetUInt32();
            cInfo->Name                     = fields[10].GetString();
            cInfo->SubName                  = fields[11].GetString();
            ...
            cInfo->dmgschool                = fields[23].GetUInt8();
            cInfo->DamageModifier           = fields[24].GetFloat();
            cInfo->BaseAttackTime           = fields[25].GetUInt32();
            cInfo->RangeAttackTime          = fields[26].GetUInt32();
            cInfo->unit_class               = fields[27].GetUInt8();
            cInfo->unit_flags               = fields[28].GetUInt32();
            cInfo->unit_flags2              = fields[29].GetUInt32();
            cInfo->dynamicflags             = fields[30].GetUInt32();
            cInfo->family                   = fields[31].GetUInt8();
            cInfo->trainer_type             = fields[32].GetUInt8();
            cInfo->trainer_spell            = fields[33].GetUInt32();
            cInfo->trainer_class            = fields[34].GetUInt8();
            cInfo->trainer_race             = fields[35].GetUInt8();
            cInfo->type                     = fields[36].GetUInt8();
            cInfo->type_flags               = fields[37].GetUInt32();
            cInfo->lootid                   = fields[38].GetUInt32();
            cInfo->pickpocketLootId         = fields[39].GetUInt32();
            cInfo->SkinLootId               = fields[40].GetUInt32();

            for (uint8 i = SPELL_SCHOOL_HOLY; i < MAX_SPELL_SCHOOL; ++i)
                cInfo->resistance[i] = fields[41 + i - 1].GetUInt16();

            cInfo->spells[0]                = fields[47].GetUInt32();
            cInfo->spells[1]                = fields[48].GetUInt32();
            cInfo->spells[2]                = fields[49].GetUInt32();
            cInfo->spells[3]                = fields[50].GetUInt32();
            cInfo->spells[4]                = fields[51].GetUInt32();
            cInfo->spells[5]                = fields[52].GetUInt32();
            cInfo->spells[6]                = fields[53].GetUInt32();
            cInfo->spells[7]                = fields[54].GetUInt32();
            cInfo->PetSpellDataId           = fields[55].GetUInt32();
            cInfo->VehicleId                = fields[56].GetUInt32();
            cInfo->mingold                  = fields[57].GetUInt32();
            cInfo->maxgold                  = fields[58].GetUInt32();
            cInfo->AIName                   = fields[59].GetString();
            cInfo->MovementType             = fields[60].GetUInt8();
            cInfo->InhabitType              = fields[61].GetUInt8();
            cInfo->HoverHeight              = fields[62].GetFloat();
            cInfo->ModHealth                = fields[63].GetFloat();
            cInfo->ModMana                  = fields[64].GetFloat();
            cInfo->ModArmor                 = fields[65].GetFloat();
            cInfo->RacialLeader             = fields[66].GetBool();
            cInfo->movementId               = fields[67].GetUInt32();
            cInfo->RegenHealth              = fields[68].GetBool();
            cInfo->MechanicImmuneMask       = fields[69].GetUInt32();
            cInfo->SpellSchoolImmuneMask    = fields[70].GetUInt32();
            cInfo->flags_extra              = fields[71].GetUInt32();
            cInfo->ScriptID                 = sObjectMgr->GetScriptId(fields[72].GetCString());
