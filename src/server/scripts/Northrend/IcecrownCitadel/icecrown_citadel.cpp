...
public:
    ...
    struct npc_icc_gauntlet_controllerAI : public NullCreatureAI
    {
        ...
        void SummonBroodling()
        {
            ...
            if (Creature* broodling = me->SummonCreature(NPC_NERUBAR_BROODLING, me->GetPositionX() + std::cos(o) * dist, me->GetPositionY() + std::sin(o) * dist, 250.0f, Position::NormalizeOrientation(o - M_PI)))
            {
