...
Position const MuradinExitPath[MuradinExitPathSize] = {
    {8.130936f, -0.2699585f, 20.31728f, 0.0f}, {6.380936f, -0.2699585f, 20.31728f, 0.0f}, {3.507703f, 0.02986573f, 20.78463f, 0.0f}, {-2.767633f, 3.743143f, 20.37663f, 0.0f}, {-4.017633f, 4.493143f, 20.12663f, 0.0f}, {-7.242224f, 6.856013f, 20.03468f, 0.0f}, {-7.742224f, 8.606013f, 20.78468f, 0.0f}, {-7.992224f, 9.856013f, 21.28468f, 0.0f}, {-12.24222f, 23.10601f, 21.28468f, 0.0f}, {-14.88477f, 25.20844f, 21.59985f, 0.0f},
};

uint32 const   SaurfangExitPathSize                   = 13;
Position const SaurfangExitPath[SaurfangExitPathSize] = {{30.43987f, 0.1475817f, 36.10674f, 0.0f}, {21.36141f, -3.056458f, 35.42970f, 0.0f}, {19.11141f, -3.806458f, 35.42970f, 0.0f}, {19.01736f, -3.299440f, 35.39428f, 0.0f}, {18.6747f, -5.862823f, 35.66611f, 0.0f}, {18.6747f, -7.862823f, 35.66611f, 0.0f}, {18.1747f, -17.36282f, 35.66611f, 0.0f},
                                                         {18.1747f, -22.61282f, 35.66611f, 0.0f},  {17.9247f, -24.36282f, 35.41611f, 0.0f},  {17.9247f, -26.61282f, 35.66611f, 0.0f},  {17.9247f, -27.86282f, 35.66611f, 0.0f},  {17.9247f, -29.36282f, 35.66611f, 0.0f}, {15.33203f, -30.42621f, 35.93796f, 0.0f}};
...
SlotInfo const SkybreakerSlotInfo[MAX_SLOTS] = {{NPC_SKYBREAKER_SORCERER, {-9.479858f, 0.05663967f, 20.77026f, 4.729842f}, 0},
...
SlotInfo const OrgrimsHammerSlotInfo[MAX_SLOTS] = {{NPC_KOR_KRON_BATTLE_MAGE, {13.58548f, 0.3867192f, 34.99243f, 1.53589f}, 0},
...
public:
    ...
    bool operator()(WorldObject* unit)
    {
        return unit->GetTypeId() != TYPEID_PLAYER || unit->GetPositionZ() > 478.0f || !unit->GetTransport() || unit->GetTransport()->GetEntry() != _entry || unit->GetMapHeight(unit->GetPhaseMask(), unit->GetPositionX(), unit->GetPositionY(), unit->GetPositionZ()) < 465.0f;
    }
...
public:
    ...
    class spell_igb_rocket_artillery_SpellScript : public SpellScript
    {
        ...
        {
            PreventHitDefaultEffect(effIndex);
            GetCaster()->CastSpell(GetHitUnit()->GetPositionX(), GetHitUnit()->GetPositionY(), GetHitUnit()->GetMapHeight(GetCaster()->GetPhaseMask(), GetHitUnit()->GetPositionX(), GetHitUnit()->GetPositionY(), GetHitUnit()->GetPositionZ()), uint32(GetEffectValue()), TRIGGERED_NONE);
        }
