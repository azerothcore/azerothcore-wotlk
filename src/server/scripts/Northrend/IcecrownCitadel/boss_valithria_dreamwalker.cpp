...
public:
    ...
    struct boss_valithria_dreamwalkerAI : public ScriptedAI
    {
        ...
        void JustSummoned(Creature* summon) override
        {
            ...
            {
                summon->m_Events.AddEventAtOffset(new DelayedCastEvent(summon, SPELL_SUMMON_DREAM_PORTAL, me->GetGUID(), 6000), 15s);
            ...
            {
                summon->m_Events.AddEventAtOffset(new DelayedCastEvent(summon, SPELL_SUMMON_NIGHTMARE_PORTAL, me->GetGUID(), 6000), 15s);
    ...
    struct npc_risen_archmageAI : public ScriptedAI
    {
        ...
        void JustSummoned(Creature* summon) override
        {
            if (summon->GetEntry() == NPC_COLUMN_OF_FROST)
                summon->m_Events.AddEventAtOffset(new DelayedCastEvent(summon, SPELL_COLUMN_OF_FROST_DAMAGE, ObjectGuid::Empty, 8000), 2s);
