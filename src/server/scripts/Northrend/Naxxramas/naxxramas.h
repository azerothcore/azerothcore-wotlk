...
enum NXData
{
    ...
    DATA_ANUB_GATE                  = 103,
    DATA_FAERLINA_WEB               = 104,
    DATA_MAEXXNA_GATE               = 105,
    DATA_THADDIUS_BOSS              = 106,
    DATA_STALAGG_BOSS               = 107,
    DATA_FEUGEN_BOSS                = 108,
    DATA_THADDIUS_GATE              = 109,
    DATA_GOTHIK_ENTER_GATE          = 110,
    DATA_GOTHIK_INNER_GATE          = 111,
    DATA_GOTHIK_EXIT_GATE           = 112,
    DATA_HORSEMEN_GATE              = 113,
    DATA_LICH_KING_BOSS             = 114,
    DATA_KELTHUZAD_FLOOR            = 115,
    DATA_ABOMINATION_KILLED         = 116,
    DATA_FRENZY_REMOVED             = 117,
    DATA_CHARGES_CROSSED            = 118,
    DATA_SPORE_KILLED               = 119,
    DATA_HUNDRED_CLUB               = 120,
    DATA_DANCE_FAIL                 = 121,
    DATA_IMMORTAL_FAIL              = 122,
    DATA_KELTHUZAD_GATE             = 123,
    DATA_HAD_THADDIUS_GREET         = 124,
    DATA_KELTHUZAD_PORTAL_1         = 125,
    DATA_KELTHUZAD_PORTAL_2         = 126,
    DATA_KELTHUZAD_PORTAL_3         = 127,
    DATA_KELTHUZAD_PORTAL_4         = 128
};
