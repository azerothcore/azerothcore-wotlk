...
public:
    ...
    struct boss_thorimAI : public ScriptedAI
    {
        ...
        void KilledUnit(Unit*) override
        {
            ...
            if (urand(0, 1))
            {
                me->Yell("Can't you at least put up a fight!?", LANG_UNIVERSAL, 0);
                me->PlayDirectSound(SOUND_SLAY1);
            }
            else
            {
                me->Yell("Pathetic!", LANG_UNIVERSAL, 0);
        ...
        void DamageTaken(Unit* who, uint32& damage, DamageEffectType, SpellSchoolMask) override
        {
            if (who && _isHitAllowed && who->GetPositionZ() > 430 && who->GetTypeId() == TYPEID_PLAYER)
            {
                ...
                me->Yell("Impertinent whelps! You dare challenge me atop my pedestal! I will crush you myself!", LANG_UNIVERSAL, 0);
            ...
            if (damage >= me->GetHealth())
            {
                ...
                if (!_encounterFinished)
                {
                    ...
                    me->Yell("Stay your arms! I yield!", LANG_UNIVERSAL, 0);
        ...
        void PlaySpecial()
        {
            ...
            {
                case 0:
                    me->Yell("Behold the power of the storms and despair!", LANG_UNIVERSAL, 0);
                    me->PlayDirectSound(SOUND_SPECIAL1);
                    break;
                case 1:
                    me->Yell("Do not hold back! Destroy them!", LANG_UNIVERSAL, 0);
                    me->PlayDirectSound(SOUND_SPECIAL2);
                    break;
                case 2:
                    me->Yell("Have you begun to regret your intrusion? ", LANG_UNIVERSAL, 0);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case EVENT_THORIM_AGGRO:
                    me->Yell("Interlopers! You mortals who dare to interfere with my sport will pay... Wait--you...", LANG_UNIVERSAL, 0);
                ...
                case EVENT_THORIM_AGGRO2:
                    {
                        me->Yell("I remember you... In the mountains... But you... what is this? Where am--", LANG_UNIVERSAL, 0);
                ...
                case EVENT_THORIM_LIGHTNING_ORB:
                    {
                        ...
                        // No players found
                        me->Yell("Failures! Weaklings!", LANG_UNIVERSAL, 0);
                ...
                case EVENT_THORIM_BERSERK:
                    ...
                    me->Yell("My patience has reached its limit!", LANG_UNIVERSAL, 0);
                    me->PlayDirectSound(SOUND_BERSERK);
                    break;
                case EVENT_THORIM_OUTRO1:
                    if (_hardMode)
                    {
                        me->Yell("You! Fiend! You are not my beloved! Be gone!", LANG_UNIVERSAL, 0);
                    ...
                    {
                        me->Yell("I feel as though I am awakening from a nightmare, but the shadows in this place yet linger.", LANG_UNIVERSAL, 0);
                ...
                case EVENT_THORIM_OUTRO2:
                    if (_hardMode)
                    {
                        me->Yell("Behold the hand behind all the evil that has befallen Ulduar! Left my kingdom in ruins, corrupted my brother and slain my wife!", LANG_UNIVERSAL, 0);
                        me->PlayDirectSound(SOUND_HARD2);
                        events.ScheduleEvent(EVENT_THORIM_OUTRO3, 12000, 0, 3);
                    }
                    else
                    {
                        me->Yell("Sif... was Sif here? Impossible--she died by my brother's hand. A dark nightmare indeed....", LANG_UNIVERSAL, 0);
                ...
                case EVENT_THORIM_OUTRO3:
                    if (_hardMode)
                    {
                        me->Yell("And now it falls to you, champions, to avenge us all! The task before you is great, but I will lend you my aid as I am able. You must prevail!", LANG_UNIVERSAL, 0);
                        me->PlayDirectSound(SOUND_HARD3);
                    }
                    else
                    {
                        me->Yell("I need time to reflect.... I will aid your cause if you should require it. I owe you at least that much. Farewell.", LANG_UNIVERSAL, 0);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case EVENT_SIF_FINISH_DOMINION:
                    ...
                    me->Yell("This pathetic morons are harmless. Relive my station, dispose of them!", LANG_UNIVERSAL, 0);
                    me->DespawnOrUnsummon(5000);
                    break;
                case EVENT_SIF_START_TALK:
                    me->Yell("Thorim, my lord, why else would these invaders have come into your sanctum but to slay you? They must be stopped!", LANG_UNIVERSAL, 0);
                    me->PlayDirectSound(SOUND_SIF_START);
                    break;
                case EVENT_SIF_JOIN_TALK:
                    me->PlayDirectSound(SOUND_SIF_EVENT);
                    me->Yell("Impossible! Lord Thorim, I will bring your foes a frigid death!", LANG_UNIVERSAL, 0);
