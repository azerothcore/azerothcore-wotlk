...
public:
    ...
    struct boss_ignisAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit*  /*who*/) override
        {
            ...
            me->Yell(TEXT_AGGRO, LANG_UNIVERSAL, 0);
        ...
        void KilledUnit(Unit*  /*victim*/) override
        {
            if( rand() % 2 )
            {
                me->Yell(TEXT_SLAY_1, LANG_UNIVERSAL, 0);
                me->PlayDirectSound(SOUND_SLAY_1);
            }
            else
            {
                me->Yell(TEXT_SLAY_2, LANG_UNIVERSAL, 0);
        ...
        {
            me->Yell(TEXT_DEATH, LANG_UNIVERSAL, 0);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_ACTIVATE_CONSTRUCT:
                    ...
                    if (++counter >= 20)
                    {
                        me->Yell(TEXT_BERSERK, LANG_UNIVERSAL, 0);
                ...
                case EVENT_SPELL_SCORCH:
                    if( rand() % 2 )
                    {
                        me->Yell(TEXT_SCORCH_1, LANG_UNIVERSAL, 0);
                        me->PlayDirectSound(SOUND_SCORCH_1);
                    }
                    else
                    {
                        me->Yell(TEXT_SCORCH_2, LANG_UNIVERSAL, 0);
                ...
                case EVENT_GRAB:
                    {
                        ...
                        if( !playerGUIDs.empty() )
                        {
                            ...
                            {
                                me->Yell(TEXT_SLAG_POT, LANG_UNIVERSAL, 0);
