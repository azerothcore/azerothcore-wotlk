...
public:
    ...
    {
        return target && target->GetEntry() == NPC_MIMIRON && target->IsUnit() && target->ToCreature()->AI()->GetData(1);
    }
};
...
public:
    ...
    bool OnCheck(Player*  /*player*/, Unit* target, uint32 /*criteria_id*/) override
    {
        return target && target->GetEntry() == NPC_MIMIRON && target->IsUnit() && !target->ToCreature()->AI()->GetData(11);
    }
};
...
public:
    ...
    bool OnCheck(Player*  /*player*/, Unit* target, uint32 /*criteria_id*/) override
    {
        return target && target->GetEntry() == NPC_MIMIRON && target->IsUnit() && !target->ToCreature()->AI()->GetData(12);
    }
};
...
public:
    ...
    bool OnCheck(Player*  /*player*/, Unit* target, uint32 /*criteria_id*/) override
    {
        return target && target->GetEntry() == NPC_MIMIRON && target->IsUnit() && !target->ToCreature()->AI()->GetData(13);
    }
};
