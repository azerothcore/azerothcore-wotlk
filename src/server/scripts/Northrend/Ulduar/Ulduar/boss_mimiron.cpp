...
public:
    ...
    struct boss_mimironAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit*  /*who*/) override
        {
            ...
            if (!hardmode)
            {
                me->Yell(TEXT_LMK2_ACTIVATE, LANG_UNIVERSAL, 0);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch( events.ExecuteEvent() )
            {
                ...
                case EVENT_MIMIRON_SAY_HARDMODE:
                    me->Yell(TEXT_HARDMODE, LANG_UNIVERSAL, 0);
                ...
                case EVENT_LMK2_RETREAT_INTERVAL:
                    if (Creature* LMK2 = GetLMK2())
                    {
                        ...
                        me->Yell(TEXT_LMK2_DEATH, LANG_UNIVERSAL, 0);
                ...
                case EVENT_SITTING_ON_VX001:
                    me->Yell(TEXT_VX001_ACTIVATE, LANG_UNIVERSAL, 0);
                ...
                case EVENT_SAY_VX001_DEAD:
                    ...
                    me->Yell(TEXT_VX001_DEATH, LANG_UNIVERSAL, 0);
                ...
                case EVENT_SAY_ACU_ACTIVATE:
                    me->Yell(TEXT_ACU_ACTIVATE, LANG_UNIVERSAL, 0);
                ...
                case EVENT_SAY_ACU_DEAD:
                    me->Yell(TEXT_ACU_DEATH, LANG_UNIVERSAL, 0);
                ...
                case EVENT_JOIN_TOGETHER:
                    {
                        ...
                        me->EnterVehicle(VX001, 1);
                        me->Yell(TEXT_VOLTRON_ACTIVATE, LANG_UNIVERSAL, 0);
                ...
                case EVENT_SAY_VOLTRON_DEAD:
                    me->Yell(TEXT_VOLTRON_DEATH, LANG_UNIVERSAL, 0);
            ...
            if( who->GetTypeId() == TYPEID_PLAYER )
                if (Creature* c = GetMimiron())
                {
                    if( Phase == 1 )
                    {
                        if( rand() % 2 )
                        {
                            c->Yell(TEXT_LMK2_SLAIN_1, LANG_UNIVERSAL, 0);
                            c->PlayDirectSound(SOUND_TANK_SLAY_1);
                        }
                        else
                        {
                            c->Yell(TEXT_LMK2_SLAIN_2, LANG_UNIVERSAL, 0);
                    ...
                    else
                    {
                        if( rand() % 2 )
                        {
                            c->Yell(TEXT_VOLTRON_SLAIN_1, LANG_UNIVERSAL, 0);
                            c->PlayDirectSound(SOUND_VOLTRON_SLAY_1);
                        }
                        else
                        {
                            c->Yell(TEXT_VOLTRON_SLAIN_2, LANG_UNIVERSAL, 0);
            ...
            if( who->GetTypeId() == TYPEID_PLAYER )
                if( Creature* c = GetMimiron() )
                {
                    if( Phase == 2 )
                    {
                        if( rand() % 2 )
                        {
                            c->Yell(TEXT_VX001_SLAIN_1, LANG_UNIVERSAL, 0);
                            c->PlayDirectSound(SOUND_TORSO_SLAY_1);
                        }
                        else
                        {
                            c->Yell(TEXT_VX001_SLAIN_2, LANG_UNIVERSAL, 0);
            ...
            if( who->GetTypeId() == TYPEID_PLAYER )
                if( Creature* c = GetMimiron() )
                {
                    if( Phase == 3 )
                    {
                        if( rand() % 2 )
                        {
                            c->Yell(TEXT_ACU_SLAIN_1, LANG_UNIVERSAL, 0);
                            c->PlayDirectSound(SOUND_HEAD_SLAY_1);
                        }
                        else
                        {
                            c->Yell(TEXT_ACU_SLAIN_2, LANG_UNIVERSAL, 0);
