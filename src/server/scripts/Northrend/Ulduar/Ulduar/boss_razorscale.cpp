        ...
        if (uiAction == GOSSIP_ACTION_INFO_DEF + 1)
        {
            ...
            if (razorscale && !razorscale->IsInCombat())
            {
                ...
                if (razorscale->AI())
                {
                    ...
                    razorscale->GetMotionMaster()->MovePoint(POINT_RAZORSCALE_INIT, 588.0f, -178.0f, 490.0f, FORCED_MOVEMENT_NONE, 0.f, 0.f, false, false, MOTION_SLOT_ACTIVE, AnimTier::Fly);
                }
            }
        }
