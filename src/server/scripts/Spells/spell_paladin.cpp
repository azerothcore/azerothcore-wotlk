...
public:
    ...
    class spell_pal_seal_of_light_AuraScript : public AuraScript
    {
        ...
        bool CheckProc(ProcEventInfo& eventInfo)
        {
            ...
            //skip divine storm self hit (dummy) and righteous vengeance (0x20000000=
            return eventInfo.GetActor() != eventInfo.GetProcTarget() && (!damageInfo || !damageInfo->GetSpellInfo() || !damageInfo->GetSpellInfo()->SpellFamilyFlags.HasFlag(0x20000000));
        }
...
public:
    ...
    class spell_pal_sacred_shield_base_AuraScript : public AuraScript
    {
        ...
        {
            DamageInfo* damageInfo = eventInfo.GetDamageInfo();
            return !(eventInfo.GetHitMask() & PROC_EX_INTERNAL_HOT) && damageInfo && damageInfo->GetDamage() > 0;
        }
        ...
        void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
        {
            ...
            if (eventInfo.GetTypeMask() & PROC_FLAG_TAKEN_SPELL_MAGIC_DMG_CLASS_POS)
            {
                ...
                DamageInfo* damageInfo = eventInfo.GetDamageInfo();
                const SpellInfo* procSpell = damageInfo ? damageInfo->GetSpellInfo() : nullptr;
                if (caster && procSpell && procSpell->SpellFamilyName == SPELLFAMILY_PALADIN &&
...
public:
    ...
    class spell_pal_seal_of_righteousness_AuraScript : public AuraScript
    {
        ...
        bool CheckProc(ProcEventInfo& eventInfo)
        {
            ...
            DamageInfo* damageInfo = eventInfo.GetDamageInfo();
            return target->IsAlive() && !eventInfo.GetTriggerAuraSpell() && (damageInfo && damageInfo->GetDamage() || (eventInfo.GetHitMask() & PROC_EX_ABSORB));
        }
