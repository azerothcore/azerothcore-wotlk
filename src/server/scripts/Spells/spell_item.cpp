        ...
        class spell_item_titanium_seal_of_dalaran_SpellScript : public SpellScript
        {
            ...
            void OnScriptEffect(SpellEffIndex effIndex)
            {
                ...
                if (Player* player = caster->ToPlayer())
                {
                    ...
                    player->TextEmote("casually flips his Titanium Seal of Dalaran", EMOTE_TYPE_UNIVERSAL);
                    if (urand(0,1))
                        player->TextEmote("finds the coin face down for tails!", EMOTE_TYPE_UNIVERSAL);
                    else
                        player->TextEmote("catches the coin heads up!", EMOTE_TYPE_UNIVERSAL);
                }
            }
...
class spell_item_fish_feast : public SpellScriptLoader
{
    public:
        ...
        class spell_item_fish_feast_SpellScript : public SpellScript
        {
            ...
            {
                PreventHitDefaultEffect(effIndex);
                GetCaster()->ToPlayer()->TextEmote( "prepares a Fish Feast!", EMOTE_TYPE_UNIVERSAL);
            }
