...
public:
    ...
    struct boss_aeonusAI : public ScriptedAI
    {
        ...
        void InitializeAI() override
        {
            ...
            if (Unit* medivh = ObjectAccessor::GetUnit(*me, instance->GetGuidData(DATA_MEDIVH)))
            {
                me->SetHomePosition(medivh->GetPositionX() + 14.0f * std::cos(medivh->GetAngle(me)), medivh->GetPositionY() + 14.0f * sin(medivh->GetAngle(me)), medivh->GetPositionZ(), me->GetAngle(medivh));
