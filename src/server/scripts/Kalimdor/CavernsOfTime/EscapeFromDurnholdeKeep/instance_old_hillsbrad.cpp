        ...
        void Update(uint32 diff)
        {
            ...
            switch (_events.ExecuteEvent())
            {
                case EVENT_INITIAL_BARRELS_FLAME:
                {
                    ...
                    for (GuidSet::const_iterator itr = _prisonersSet.begin(); itr != _prisonersSet.end(); ++itr)
                    ...
                    for (GuidSet::const_iterator itr = _initalFlamesSet.begin(); itr != _initalFlamesSet.end(); ++itr)
                ...
                case EVENT_FINAL_BARRELS_FLAME:
                {
                    ...
                    for (GuidSet::const_iterator itr = _finalFlamesSet.begin(); itr != _finalFlamesSet.end(); ++itr)
                        if (GameObject* gobject = instance->GetGameObject(*itr))
                        {
                            gobject->SetRespawnTime(0);
                            gobject->UpdateObjectVisibility(true);
