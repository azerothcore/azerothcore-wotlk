        ...
        if (whelpSpam)
        {
            if (whelpCount < 40)
            {
                ...
                if (whelpSpamTimer <= 0)
                {
                    ...
                    me->CastSpell(-33.18f + std::cos(angle) * dist, -258.80f + sin(angle) * dist, -89.0f, 17646, true);
                    me->CastSpell(-32.535f + std::cos(angle) * dist, -170.190f + sin(angle) * dist, -89.0f, 17646, true);
                    whelpCount += 2;
                    whelpSpamTimer += 600;
                }
            }
