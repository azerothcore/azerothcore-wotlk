...
const creature_type EP_EWT_Summons_A[EP_EWT_NUM_CREATURES] =
{
    ...
    */
    {17635, 0, 2545.37f, -4778.07f, 108.13f, 2.3307f},
    {17647, 0, 2549.94f, -4778.65f, 109.10f, 2.3306f},
    {17647, 0, 2545.19f, -4781.94f, 109.24f, 2.3306f},
    {17647, 0, 2545.53f, -4774.84f, 107.52f, 2.3307f},
    {17647, 0, 2541.47f, -4778.71f, 107.85f, 2.3307f}
    // End Lanny NPCBot
};
...
const creature_type EP_EWT_Summons_H[EP_EWT_NUM_CREATURES] =
{
    ...
    */
    {17995, 0, 2545.37f, -4778.07f, 108.13f, 2.3307f},
    {17996, 0, 2549.94f, -4778.65f, 109.10f, 2.3306f},
    {17996, 0, 2545.19f, -4781.94f, 109.24f, 2.3306f},
    {17996, 0, 2545.53f, -4774.84f, 107.52f, 2.3307f},
    {17996, 0, 2541.47f, -4778.71f, 107.85f, 2.3307f}
    // End Lanny NPCBot
};
