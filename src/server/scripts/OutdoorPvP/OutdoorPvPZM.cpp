...
void OPvPCapturePointZM_Beacon::FillInitialWorldStates(WDataStore& data)
{
...
void OPvPCapturePointZM_GraveYard::FillInitialWorldStates(WDataStore& data)
{
...
void OutdoorPvPZM::FillInitialWorldStates(WDataStore& data)
{
