...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_SELECT_INSTANCE_SAVED_DATA, "SELECT id, entry, guid, state FROM instance_saved_go_state_data", CONNECTION_SYNCH);
    ...
    PrepareStatement(CHAR_INSERT_INSTANCE_SAVED_DATA, "INSERT INTO instance_saved_go_state_data (id, entry, guid, state) VALUES (?, ?, ?, ?)", CONNECTION_ASYNC);
