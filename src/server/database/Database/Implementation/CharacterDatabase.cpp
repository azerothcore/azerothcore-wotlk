...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    // Chat filtered words
    PrepareStatement(CHAR_SEL_FILTERED_WORDS, "SELECT ID, Word FROM filtered_words ORDER BY ID", CONNECTION_SYNCH);
    PrepareStatement(CHAR_SEL_FILTERED_WORD, "SELECT ID FROM filtered_words WHERE Word = ?", CONNECTION_SYNCH);
    PrepareStatement(CHAR_INS_FILTERED_WORD, "INSERT INTO filtered_words (Word) VALUES (?)", CONNECTION_SYNCH);
    PrepareStatement(CHAR_DEL_FILTERED_WORD, "DELETE FROM filtered_words WHERE Word = ?", CONNECTION_SYNCH);
