...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_CHARACTERS_FOR_NAME_RECHECK,
    CHAR_SEL_CHARACTERS_FOR_NAME_RECHECK_EXACT,
    CHAR_SEL_CHARACTERS_FOR_NAME_RECHECK_ENDS_WITH,
    CHAR_SEL_CHARACTERS_FOR_NAME_RECHECK_STARTS_WITH,
    CHAR_SEL_CHARACTERS_FOR_NAME_RECHECK_CONTAINS,
    CHAR_SEL_RESERVED_PLAYER_NAMES,
    CHAR_SEL_PROFANITY_PLAYER_NAMES,
    CHAR_DEL_RESERVED_PLAYER_NAME_BY_NAME,
    CHAR_DEL_PROFANITY_PLAYER_NAME_BY_NAME,
