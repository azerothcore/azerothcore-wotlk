...
void WorldDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(WORLD_SEL_SMARTAI_WP, "SELECT entry, pointid, wp_group, position_x, position_y, position_z FROM waypoints ORDER BY entry, pointid, wp_group", CONNECTION_SYNCH);
