...
enum SpellAttr2
{
    ...
    SPELL_ATTR2_NO_INITIAL_THREAT                    = 0x00400000, // TITLE Unknown attribute 22@Attr2 DESCRIPTION Ambush, Backstab, Cheap Shot, Death Grip, Garrote, Judgements, Mutilate, Pounce, Ravage, Shiv, Shred
