...
enum GroupJoinBattlegroundResult
{
    ...
    ERR_BATTLEGROUND_JOIN_TIMED_OUT         = -11,          // %s was unavailable to join the queue. (WOWGUID guid exist in client cache)
    ERR_BATTLEGROUND_JOIN_FAILED            = -12,          // Join as a group failed (WOWGUID guid doesn't exist in client cache)
