...
enum AccountFlag
{
    ...
    FLAG_COLLECTOR            = 0x4,        // NYI Collector's Edition
    FLAG_TRIAL                = 0x8,        // NYI Trial account
    FLAG_CANCELLED            = 0x10,       // NYI UNK
    FLAG_IGR                  = 0x20,       // NYI Internet Game Room (Internet cafe?)
    ...
    FLAG_REFERRAL             = 0x800,      // NYI Recruit-A-Friend, either referer or referee
    FLAG_BLIZZARD             = 0x1000,     // NYI UNK
    FLAG_RECURRING_BILLING    = 0x2000,     // NYI UNK
    FLAG_NOELECTUP            = 0x4000,     // NYI UNK
    FLAG_KR_CERTIFICATE       = 0x8000,     // NYI Korean certificate?
    FLAG_EXPANSION_COLLECTOR  = 0x10000,    // NYI TBC Collector's Edition
    FLAG_DISABLE_VOICE        = 0x20000,    // NYI Can't join voice chat
    FLAG_DISABLE_VOICE_SPEAK  = 0x40000,    // NYI Can't speak in voice chat
    FLAG_REFERRAL_RESURRECT   = 0x80000,    // NYI Scroll of Resurrection
    FLAG_EU_FORBID_CC         = 0x100000,   // NYI UNK
    FLAG_OPENBETA_DELL        = 0x200000,   // NYI https://wowpedia.fandom.com/wiki/Dell_XPS_M1730_World_of_Warcraft_Edition
    FLAG_PROPASS              = 0x400000,   // NYI UNK
    FLAG_PROPASS_LOCK         = 0x800000,   // NYI Pro pass (arena tournament)
    FLAG_PENDING_UPGRADE      = 0x1000000,  // NYI UNK
    FLAG_RETAIL_FROM_TRIAL    = 0x2000000,  // NYI UNK
    FLAG_EXPANSION2_COLLECTOR = 0x4000000,  // NYI WotLK Collector's Edition
    FLAG_OVERMIND_LINKED      = 0x8000000,  // NYI Linked with Battle.net account
    FLAG_DEMOS                = 0x10000000, // NYI UNK
    FLAG_DEATH_KNIGHT_OK      = 0x20000000, // NYI Has level 55 on account?
