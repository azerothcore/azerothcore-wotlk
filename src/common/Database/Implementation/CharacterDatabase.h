...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    // Premium character queries
    CHAR_INS_PREMIUM_CHARACTER,
    CHAR_DEL_PREMIUM_CHARACTER,
    CHAR_SEL_PREMIUM_CHARACTER_PREMIUM_LEVEL,
    CHAR_SEL_PREMIUM_CHARACTER_ACCOUNT,
