...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    WORLD_SEL_REQ_XP,
    WORLD_SEL_ACORE_STRING_DEFAULT,
    WORLD_SEL_ACORE_STRING_CONTENT_LOC1,
    WORLD_SEL_ACORE_STRING_CONTENT_LOC2,
    WORLD_SEL_ACORE_STRING_CONTENT_LOC3,
    WORLD_SEL_ACORE_STRING_CONTENT_LOC4,
    WORLD_SEL_ACORE_STRING_CONTENT_LOC5,
    WORLD_SEL_ACORE_STRING_CONTENT_LOC6,
    WORLD_SEL_ACORE_STRING_CONTENT_LOC7,
    WORLD_SEL_ACORE_STRING_CONTENT_LOC8,
