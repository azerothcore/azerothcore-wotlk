...
namespace MMAP
{
    ...
    boost::shared_mutex& MMapManager::GetMMapLock(uint32 mapId)
    {
    ...
    {
        boost::shared_lock<boost::shared_mutex> lock(MMapManagerLock); // ?
        ...
        dtStatus stat;
        {
            boost::shared_lock<boost::shared_mutex> lock(GetMMapLock(mapId)); // ?
