...
CSCRIPTPCH=OFF
CCOREPCH=OFF
CCUSTOMOPTIONS='-DOPENSSL_INCLUDE_DIR="$OPENSSL_ROOT_DIR/include" -DOPENSSL_SSL_LIBRARIES="$OPENSSL_ROOT_DIR/lib/libssl.so" -DOPENSSL_CRYPTO_LIBRARIES="$OPENSSL_ROOT_DIR/lib/libcrypto.so" -DCMAKE_C_COMPILER_LAUNCHER=ccache -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_C_FLAGS="-Werror" -DCMAKE_CXX_FLAGS="-Werror"'
