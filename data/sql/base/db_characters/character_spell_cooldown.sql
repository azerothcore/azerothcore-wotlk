...
-- Дамп структуры для таблица acore_characters.character_spell_cooldown
...
-- Дамп данных таблицы acore_characters.character_spell_cooldown: ~0 rows (приблизительно)
