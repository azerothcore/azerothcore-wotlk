...
-- Дамп структуры для таблица acore_characters.item_soulbound_trade_data
...
-- Дамп данных таблицы acore_characters.item_soulbound_trade_data: ~0 rows (приблизительно)
