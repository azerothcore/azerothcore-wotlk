...
-- Дамп структуры для таблица _acore_characters.item_soulbound_trade_data
...
-- Дамп данных таблицы _acore_characters.item_soulbound_trade_data: ~0 rows (приблизительно)
