...
-- Дамп структуры для таблица acore_characters.character_brew_of_the_month
...
-- Дамп данных таблицы acore_characters.character_brew_of_the_month: ~0 rows (приблизительно)
