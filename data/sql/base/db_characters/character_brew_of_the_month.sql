...
-- Дамп структуры для таблица _acore_characters.character_brew_of_the_month
...
-- Дамп данных таблицы _acore_characters.character_brew_of_the_month: ~0 rows (приблизительно)
