...
--
-- Dumping data for table `profanity_name`
--

LOCK TABLES `profanity_name` WRITE;
/*!40000 ALTER TABLE `profanity_name` DISABLE KEYS */;
/*!40000 ALTER TABLE `profanity_name` ENABLE KEYS */;
UNLOCK TABLES;
