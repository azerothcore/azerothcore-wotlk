...
-- Дамп структуры для таблица acore_characters.character_battleground_random
...
-- Дамп данных таблицы acore_characters.character_battleground_random: ~0 rows (приблизительно)
