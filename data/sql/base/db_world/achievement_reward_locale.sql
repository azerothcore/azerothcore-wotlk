...
(45,'zhCN','你环游了世界！','嘿，伙计！$B$B我认为我已经在这片冰冻荒原找到一些值得庆祝的事情了！对于我这个矮人来说，我在你眼中很明显地看到探险家才有的激情。$B$B穿上这件战袍吧。这样当你的朋友要问路的时候就会想到你了！$B$B别停下脚步！$B$B布莱恩·铜须'),
(46,'frFR','',NULL),
(230,'frFR','',NULL),
(432,'frFR','',NULL),
(456,'frFR','',NULL),
...
(619,'zhCN','为了部落！','在这次行动中，伟大的勇士从苦难困苦中昂首站了起来——你就是其中之一。$B$B战争随时都会爆发，你的努力会为我们在艾泽拉斯的征程上画上浓重的一笔。你的勇敢必须要得到奖励，请收下这份来自奥格瑞玛的奖励，以彰显你的果敢！$B$B为了部落！$B$B - 大酋长萨尔'),
(714,'frFR','',NULL),
(762,'frFR','',NULL),
(870,'frFR','',NULL),
(871,'frFR','',NULL),
...
(876,'zhCN','我一直在关注着你，孩子。','你长期在竞技场中磨练，给你的格斗技巧带来了很大的提升，$n。收下这件战袍，然后穿上它自豪地走上街，让别人看看你洒过的汗水以及丰收的硕果！$B$B斯卡巴里·谢波德'),
(907,'frFR','',NULL),
(913,'frFR','',NULL),
(942,'frFR','',NULL),
(943,'frFR','',NULL),
...
(1021,'frFR','',NULL),
(1021,'zhCN','成就卓著！','我注意到你收集了许多很棒的战袍，或许你想把这一件也锦上添花地加入你的收藏中。反正我留着它也没什么用。'),
(1038,'frFR','',NULL),
(1039,'frFR','',NULL),
(1174,'frFR','',NULL),
(1175,'frFR','',NULL),
...
(1956,'zhCN','进修','恭喜你顺利完成了在达拉然魔法学院的进修工作。为了鼓励你所获得的成就，我把这部书籍邮寄给你，希望你能收下。$B$B我想，你应该能知道这份书籍的用途。$B$B向你致以真诚的问候。$B$B罗宁'),
(2051,'frFR','',NULL),
(2054,'frFR','',NULL),
...
(2096,'frFR','',NULL),
(2096,'zhCN','金币达人','你好，恭喜你成功收集到了达拉然喷泉的所有硬币！为了表彰你的成就，我准备把这枚达拉然泰坦神铁徽记赠予你——这可是一枚我们只奖励给狂热硬币收集者的礼物。$B$B希望你会喜欢我这份特殊的礼物，现在，它是你的了！$B$B真挚地问候您。$B耶比托·乔巴斯'),
...
(2136,'frFR','',NULL),
(2136,'zhCN','英雄的荣耀！','尊敬的勇士，$B$B你在诺森德英勇战斗的身影以及所获得的成就已经传到了龙眠神殿。$B$B你的勇敢不容忽视，请你务必接受这份礼物，和它一起，我们并肩驱逐诺森德的恶魔，一次亦或永远。$B$B阿莱克丝塔萨，生命的缚誓者'),
...
(2144,'frFR','',NULL),
(2144,'zhCN','千奇百怪的漫长旅行','随着远方漫天战鼓的响起，对于你们这些艾泽拉斯的冒险者来说，忘记生命的意义是一件再正常不过的事情。$B$B从另一方面来说，你用你的所作所为来捍卫艾泽拉斯一个高贵种族的尊严，并且去记住我们为之奋斗的东西。不是为了庆祝我们的胜利，也许是我们在另一个方面的胜利更合适。记住你所做过的事情，冒险者。$B$B希望其他人会为你的行为而欢呼。$B$B阿莱克丝塔萨，生命的缚誓者'),
...
(2145,'frFR','',NULL),
(2145,'zhCN','千奇百怪的漫长旅行','随着远方漫天战鼓的响起，对于你们这些艾泽拉斯的冒险者来说，忘记生命的意义是一件再正常不过的事情。$B$B从另一方面来说，你用你的所作所为来捍卫艾泽拉斯一个高贵种族的尊严，并且去记住我们为之奋斗的东西。不是为了庆祝我们的胜利，也许是我们在另一个方面的胜利更合适。记住你所做过的事情，冒险者。$B$B希望其他人会为你的行为而欢呼。$B$B阿莱克丝塔萨，生命的缚誓者'),
(2186,'frFR','',NULL),
(2187,'frFR','',NULL),
(2188,'frFR','',NULL),
(2336,'frFR','',NULL),
...
(3857,'zhCN','征服之岛的主人','荣耀属于你，$N，$B$B你在征服之岛的英雄表现，为军团做出了卓越的贡献，为此，送你这件战袍以示感谢。$B$B高级指挥官哈尔弗·维姆班恩'),
...
(4079,'zhCN','大十字军的荣耀','亲爱的$N，$B$B你在大十字军竞技场的事迹这么久以来被反复传颂。大十字军竞技场是为了选拔以后进军冰冠堡垒的勇士而设立的一座竞技场，我希望有越来越多的勇士能在这座竞技场里脱颖而出，然后直捣冰冠堡垒。很显然，你引起了我的注意。$B$B我们需要你的力量来对抗巫妖王。不过这么些天来，你一直在举办庆祝活动，我也不好意思打扰你，现在把这匹最好的战马送给你，当天灾军团看到竖立在它后边的银白十字军战旗时，那胆战心惊的模样想必你也很乐意看到吧？$B$B荣耀伴随着你$B提里奥·弗丁'),
(4080,'frFR','',NULL),
...
(4478,'zhCN','小狗溜溜','这位耐心的朋友，$B$B您愿与可能不熟识的人一起下副本，我们对您的伟大表示崇高的敬意。如果你还带了带野队里的新手，那就更好了。$B$B长话短说，听说你喜欢组野队。那么我们就送您一只名叫溜溜的小狗，希望它能让你开心地完成一次野队之旅。$B$B/抱，$B$B魔兽世界开发团队'),
(4530,'frFR','',NULL),
...
(4602,'frFR','',NULL),
(4602,'zhCN','冰冠堡垒征服者的荣耀','$N，$B$B当巫妖王的影响力日渐薄弱的时候，有不少昔日在他麾下很强力的人脱离了他的控制。$B$B这只被我们捕获的冰霜巨龙就是一个很好的例子。它有强烈的自主意识，并且我们还有更多的这种巨龙。$B$B我们当中的一个人虽然在一次战斗中光荣地失去了一只胳膊，不过依然能很好的驾驭它——很明显，它被驯服的很好，并且给了他们自信。$B$B请接受这只来自黑锋骑士团的礼物，在这场伟大的战斗中有你们陪同，真的很荣幸。$B$B荣誉属于你们。$B大领主达里安·莫格莱尼'),
(4603,'deDE','Ruhm des Schlachtzüglers von Eiskrone','$N,$B$BAls der Einfluss des Lichkönigs schwand, haben sich einige seiner mächtigeren Schergen aus seinem Griff befreit.$B$BDieser von meinen Männern gefangen genommene Frostwyrmdrache ist ein Paradebeispiel dafür. Sie hat einen eigenen Willen und noch mehr.$B$BEiner meiner Männer verlor einen Arm als er sie einritt, aber sie kann jetzt recht gut mit Reitern umgehen - vorausgesetzt Ihr seid geschickt und habt einen starken Willen.$B$BBitte nehmt diese prächtige Bestie als Geschenk der Ritter der Schwarzen Klinge an. Es war mir eine Ehre, an Eurer Seite in der größten aller Schlachten zu kämpfen.$B$BHochachtungsvoll,$BDarion Mograine.'),
...
(4784,'frFR','',NULL),
(4784,'zhCN','银色领地的纹章收集者','朋友，你在诺森德所取得的成就令人不得不注目。$B$B用获取的纹章在达拉然兑换到各种强力的装备，然后武装自己，不是件很快乐的事么？$B$B我们就在达拉然的银色领地，在那儿，每种纹章都有对应的兑换师，来看看吧。$B$B我们期待你的到来！'),
