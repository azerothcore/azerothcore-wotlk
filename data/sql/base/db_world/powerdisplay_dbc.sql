...
-- Dumping structure for table acore_world.powerdisplay_dbc
DROP TABLE IF EXISTS `powerdisplay_dbc`;
CREATE TABLE IF NOT EXISTS `powerdisplay_dbc` (
  `ID` int NOT NULL DEFAULT '0',
  `ActualType` int NOT NULL DEFAULT '0',
  `GlobalstringBaseTag` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table acore_world.powerdisplay_dbc: ~0 rows (approximately)
