...
-- Dumping structure for table acore_world.totemcategory_dbc
...
-- Dumping data for table acore_world.totemcategory_dbc: ~0 rows (approximately)
DELETE FROM `totemcategory_dbc`;
