...
-- Dumping structure for table acore_world.cinematiccamera_dbc
...
CREATE TABLE IF NOT EXISTS `cinematiccamera_dbc` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='Cinematic camera DBC';
