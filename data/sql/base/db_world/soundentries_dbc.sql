...
CREATE TABLE IF NOT EXISTS `soundentries_dbc` (
  ...
  `File_1` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `File_5` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `File_6` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `File_7` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `File_8` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `File_9` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `File_10` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `DirectoryBase` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
