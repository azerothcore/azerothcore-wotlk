-- DB update 2021_09_20_17 -> 2021_09_20_18
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2021_09_20_17';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_09_20_17 2021_09_20_18 bit;
...
--
UPDATE version_db_world SET date = '2021_09_20_18' WHERE sql_rev = '1631973253175864827';
COMMIT;
END //
DELIMITER ;
CALL updateDb();
