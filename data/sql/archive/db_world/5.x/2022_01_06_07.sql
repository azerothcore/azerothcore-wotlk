-- DB update 2022_01_06_06 -> 2022_01_06_07
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2022_01_06_06';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2022_01_06_06 2022_01_06_07 bit;
SELECT sql_rev INTO OK FROM version_db_world WHERE sql_rev = '1637692848290406800'; IF OK <> 'FALSE' THEN LEAVE proc; END IF;
--
...
(4844, 0, 0, 0, 0, 0, 0, NULL),
(25817, 2, 0, 1, 0, 0, 0, NULL);

--
-- END UPDATING QUERIES
--
UPDATE version_db_world SET date = '2022_01_06_07' WHERE sql_rev = '1637692848290406800';
COMMIT;
END //
DELIMITER ;
CALL updateDb();
