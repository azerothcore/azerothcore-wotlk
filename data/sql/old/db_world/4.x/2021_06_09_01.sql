...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2021_06_09_00';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_06_09_00 2021_06_09_01 bit;
...
--
UPDATE version_db_world SET date = '2021_06_09_01' WHERE sql_rev = '1622617341739892363';
COMMIT;
END //
DELIMITER ;
CALL updateDb();
