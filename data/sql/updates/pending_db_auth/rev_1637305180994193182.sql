INSERT INTO `version_db_auth` (`sql_rev`) VALUES ('1637305180994193182');

ALTER TABLE `account_access`
    CHANGE COLUMN `id` `AccountID` INT(10) UNSIGNED NOT NULL FIRST,
    CHANGE COLUMN `gmlevel` `SecurityLevel` TINYINT(3) UNSIGNED NOT NULL AFTER `AccountID`,
    CHANGE COLUMN `comment` `Comment` VARCHAR(255) NULL DEFAULT '' COLLATE 'utf8mb4_general_ci' AFTER `RealmID`,
DROP PRIMARY KEY,
	ADD PRIMARY KEY (`AccountID`, `RealmID`) USING BTREE;
