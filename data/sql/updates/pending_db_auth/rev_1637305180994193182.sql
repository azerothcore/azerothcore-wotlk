...
-- Dumping structure for table acore_auth.rbac_account_permissions
DROP TABLE IF EXISTS `rbac_account_permissions`;
CREATE TABLE IF NOT EXISTS `rbac_account_permissions` (
    `accountId` int(10) unsigned NOT NULL COMMENT 'Account id',
    `permissionId` int(10) unsigned NOT NULL COMMENT 'Permission id',
    `granted` tinyint(4) NOT NULL DEFAULT 1 COMMENT 'Granted = 1, Denied = 0',
...
-- Dumping data for table acore_auth.rbac_account_permissions: ~0 rows (approximately)
...
-- Dumping structure for table acore_auth.rbac_default_permissions
...
-- Dumping data for table acore_auth.rbac_default_permissions: ~4 rows (approximately)
...
-- Dumping structure for table acore_auth.rbac_linked_permissions
...
-- Dumping data for table acore_auth.rbac_linked_permissions: ~654 rows (approximately)
...
-- Dumping structure for table acore_auth.rbac_permissions
...
-- Dumping data for table acore_auth.rbac_permissions: ~670 rows (approximately)
