...
ALTER TABLE `account_instance_times`
  ...
  RENAME COLUMN `releaseTime`TO ``,

ALTER TABLE `account_tutorial`
  RENAME COLUMN `accountId`TO ``,
  RENAME COLUMN `tut0`TO ``,
  RENAME COLUMN `tut1`TO ``,
  RENAME COLUMN `tut2`TO ``,
  RENAME COLUMN `tut3`TO ``,
  RENAME COLUMN `tut4`TO ``,
  RENAME COLUMN `tut5`TO ``,
  RENAME COLUMN `tut6`TO ``,
  RENAME COLUMN `tut7`TO ``,

ALTER TABLE `addons`
  RENAME COLUMN `name`TO ``,
  RENAME COLUMN `crc`TO ``,

ALTER TABLE `arena_team`
  RENAME COLUMN `arenaTeamId`TO ``,
  RENAME COLUMN `name`TO ``,
  RENAME COLUMN `captainGuid`TO ``,
  RENAME COLUMN `type`TO ``,
  RENAME COLUMN `rating`TO ``,
  RENAME COLUMN `seasonGames`TO ``,
  RENAME COLUMN `seasonWins`TO ``,
  RENAME COLUMN `weekGames`TO ``,
  RENAME COLUMN `weekWins`TO ``,
  RENAME COLUMN `rank`TO ``,
  RENAME COLUMN `backgroundColor`TO ``,
  RENAME COLUMN `emblemStyle`TO ``,
  RENAME COLUMN `emblemColor`TO ``,
  RENAME COLUMN `borderStyle`TO ``,
  RENAME COLUMN `borderColor`TO ``,
...
ALTER TABLE `arena_team_member`
  ...
  RENAME COLUMN `seasonGames`TO ``,
  RENAME COLUMN `seasonWins`TO ``,
  RENAME COLUMN `personalRating`TO ``,

ALTER TABLE `auctionhouse`
  RENAME COLUMN `id`TO ``,
  RENAME COLUMN `houseid`TO ``,
  RENAME COLUMN `itemguid`TO ``,
  RENAME COLUMN `itemowner`TO ``,
  RENAME COLUMN `buyoutprice`TO ``,
  RENAME COLUMN `time`TO ``,
  RENAME COLUMN `buyguid`TO ``,
  RENAME COLUMN `lastbid`TO ``,
  RENAME COLUMN `startbid`TO ``,
  RENAME COLUMN `deposit`TO ``,

ALTER TABLE `banned_addons`
  RENAME COLUMN `Id`TO ``,
  RENAME COLUMN `Name`TO ``,
  RENAME COLUMN `Version`TO ``,
  RENAME COLUMN `Timestamp`TO ``,

ALTER TABLE `battleground_deserters`
  RENAME COLUMN `guid`TO ``,
  RENAME COLUMN `type`TO ``,
  RENAME COLUMN `datetime`TO ``,

ALTER TABLE `bugreport`
  RENAME COLUMN `id`TO ``,
  RENAME COLUMN `type`TO ``,
  RENAME COLUMN `content`TO ``,

ALTER TABLE `calendar_events`
  RENAME COLUMN `id`TO ``,
  RENAME COLUMN `creator`TO ``,
  RENAME COLUMN `title`TO ``,
...
ALTER TABLE `character_pet`
  ...
  RENAME COLUMN `CreatedBySpell`TO ``,
  RENAME COLUMN `PetType`TO ``,
  RENAME COLUMN `level`TO ``,
...
ALTER TABLE `guild`
  ...
  RENAME COLUMN `BankMoney`TO ``,

ALTER TABLE `guild_bank_eventlog`
  RENAME COLUMN `guildid`TO ``,
  RENAME COLUMN `LogGuid`TO ``,
  RENAME COLUMN `TabId`TO ``,
  RENAME COLUMN `EventType`TO ``,
  RENAME COLUMN `PlayerGuid`TO ``,
  RENAME COLUMN `ItemOrMoney`TO ``,
  RENAME COLUMN `ItemStackCount`TO ``,
...
ALTER TABLE `guild_bank_right`
  ...
  RENAME COLUMN `SlotPerDay`TO ``,

ALTER TABLE `guild_bank_tab`
  RENAME COLUMN `guildid`TO ``,
  RENAME COLUMN `TabId`TO ``,
  RENAME COLUMN `TabName`TO ``,
  RENAME COLUMN `TabIcon`TO ``,
  RENAME COLUMN `TabText`TO ``,
...
ALTER TABLE `guild_rank`
  ...
  RENAME COLUMN `BankMoneyPerDay`TO ``,
