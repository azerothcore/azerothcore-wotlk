-- DB update 2021_10_17_06 -> 2021_10_17_07
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2021_10_17_06';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_10_17_06 2021_10_17_07 bit;
...
--
UPDATE version_db_world SET date = '2021_10_17_07' WHERE sql_rev = '1634485959723104200';
COMMIT;
END //
DELIMITER ;
CALL updateDb();
