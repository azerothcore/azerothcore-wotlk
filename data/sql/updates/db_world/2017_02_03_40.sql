-- DB update 2017_02_03_39 -> 2017_02_03_40
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2017_02_03_39';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2017_02_03_39 2017_02_03_40 bit;
SELECT sql_rev INTO OK FROM version_db_world WHERE sql_rev = '1485434129254921100'; IF OK <> 'FALSE' THEN LEAVE proc; END IF;
--
-- START UPDATING QUERIES
--
INSERT INTO version_db_world (`sql_rev`) VALUES ('1485434129254921100');
-- ========================================
