-- DB update 2021_06_17_02 -> 2021_06_17_03
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2021_06_17_02';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2021_06_17_02 2021_06_17_03 bit;
...
--
UPDATE version_db_world SET date = '2021_06_17_03' WHERE sql_rev = '1623303655379442308';
COMMIT;
END //
DELIMITER ;
CALL updateDb();
