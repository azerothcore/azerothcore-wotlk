...
DELETE FROM `creature_formations` WHERE `leaderguid` IN (49090, 49751, 49752, 49146, 49147, 49132, 49135, 49186, 49189, 52136, 49157, 49158, 49167, 49185, 51452, 49760, 49762, 49763, 49195, 49766, 49201, 49046, 91509, 49315, 51386);
