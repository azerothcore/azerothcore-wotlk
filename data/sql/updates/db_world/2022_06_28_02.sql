...
DELETE FROM `creature_formations` WHERE `leaderguid` IN (49751, 49090, 49090, 49146, 49132, 49135, 49186,  52136, 49158, 51452, 49760, 49762, 49195, 49766, 91509, 49046, 49315, 51386, 49201);
