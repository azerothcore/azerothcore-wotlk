...
VALUES
(1, 31139, 44009, 0, 9, 13281, 'Pustulent Horror - Flesh Giant Spine requires quest Neutralizing the Plague (H)'),
(1, 31139, 44009, 1, 9, 13297, 'Pustulent Horror - Flesh Giant Spine requires quest Neutralizing the Plague (A)');
