-- DB update 2022_04_01_13 -> 2022_04_01_14
...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'version_db_world' AND COLUMN_NAME = '2022_04_01_13';
IF @COLEXISTS = 0 THEN LEAVE proc; END IF;
START TRANSACTION;
ALTER TABLE version_db_world CHANGE COLUMN 2022_04_01_13 2022_04_01_14 bit;
SELECT sql_rev INTO OK FROM version_db_world WHERE sql_rev = '1648456523050586213'; IF OK <> 'FALSE' THEN LEAVE proc; END IF;
--
-- START UPDATING QUERIES
--

INSERT INTO `version_db_world` (`sql_rev`) VALUES ('1648456523050586213');
...
--
UPDATE version_db_world SET date = '2022_04_01_14' WHERE sql_rev = '1648456523050586213';
COMMIT;
END //
DELIMITER ;
CALL updateDb();
