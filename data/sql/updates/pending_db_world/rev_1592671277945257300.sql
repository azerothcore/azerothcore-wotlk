INSERT INTO `version_db_world` (`sql_rev`) VALUES ('1592671277945257300');

-- Migrate NPC to use SmartAI
UPDATE `creature_template` SET `AIName`= "SmartAI", `ScriptName`= '' WHERE `entry`= 3836;

-- Correct gossip_menu_options for Quest 3181 gossip
DELETE FROM `gossip_menu_option` WHERE `MenuID` IN (1201,1202,1203,1204,1205,1206) AND `OptionID` = 0;
...
DELETE FROM `gossip_menu` WHERE `MenuID` IN (1202,1203,1204,1205,1206);
...
(3836,0,0,0,62,0,100,0,1206,0,0,0,72,0,0,0,0,0,0,7,0,0,0,0,0,0,0,"Mountaineer Pebblebitty - on Gossip Menu Option 1206 selected - Close Gossip");
