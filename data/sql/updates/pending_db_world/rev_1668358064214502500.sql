...
(12097, 'esES', '¡JA! ¡Lo has hecho! Los soldados en la Puerta de Cólera están en deuda contigo, $N! Esto seguramente convenza a alguno de ellos para estar otro día más en la tierra.', 0), -- This'll surely buy a few of them another day above ground. <-- No tengo ni papa de lo que pueda significar esta mierda, se que la traducción literal no tiene sentido, tiene que ser algo concreto.
...
(12097, 'esMX', '¡JA! ¡Lo has hecho! Los soldados en la Puerta de Cólera están en deuda contigo, $N! Esto seguramente convenza a alguno de ellos para estar otro día más en la tierra.', 0), -- This'll surely buy a few of them another day above ground. <-- No tengo ni papa de lo que pueda significar esta mierda, se que la traducción literal no tiene sentido, tiene que ser algo concreto.
