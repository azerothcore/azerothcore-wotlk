INSERT INTO `version_db_world` (`sql_rev`) VALUES ('1624998621825147000');
...
WHERE `entry`= @FREE_POOL_TEMPLATE 
OR `entry`= @FREE_POOL_TEMPLATE+1
OR `entry`= @FREE_POOL_TEMPLATE+2
OR `entry`= @FREE_POOL_TEMPLATE+3
OR `entry`= @FREE_POOL_TEMPLATE+4
OR `entry`= @FREE_POOL_TEMPLATE+5
OR `entry`= @FREE_POOL_TEMPLATE+6
OR `entry`= @FREE_POOL_TEMPLATE+7
OR `entry`= @FREE_POOL_TEMPLATE+8
OR `entry`= @FREE_POOL_TEMPLATE+9
OR `entry`= @FREE_POOL_TEMPLATE+10
OR `entry`= @FREE_POOL_TEMPLATE+11
OR `entry`= @FREE_POOL_TEMPLATE+12
OR `entry`= @FREE_POOL_TEMPLATE+13
OR `entry`= @FREE_POOL_TEMPLATE+14
OR `entry`= @FREE_POOL_TEMPLATE+15
OR `entry`= @FREE_POOL_TEMPLATE+16
OR `entry`= @FREE_POOL_TEMPLATE+17;
...
WHERE `pool_entry`= @FREE_POOL_TEMPLATE 
OR `pool_entry`= @FREE_POOL_TEMPLATE+1
OR `pool_entry`= @FREE_POOL_TEMPLATE+2
OR `pool_entry`= @FREE_POOL_TEMPLATE+3
OR `pool_entry`= @FREE_POOL_TEMPLATE+4
OR `pool_entry`= @FREE_POOL_TEMPLATE+5
OR `pool_entry`= @FREE_POOL_TEMPLATE+6
OR `pool_entry`= @FREE_POOL_TEMPLATE+7
OR `pool_entry`= @FREE_POOL_TEMPLATE+8
OR `pool_entry`= @FREE_POOL_TEMPLATE+9
OR `pool_entry`= @FREE_POOL_TEMPLATE+10
OR `pool_entry`= @FREE_POOL_TEMPLATE+11
OR `pool_entry`= @FREE_POOL_TEMPLATE+12
OR `pool_entry`= @FREE_POOL_TEMPLATE+13
OR `pool_entry`= @FREE_POOL_TEMPLATE+14
OR `pool_entry`= @FREE_POOL_TEMPLATE+15
OR `pool_entry`= @FREE_POOL_TEMPLATE+16
OR `pool_entry`= @FREE_POOL_TEMPLATE+17;
...
DELETE FROM `pool_gameobject` WHERE `pool_entry`= 2008
OR `pool_entry`= 4400
OR `pool_entry`= 4401
OR `pool_entry`= 4402
OR `pool_entry`= 4403
...
DELETE FROM `pool_template` WHERE `entry`= 2008
OR `entry`= 4400
OR `entry`= 4401
OR `entry`= 4402
OR `entry`= 4403
...
(120363, 1733, 530, 0, 0, 1, 1, -1410.64, -11745, 24.3925, 2.75517, 0, 0, -0.981393, -0.19201, 300, 0, 1),
...
(2134646, 1733, 530, 0, 0, 1, 1, -1428.23, -11520.3, 26.1887, 4.08894, 0, 0, -0.889899, 0.456158, 300, 0, 1),
...
(2134666, 1733, 530, 0, 0, 1, 1, -2168.57, -10679.6, 47.6714, 5.22776, 0, 0, -0.503557, 0.863962, 300, 0, 1),
...
(2134686, 1733, 530, 0, 0, 1, 1, -1493.48, -11311.5, 72.8389, 1.14401, 0, 0, -0.541319, -0.840817, 300, 0, 1),
(2134687, 1733, 530, 0, 0, 1, 1, -1259.97, -11644.9, 5.90562, 3.24856, 0, 0, -0.99857, 0.0534586, 300, 0, 1),
...
(2134698, 1733, 530, 0, 0, 1, 1, -1961.35, -10836.5, 75.3578, 3.59069, 0, 0, -0.974895, 0.222664, 300, 0, 1),
(2134700, 1731, 530, 0, 0, 1, 1, -1995.28, -10558.2, 180.937, 3.5013, 0, 0, -0.98387, 0.178888, 300, 0, 1),
(2134701, 1733, 530, 0, 0, 1, 1, -1292.85, -11483.8, 10.8579, 2.54705, 0, 0, -0.956139, -0.292915, 300, 0, 1),
...
(2134730, 1733, 530, 0, 0, 1, 1, -1353.69, -10657.9, 95.6906, 5.5994, 0, 0, -0.33527, 0.942122, 300, 0, 1),
...
(2134738, 1733, 530, 0, 0, 1, 1, -1370.3, -11392.2, 26.9523, 2.96096, 0, 0, -0.995924, -0.0901952, 300, 0, 1),
