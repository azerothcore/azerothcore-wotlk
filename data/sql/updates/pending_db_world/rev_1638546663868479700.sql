...
UPDATE `pool_gameobject` SET `chance` = 35 WHERE `description` LIKE 'Ghostlands Spawn Point%(Tin)%';
UPDATE `pool_gameobject` SET `chance` = 5 WHERE `description` LIKE 'Ghostlands Spawn Point%(Silver)%';
UPDATE `pool_gameobject` SET `chance` = 30 WHERE `description` LIKE 'Spawn Point%Tin%' AND `chance` = 70;
UPDATE `pool_gameobject` SET `chance` = 5 WHERE `description` LIKE 'Spawn Point%Silver%' AND `chance` = 30;
