...
-- es ES
UPDATE `quest_template_locale` SET `CompletedText` = 'Vuelve con: Guardián Bel\'dugur. Zona: Apothecarium de Entrañas.' WHERE `ID` = 1013 AND `locale` = 'esES';

-- esMX
UPDATE `quest_template_locale` SET `CompletedText` = 'Vuelve con: Guardián Bel\'dugur. Zona: Apothecarium de Entrañas.' WHERE `ID` = 1013 AND `locale` = 'esMX';
