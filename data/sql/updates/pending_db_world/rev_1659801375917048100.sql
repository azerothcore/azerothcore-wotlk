...
(7047, 0, 1, 'Let\'s see.', 3, 128, 0, 0, 0, 0, ''), -- 15471
...
(15,7047,0,0,0,13,0,1,3,2,1,0,0,'','Show gossip option if Rajaxx is not done'),
(15,7047,1,0,0,13,0,1,3,2,0,0,0,'','Show gossip option if Rajaxx is done');
