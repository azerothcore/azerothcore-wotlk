...
/* BOSS */ 
UPDATE `creature_template` SET `mindmg` = 13400, `maxdmg` = 17850, `DamageModifier` = 1.01 WHERE `entry` = 28859;
UPDATE `creature_template` SET `mindmg` = 26450, `maxdmg` = 35150, `DamageModifier` = 1.01 WHERE `entry` = 31734;
