...
/* BOSS */ 
UPDATE `creature_template` SET `mindmg` = 14850, `maxdmg` = 18750, `DamageModifier` = 1.01 WHERE `entry` = 28859;
UPDATE `creature_template` SET `mindmg` = 21757, `maxdmg` = 35350, `DamageModifier` = 1.01 WHERE `entry` = 31734;
