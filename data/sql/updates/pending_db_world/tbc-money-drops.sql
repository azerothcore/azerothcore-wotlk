...
UPDATE `creature_template` SET `mingold` = 4750000, `maxgold` = 5250000 WHERE `entry` IN (17257, 17711, 18728); -- Entirely guessed, ±25g from 500g (average money from Wowhead)
