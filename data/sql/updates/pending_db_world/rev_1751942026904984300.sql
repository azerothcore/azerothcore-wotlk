...
UPDATE `creature_template` SET `ScriptName` = '' WHERE `entry` IN (28610, 28936, 28939, 28940);
...
UPDATE `creature_template` SET `AIName` = 'SmartAI' WHERE `entry` = 28940;
...
UPDATE `creature_template` SET `AIName` = 'SmartAI' WHERE `entry` = 28610;
