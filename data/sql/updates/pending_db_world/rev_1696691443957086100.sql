...
DELETE FROM `pool_template` WHERE `entry` IN (11699,11706,11707);
...
DELETE FROM `pool_pool` WHERE `mother_pool` IN (11699);
INSERT INTO `pool_pool` (`pool_id`, `mother_pool`, `chance`, `description`) VALUES
(11706, 11699, 0, 'Desolace - Mithril Deposit - Group 1'),
(11707, 11699, 0, 'Desolace - Mithril Deposit - Group 1');
