...
DELETE FROM `creature_loot_template` WHERE `Entry` = 193 AND `Item` = 21949;
INSERT INTO `creature_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
(193, 21949, 0, 0.5, 0, 1, 1, 1, 1, 'Blue Dragonspawn - Design: Ruby Serpent');

DELETE FROM `creature_loot_template` WHERE `Entry` = 6130 AND `Item` = 21949;
INSERT INTO `creature_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
(6130, 21949, 0, 0.5, 0, 1, 1, 1, 1, 'Blue Scalebane - Design: Ruby Serpent');

DELETE FROM `creature_loot_template` WHERE `Entry` = 6129 AND `Item` = 21949;
INSERT INTO `creature_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
(6129, 21949, 0, 0.5, 0, 1, 1, 1, 1, 'Draconic Magelord - Design: Ruby Serpent');

DELETE FROM `creature_loot_template` WHERE `Entry` = 6131 AND `Item` = 21949;
INSERT INTO `creature_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
