--
UPDATE `creature_template_addon` SET `bytes2` = 1, `auras` = '33900 37411 37509' WHERE (`entry` = 21787);
...
(21787, 0, 0, 0, 0, 0, 100, 0, 4200, 7700, 7100, 16200, 0, 0, 11, 11639, 0, 0, 0, 0, 0, 5, 0, 0, 0, 11639, 0, 0, 0, 0, 'Time-Lost Skettis High Priest - In Combat - Cast \'Shadow Word: Pain\''),
...
(21787, 0, 2, 0, 74, 0, 100, 0, 10000, 15000, 10000, 15000, 60, 40, 11, 42420, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 0, 'Time-Lost Skettis High Priest - On Friendly Below 60% Health - Cast \'Flash Heal\'');
