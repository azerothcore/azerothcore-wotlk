INSERT INTO `version_db_world` (`sql_rev`) VALUES ('1592667231189465500');
...
DELETE FROM `gossip_menu` WHERE `MenuID` IN (57000,57001,57002,57003,57004,57005,57006);
INSERT INTO `gossip_menu` (`MenuID`,`TextID`) VALUES 
(57000,1674),(57001,1675),(57002,1676),(57003,1677),(57004,1678),(57005,1679);

DELETE FROM `gossip_menu_option` WHERE (`MenuID` BETWEEN 57000 AND 57005) OR (`MenuID` IN (8072));
