...
-- Young Lashtail Raptor: DamageModifier 1 -> 1.25 (melee, WotLK, 30 swings, k 1.226-1.240)
...
-- Gorlash: ExperienceModifier 1 -> 1.25 (xp, WotLK, 4 kills in 4 sniffs, 1.00 at median)
...
-- King Mukla: ExperienceModifier 1 -> 2 (xp, WotLK, 3 kills in 3 sniffs, 1.00 at median)
...
-- Boulderfist Lord: ExperienceModifier 1 -> 1.1 (xp, WotLK, 8 kills in 3 sniffs, 1.00 at median)
...
-- Marez Cowl: ExperienceModifier 1 -> 2 (xp, WotLK, 3 kills in 3 sniffs, 1.00 at median)
...
-- Razormane Dustrunner: DamageModifier 1 -> 0.95 (melee, WotLK, 34 swings, k 0.923-0.964)
UPDATE `creature_template` SET `DamageModifier` = 0.95 WHERE `entry` = 3113;
...
-- Kolkar Outrunner: DamageModifier 1 -> 0.95 (melee, TBC, 38 swings, k 0.925-0.947)
UPDATE `creature_template` SET `DamageModifier` = 0.95 WHERE `entry` = 3120;
...
-- Needles Cougar: DamageModifier 1 -> 1.2 (melee, WotLK, 152 swings, k 1.170-1.186)
...
-- Hatecrest Screamer: ExperienceModifier 1 -> 0.95 (xp, WotLK, 12 kills in 2 sniffs, 0.58 at median)
...
-- Crazed Dragonhawk: DamageModifier 1 -> 0.95 (melee, WotLK, 397 swings, k 0.932-0.942)
UPDATE `creature_template` SET `DamageModifier` = 0.95 WHERE `entry` = 15650;
...
-- Wretched Hooligan: DamageModifier 1 -> 0.95 (melee, WotLK, 121 swings, k 0.924-0.936)
UPDATE `creature_template` SET `DamageModifier` = 0.95 WHERE `entry` = 16162;
...
-- Mag'har Grunt: ExperienceModifier 1 -> 0.65 (xp, WotLK, 54 kills in 5 sniffs, 1.00 at median)
UPDATE `creature_template` SET `ExperienceModifier` = 0.65 WHERE `entry` = 16846;
-- Debilitated Mag'har Grunt: ExperienceModifier 1 -> 0.65 (xp, WotLK, 41 kills in 5 sniffs, 1.00 at median)
...
-- Blistering Oozeling: ExperienceModifier 1 -> 0.05 (xp, WotLK, 80 kills in 10 sniffs, 0.89 at median)
...
-- Dreghood Brute: ExperienceModifier 1 -> 0.65 (xp, WotLK, 22 kills in 3 sniffs, 0.73 at median)
...
-- Netherhound: ExperienceModifier 1 -> 0.4 (xp, WotLK, 22 kills in 7 sniffs, 1.00 at median)
...
-- Dreghood Drudge: ExperienceModifier 1 -> 0.7 (xp, WotLK, 7 kills in 3 sniffs, 1.00 at median)
UPDATE `creature_template` SET `ExperienceModifier` = 0.7 WHERE `entry` = 18122;
-- Wrekt Slave: DamageModifier 1 -> 0.65 (melee, WotLK, 564 swings, k 0.650-0.647); ExperienceModifier 1 -> 0.7 (xp, WotLK, 12 kills in 7 sniffs, 1.00 at median)
...
-- Murkblood Raider: ExperienceModifier 1 -> 0.9 (xp, WotLK, 54 kills in 6 sniffs, 1.00 at median)
UPDATE `creature_template` SET `ExperienceModifier` = 0.9 WHERE `entry` = 18203;
-- Murkblood Scavenger: DamageModifier 0.55 -> 0.5 (melee, WotLK, 263 swings, k 0.494-0.502); ExperienceModifier 1 -> 0.25 (xp, WotLK, 94 kills in 6 sniffs, 1.00 at median)
...
-- Murkblood Brute: ExperienceModifier 1 -> 0.8 (xp, WotLK, 12 kills in 3 sniffs, 1.00 at median)
UPDATE `creature_template` SET `ExperienceModifier` = 0.8 WHERE `entry` = 18211;
-- Mudfin Frenzy: ExperienceModifier 1 -> 0.25 (xp, WotLK, 11 kills in 4 sniffs, 1.00 at median)
...
-- Sharth Voldoun: ExperienceModifier 1 -> 1.5 (xp, WotLK, 3 kills in 3 sniffs, 1.00 at median)
...
-- Shimmerscale Eel: ExperienceModifier 1 -> 0.65 (xp, WotLK, 38 kills in 2 sniffs, 1.00 at median)
...
-- Heckling Fel Sprite: ExperienceModifier 1 -> 0.4 (xp, WotLK, 57 kills in 8 sniffs, 1.00 at median)
...
-- Flamewaker Imp: DamageModifier 0.4 -> 0.35 (melee, WotLK, 54 swings, k 0.341-0.347); ExperienceModifier 1 -> 0.3 (xp, WotLK, 28 kills in 8 sniffs, 1.00 at median)
...
-- Fel Handler: DamageModifier 3 -> 0.8 (melee, TBC, 134 swings, k 0.798-0.794); ExperienceModifier 1 -> 0.8 (xp, WotLK, 23 kills in 8 sniffs, 1.00 at median)
...
-- Grillok "Darkeye": ExperienceModifier 1 -> 1.5 (xp, WotLK, 4 kills in 4 sniffs, 1.00 at median)
...
-- Warp-Raider Nesaad: ExperienceModifier 1 -> 1.2 (xp, WotLK, 6 kills in 6 sniffs, 1.00 at median)
...
-- Daggerfen Servant: ExperienceModifier 1 -> 0.4 (xp, WotLK, 30 kills in 9 sniffs, 1.00 at median)
...
-- Darkcrest Sentry: ExperienceModifier 1 -> 0.25 (xp, WotLK, 4 kills in 2 sniffs, 1.00 at median)
UPDATE `creature_template` SET `ExperienceModifier` = 0.25 WHERE `entry` = 20079;
-- Bloodscale Sentry: ExperienceModifier 1 -> 0.25 (xp, WotLK, 3 kills in 3 sniffs, 1.00 at median)
...
-- Culuthas: ExperienceModifier 1 -> 1.5 (xp, WotLK, 4 kills in 4 sniffs, 1.00 at median)
...
-- Deathforge Summoner: ExperienceModifier 1 -> 0.9 (xp, WotLK, 13 kills in 2 sniffs, 1.00 at median)
UPDATE `creature_template` SET `ExperienceModifier` = 0.9 WHERE `entry` = 20872;
-- Deathforge Imp: ExperienceModifier 1 -> 0.25 (xp, WotLK, 10 kills in 2 sniffs, 1.00 at median)
...
-- Fel Corrupter: ExperienceModifier 1 -> 0.75 (xp, WotLK, 6 kills in 3 sniffs, 1.00 at median)
...
-- Minion of Terokk: DamageModifier 2 -> 1.5 (melee, WotLK, 54 swings, k 1.490-1.496)
UPDATE `creature_template` SET `DamageModifier` = 1.5 WHERE `entry` = 22376;
...
-- Chill Nymph: ExperienceModifier 1 -> 1.05 (xp, WotLK, 17 kills in 2 sniffs, 0.76 at median)
...
-- Glacion: DamageModifier 4.6 -> 3 (melee, WotLK, 125 swings, k 2.987-2.995); ExperienceModifier 1 -> 1.5 (xp, WotLK, 5 kills in 4 sniffs, 0.80 at median)
...
-- Megalith: DamageModifier 4.6 -> 2 (melee, WotLK, 33 swings, k 1.977-1.987)
UPDATE `creature_template` SET `DamageModifier` = 2 WHERE `entry` = 24371;
...
-- Riplash Myrmidon: DamageModifier 1 -> 0.1 (melee, WotLK, 177 swings, k 0.099-0.099); ExperienceModifier 1 -> 0.33 (xp, WotLK, 6 kills in 6 sniffs, 1.00 at median)
...
-- Irespeaker: DamageModifier 1.5 -> 1 (melee, TBC, 180 swings, k 0.996-0.995); ExperienceModifier 1 -> 1.45 (xp, WotLK, 23 kills in 5 sniffs, 0.52 at median)
...
-- Unleashed Hellion: DamageModifier 1.4 -> 1 (melee, WotLK, 184 swings, k 1.001-0.998); ExperienceModifier 1 -> 1.45 (xp, WotLK, 37 kills in 5 sniffs, 0.51 at median)
UPDATE `creature_template` SET `DamageModifier` = 1, `ExperienceModifier` = 1.45 WHERE `entry` = 25002;
-- Emissary of Hate: DamageModifier 2 -> 1.2 (melee, WotLK, 45 swings, k 1.192-1.189); ExperienceModifier 1 -> 1.45 (xp, WotLK, 10 kills in 5 sniffs, 0.50 at median)
...
-- Force-Commander Steeljaw: ExperienceModifier 1 -> 1.5 (xp, WotLK, 4 kills in 4 sniffs, 1.00 at median)
...
-- Offspring of Magmothregar: DamageModifier 1 -> 0.25 (melee, WotLK, 106 swings, k 0.250-0.249); ExperienceModifier 1 -> 0.25 (xp, WotLK, 27 kills in 6 sniffs, 1.00 at median)
...
-- Coldarra Mage Slayer: DamageModifier 1 -> 0.5 (melee, WotLK, 635 swings, k 0.496-0.498); ExperienceModifier 1 -> 0.75 (xp, WotLK, 56 kills in 10 sniffs, 0.96 at median)
...
-- Northsea Thug: ExperienceModifier 1 -> 0.8 (xp, WotLK, 17 kills in 6 sniffs, 0.76 at median)
UPDATE `creature_template` SET `ExperienceModifier` = 0.8 WHERE `entry` = 25843;
-- Minion of Kaw: ExperienceModifier 1 -> 0.1 (xp, WotLK, 31 kills in 6 sniffs, 0.94 at median)
...
-- Ursoc: ExperienceModifier 1 -> 7.5 (xp, WotLK, 4 kills in 2 sniffs, 0.50 at median)
...
-- High General Abbendis: DamageModifier 4.6 -> 6 (melee, WotLK, 45 swings, k 6.033-6.027); ExperienceModifier 1 -> 1.25 (xp, WotLK, 3 kills in 3 sniffs, 1.00 at median)
...
-- Luthion the Vile: ExperienceModifier 1 -> 2.5 (xp, WotLK, 3 kills in 2 sniffs, 0.67 at median)
...
-- Hardknuckle Forager: DamageModifier 1 -> 0.75 (melee, WotLK, 149 swings, k 0.748-0.747); ExperienceModifier 1 -> 0.75 (xp, WotLK, 40 kills in 4 sniffs, 0.80 at median)
...
-- Broodmother Slivina: DamageModifier 4.6 -> 4 (melee, WotLK, 146 swings, k 3.990-4.003); ExperienceModifier 1 -> 1.5 (xp, WotLK, 5 kills in 3 sniffs, 0.60 at median)
...
-- High Cultist Herenn: ExperienceModifier 1 -> 2.25 (xp, WotLK, 4 kills in 3 sniffs, 0.75 at median)
...
-- Risen Soldier: DamageModifier 1 -> 0.3 (melee, WotLK, 213 swings, k 0.298-0.299)
UPDATE `creature_template` SET `DamageModifier` = 0.3 WHERE `entry` = 30960;
...
-- Corp'rethar Guardian: DamageModifier 4.6 -> 10 (melee, WotLK, 54 swings, k 9.970-9.994)
UPDATE `creature_template` SET `DamageModifier` = 10 WHERE `entry` = 32280;
