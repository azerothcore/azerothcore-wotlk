...
UPDATE `quest_template_addon` SET `RequiredMinRepValue` = -42000, `RequiredMaxRepValue` = 0 WHERE `id` IN (10017, 10019);

-- Mark of Kil'jaden: From Neutral to Honoured
UPDATE `quest_template_addon` SET `RequiredMinRepValue` = 0, `RequiredMaxRepValue` = 9000 WHERE `id` IN (10325, 10326, 10327);
...
UPDATE `quest_template_addon` SET `RequiredMinRepValue` = -42000, `RequiredMaxRepValue` = 0 WHERE `id` IN (10024, 10025);

-- Firewing Signet: From Neutral to Honoured
UPDATE `quest_template_addon` SET `RequiredMinRepValue` = 0, `RequiredMaxRepValue` = 9000 WHERE `id` IN (10412, 10415, 10414);
