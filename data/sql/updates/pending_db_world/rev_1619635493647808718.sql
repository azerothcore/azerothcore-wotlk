...
(87386,@POOL,0,@POOLDESC),
(11755,@POOL,0,@POOLDESC),
(14618,@POOL,0,@POOLDESC),
(85709,@POOL,0,@POOLDESC),
(85714,@POOL,0,@POOLDESC),
(13632,@POOL,0,@POOLDESC),
(85864,@POOL,0,@POOLDESC),
(85706,@POOL,0,@POOLDESC),
(9096,@POOL,0,@POOLDESC),
(14619,@POOL,0,@POOLDESC),
(14931,@POOL,0,@POOLDESC),
(40758,@POOL,0,@POOLDESC),
(40772,@POOL,0,@POOLDESC),
(40796,@POOL,0,@POOLDESC),
(85718,@POOL,0,@POOLDESC),
(85721,@POOL,0,@POOLDESC),
(85722,@POOL,0,@POOLDESC),
(85734,@POOL,0,@POOLDESC),
(85735,@POOL,0,@POOLDESC);
