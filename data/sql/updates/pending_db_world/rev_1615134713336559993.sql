...
UPDATE `creature_template` SET `resistance5`=30 WHERE `entry`=3417; -- 'Living Flame, level 17, resistance5 was 0 (Shadow)
...
UPDATE `creature_template` SET `resistance2`=19 WHERE `entry`=6748; -- 'Water Spirit, level 18, resistance2 was 0 (Fire)
UPDATE `creature_template` SET `resistance3`=38 WHERE `entry`=6748; -- 'Water Spirit, level 18, resistance3 was 0 (Nature)
UPDATE `creature_template` SET `resistance5`=38 WHERE `entry`=6748; -- 'Water Spirit, level 18, resistance5 was 0 (Shadow)
UPDATE `creature_template` SET `resistance6`=19 WHERE `entry`=6748; -- 'Water Spirit, level 18, resistance6 was 0 (Arcane)
...
UPDATE `creature_template` SET `resistance6`=76 WHERE `entry`=10373; -- 'Xabraxxis, level 19, resistance6 was 0 (Arcane)
