INSERT INTO `version_db_world` (`sql_rev`) VALUES ('1601870525065182700');
...
UPDATE `creature_template` SET `InhabitType`=5 WHERE  `entry`=33779;
...
(33662, 0, 0, 0, 1, 0, 100, 1, 1000, 1000, 1000, 1000, 0, 11, 39123, 2, 0, 0, 0, 0, 11, 33779, 60, 0, 0, 0, 0, 0, 0, 'Kirin Tor Battle-Mage - Out of combat - Cast /58847/');
