...
UPDATE pool_gameobject SET pool_gameobject.chance = 70 WHERE pool_gameobject.description LIKE 'Ghostlands Spawn Point%(Tin)%';
UPDATE pool_gameobject SET pool_gameobject.chance = 30 WHERE pool_gameobject.description LIKE 'Ghostlands Spawn Point%(Silver)%';
