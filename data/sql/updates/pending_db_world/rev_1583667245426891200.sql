...
-- The Deadmines (18-23)
-- -------------------------------------------------------------------------------------------------------------------------------------------------
-- Brainwashed Noble (Entrance) (Not listed in Beastiary) Src: https://classicdb.ch/?npc=596
UPDATE `creature_template` SET `mindmg` = 109, `maxdmg` = 131 WHERE `entry` = 596;
...
-- -------------------------------------------------------------------------------------------------------------------------------------------------
-- Fel Steed (Not listed in Beastiary) Src: https://classicdb.ch/?npc=3864
UPDATE `creature_template` SET `mindmg` = 154, `maxdmg` = 183 WHERE `entry` = 3864;
-- Shadow Charger (Not listed in Beastiary) Src: https://classicdb.ch/?npc=3865
UPDATE `creature_template` SET `mindmg` = 145, `maxdmg` = 172 WHERE `entry` = 3865;
-- Deathsworn Captain
...
-- Kam Deepfury (Not listed in beastiary) Src: https://classicdb.ch/?npc=1666
UPDATE `creature_template` SET `mindmg` = 197, `maxdmg` = 234 WHERE `entry` = 1666;
-- Targorr the Dread
...
-- Gnomeregan (29-38)
-- -------------------------------------------------------------------------------------------------------------------------------------------------
-- Namdo Bizzfizzle (Entrance) (Not listed in Beastiary) Src: https://classicdb.ch/?npc=2683
UPDATE `creature_template` SET `mindmg` = 74, `maxdmg` = 84 WHERE `entry` = 2683;
-- Techbot (Entrance)
...
-- Crowd Pummeler 9-60 (Not listed in Beastiary) Src: https://classicdb.ch/?npc=6229
UPDATE `creature_template` SET `mindmg` = 295, `maxdmg` = 351 WHERE `entry` = 6229;
...
-- Fallen Champion (Not listed in Beastiary) Src: https://classicdb.ch/?npc=6488
UPDATE `creature_template` SET `mindmg` = 266, `maxdmg` = 316 WHERE `entry` = 6488;
-- Ironspine
...
-- Baelog (Not listed in beastiary) Src: https://classicdb.ch/?npc=6906
UPDATE `creature_template` SET `mindmg` = 411, `maxdmg` = 488 WHERE `entry` = 6906;
-- Revelosh
...
-- Galgann Firehammer (Not listed in Beastiary) Src: https://classicdb.ch/?npc=7291
UPDATE `creature_template` SET `mindmg` = 319, `maxdmg` = 410 WHERE `entry` = 7291;
...
-- Dustwraith (Not listed in Beastiary) Src: https://classicdb.ch/?npc=10081
UPDATE `creature_template` SET `mindmg` = 64, `maxdmg` = 82 WHERE `entry` = 10081;
-- Zerillis
...
-- Avatar of Hakkar (Not listed in Beastiary) Src: https://classicdb.ch/?npc=8443
UPDATE `creature_template` SET `mindmg` = 459, `maxdmg` = 547 WHERE `entry` = 8443;
-- Atal'alarion
...
-- Hurley Blackbreath (Not listed in Beastiary) Src: https://classicdb.ch/?npc=9537
UPDATE `creature_template` SET `mindmg` = 526, `maxdmg` = 626 WHERE `entry` = 9537;
-- Ribbly Screwspigot
...
-- Jed Runewatcher (Not listed in Beastiary) Src: https://classicdb.ch/?npc=10509
UPDATE `creature_template` SET `mindmg` = 530, `maxdmg` = 630 WHERE `entry` = 10509;
-- Goraluk Anvilcrack
...
-- The Ravenian (Not listed in Beastiary) Src: https://classicdb.ch/?npc=10507
UPDATE `creature_template` SET `mindmg` = 832, `maxdmg` = 991 WHERE `entry` = 10507;
-- Ras Frostwhisper
...
UPDATE `creature_template` SET `mindmg` = 925, `maxdmg` = 1103 WHERE `entry` = 10440;
-- The Unforgiven
...
-- Black Guard Swordsmith (Not listed in Beastiary) Src: https://classicdb.ch/?npc=11121
UPDATE `creature_template` SET `mindmg` = 878, `maxdmg` = 959 WHERE `entry` = 11121;
-- Postmaster Malown
...
UPDATE `creature_template` SET `mindmg` = 854, `maxdmg` = 1015 WHERE `entry` = 11486;
-- Magister Kalendris
...
-- Knot Thimblejack (Not listed in Beastiary) Src: https://classicdb.ch/?npc=14338
UPDATE `creature_template` SET `mindmg` = 130, `maxdmg` = 154 WHERE `entry` = 14338;
...
-- -------------------------------------------------------------------------------------------------------------------------------------------------
UPDATE `creature_template` SET `minrangedmg` = 98, `maxrangedmg` = 138 WHERE `entry` = 596;
...
UPDATE `creature_template` SET `minrangedmg` = 135, `maxrangedmg` = 203 WHERE `entry` = 1666;
...
UPDATE `creature_template` SET `minrangedmg` = 50, `maxrangedmg` = 74 WHERE `entry` = 2683;
...
UPDATE `creature_template` SET `minrangedmg` = 108, `maxrangedmg` = 154 WHERE `entry` = 3864;
UPDATE `creature_template` SET `minrangedmg` = 102, `maxrangedmg` = 145 WHERE `entry` = 3865;
...
UPDATE `creature_template` SET `minrangedmg` = 204, `maxrangedmg` = 303 WHERE `entry` = 6229;
...
UPDATE `creature_template` SET `minrangedmg` = 183, `maxrangedmg` = 272 WHERE `entry` = 6488;
...
UPDATE `creature_template` SET `minrangedmg` = 282, `maxrangedmg` = 419 WHERE `entry` = 6906;
...
UPDATE `creature_template` SET `minrangedmg` = 221, `maxrangedmg` = 325 WHERE `entry` = 7291;
...
UPDATE `creature_template` SET `minrangedmg` = 313, `maxrangedmg` = 464 WHERE `entry` = 8443;
...
UPDATE `creature_template` SET `minrangedmg` = 364, `maxrangedmg` = 532 WHERE `entry` = 9537;
...
UPDATE `creature_template` SET `minrangedmg` = 44, `maxrangedmg` = 65 WHERE `entry` = 10081;
...
UPDATE `creature_template` SET `minrangedmg` = 576, `maxrangedmg` = 848 WHERE `entry` = 10507;
UPDATE `creature_template` SET `minrangedmg` = 324, `maxrangedmg` = 480 WHERE `entry` = 10508;
UPDATE `creature_template` SET `minrangedmg` = 364, `maxrangedmg` = 535 WHERE `entry` = 10509;
...
UPDATE `creature_template` SET `minrangedmg` = 710, `maxrangedmg` = 1057 WHERE `entry` = 11121;
...
UPDATE `creature_template` SET `minrangedmg` = 89, `maxrangedmg` = 132 WHERE `entry` = 14338;
