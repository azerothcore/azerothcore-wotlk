...
UPDATE `creature_template` SET `mindmg` = 37621, `maxdmg` = 50188, `DamageModifier` = 1.01 WHERE `entry` = 31722;
...
UPDATE `creature_template` SET `mindmg` = 37998, `maxdmg` = 52250, `DamageModifier` = 1.01 WHERE `entry` = 33994;
 /* 3rd: Towards Tier 8.5 / 9. */
UPDATE `creature_template` SET `mindmg` = 18720, `maxdmg` = 26481, `DamageModifier` = 1.01 WHERE `entry` = 35013;
UPDATE `creature_template` SET `mindmg` = 38376, `maxdmg` = 54286, `DamageModifier` = 1.01 WHERE `entry` = 35360;
...
UPDATE `creature_template` SET `mindmg` = 38814, `maxdmg` = 56340, `DamageModifier` = 1.01 WHERE `entry` = 38462;
