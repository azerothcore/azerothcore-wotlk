...
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 4572, `maxdmg` = 5646, `DamageModifier` = 1.04 WHERE `entry` = 16387;
...
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 1329, `maxdmg` = 1759, `DamageModifier` = 1.01 WHERE `entry` = 16042;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 575, `maxdmg` = 763, `DamageModifier` = 1.01 WHERE `entry` = 8923;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 394, `maxdmg` = 522, `DamageModifier` = 1.01 WHERE `entry` = 8929;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 547, `maxdmg` = 725, `DamageModifier` = 1.01 WHERE `entry` = 8983;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 636, `maxdmg` = 844, `DamageModifier` = 1.01 WHERE `entry` = 9016;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 450, `maxdmg` = 597, `DamageModifier` = 1.01 WHERE `entry` = 9017;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 271, `maxdmg` = 359, `DamageModifier` = 1.01 WHERE `entry` = 9018;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 695, `maxdmg` = 922, `DamageModifier` = 1.01 WHERE `entry` = 9019;
...
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 257, `maxdmg` = 340, `DamageModifier` = 1.01 WHERE `entry` = 9026;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 477, `maxdmg` = 633, `DamageModifier` = 1.01 WHERE `entry` = 9027;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 530, `maxdmg` = 703, `DamageModifier` = 1.01 WHERE `entry` = 9028;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 401, `maxdmg` = 531, `DamageModifier` = 1.01 WHERE `entry` = 9029;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 349, `maxdmg` = 463, `DamageModifier` = 1.01 WHERE `entry` = 9030;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 444, `maxdmg` = 588, `DamageModifier` = 1.01 WHERE `entry` = 9031;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 583, `maxdmg` = 774, `DamageModifier` = 1.01 WHERE `entry` = 9032;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 550, `maxdmg` = 730, `DamageModifier` = 1.01 WHERE `entry` = 9033;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 350, `maxdmg` = 464, `DamageModifier` = 1.01 WHERE `entry` = 9034;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 376, `maxdmg` = 499, `DamageModifier` = 1.01 WHERE `entry` = 9035;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 321, `maxdmg` = 425, `DamageModifier` = 1.01 WHERE `entry` = 9036;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 537, `maxdmg` = 712, `DamageModifier` = 1.01 WHERE `entry` = 9037;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 321, `maxdmg` = 425, `DamageModifier` = 1.01 WHERE `entry` = 9038;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 330, `maxdmg` = 437, `DamageModifier` = 1.01 WHERE `entry` = 9039;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 384, `maxdmg` = 509, `DamageModifier` = 1.01 WHERE `entry` = 9040;
...
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 638, `maxdmg` = 788, `DamageModifier` = 1.01 WHERE `entry` = 9056;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 470, `maxdmg` = 624, `DamageModifier` = 1.01 WHERE `entry` = 9156;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 327, `maxdmg` = 434, `DamageModifier` = 1.01 WHERE `entry` = 9319;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 331, `maxdmg` = 381, `DamageModifier` = 1.01 WHERE `entry` = 9499;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 658, `maxdmg` = 873, `DamageModifier` = 1.01 WHERE `entry` = 9502;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 705, `maxdmg` = 935, `DamageModifier` = 1.01 WHERE `entry` = 9537; 
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 297, `maxdmg` = 394, `DamageModifier` = 1.01 WHERE `entry` = 9543; 
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 806, `maxdmg` = 1068, `DamageModifier` = 1.01 WHERE `entry` = 9938; 
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 403, `maxdmg` = 514, `DamageModifier` = 1 WHERE `entry` = 16059; 
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 482, `maxdmg` = 657, `DamageModifier` = 1.63 WHERE `entry` = 16080;
