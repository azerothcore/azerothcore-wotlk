...
DELETE FROM `waypoint_data` WHERE `id` IN (177721,177722,177723,177724,177725,177726,177727,178521,178522,178523,178524,178525,178526,179481,179482,179483,179061,179062,179063,179064,179065,179066,179071,179072,179073);
