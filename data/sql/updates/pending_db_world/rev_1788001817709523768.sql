...
DELETE FROM `creature_loot_template` WHERE `Entry` = 10506 AND (`Item` IN (13955, 13956, 13957, 13960, 13967, 13969, 13983, 14024, 16734) OR (`Item` = 1 AND `Reference` IN (10506, 1025963)));
...
(10506, 1, 10506, 0, 0, 1, 1, 1, 1, 'Kirtonos the Herald - Green equipment'),
...
(10506, 1, 10506, 0, 0, 1, 2, 1, 1, 'Kirtonos the Herald - Green equipment');
