...
(35458, 'Items ({}):', '아이템 ({}):', 'Objets ({}) :', 'Gegenstände ({}):', '物品 ({})：', '物品 ({})：', 'Objetos ({}):', 'Objetos ({}):', 'Предметы ({}):'),
...
(35460, 'Quest items ({}):', '퀘스트 아이템 ({}):', 'Objets de quête ({}) :', 'Questgegenstände ({}):', '任务物品 ({})：', '任務物品 ({})：', 'Objetos de misión ({}):', 'Objetos de misión ({}):', 'Предметы заданий ({}):');
