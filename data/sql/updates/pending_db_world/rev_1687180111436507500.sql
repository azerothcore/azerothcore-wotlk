...
DELETE FROM `smart_scripts` WHERE (`entryorguid` = 21735) AND (`source_type` = 0) AND (`id` IN (3, 4));
...
(21735, 0, 4, 0, 54, 0, 100, 0, 0, 0, 0, 0, 0, 41, 0, 0, 0, 0, 0, 0, 11, 21735, 80, 0, 0, 0, 0, 0, 0, 'Infernal Oversoul - On Just Summoned - Despawn Instant');
