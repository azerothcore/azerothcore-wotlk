...
SET @REPREGULAR := 18;
SET @REPBOSS := 275;
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1` = @REPTRASH, `RewOnKillRepValue2` = @REPTRASH WHERE `creature_id` IN (30902, 30903); -- whelps, azure ring guardians
