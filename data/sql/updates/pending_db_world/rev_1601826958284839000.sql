...
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6752, `maxdmg` = 9425, `DamageModifier` = 1.01 WHERE `entry` = 31558;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 3793, `maxdmg` = 4680, `DamageModifier` = 1.01 WHERE `entry` = 27447;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6851, `maxdmg` = 9432, `DamageModifier` = 1.01 WHERE `entry` = 31559;
...
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6883, `maxdmg` = 9957, `DamageModifier` = 1.01 WHERE `entry` = 31561;
