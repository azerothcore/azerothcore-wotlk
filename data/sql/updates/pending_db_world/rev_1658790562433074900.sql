...
UPDATE `creature_template` SET `mingold`=0, `maxgold`=0 WHERE `entry`=15527;
...
(15527, 0, 1, 0, 13, 0, 100, 0, 7000, 14000, 7000, 14000, 11, 15122, 2, 2, 'Mana Fiend - In Combat - Cast Counterspell');
