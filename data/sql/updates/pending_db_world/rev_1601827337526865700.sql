...
/* BOSS */ 
UPDATE `creature_template` SET `mindmg` = 13743, `maxdmg` = 18441, `DamageModifier` = 1.01 WHERE `entry` = 28860;
UPDATE `creature_template` SET `mindmg` = 22905, `maxdmg` = 30735, `DamageModifier` = 1.01 WHERE `entry` = 31311;
/* MINI BOSS */ 
