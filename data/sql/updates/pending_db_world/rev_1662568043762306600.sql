...
(25, @GOSSIP_MENU_ID2, 0, 0, 0, 9, 0, @QUEST_ID, 0, 0, 0, 0, '', 'Requires Quest Taken'),
(25, @GOSSIP_MENU_ID2, 0, 0, 0, 2, 0, @ITEM_ID2, 2, 0, 2, 0, '', 'Requires Missing Item'),
(25, @GOSSIP_MENU_ID2, 0, 0, 0, 2, 0, @RUBBING_KIT, 2, 0, 0, 0, '', 'Requires Item'),
(35, @GOSSIP_MENU_ID3, 0, 0, 0, 9, 0, @QUEST_ID, 0, 0, 0, 0, '', 'Requires Quest Taken'),
(35, @GOSSIP_MENU_ID3, 0, 0, 0, 2, 0, @ITEM_ID3, 3, 0, 3, 0, '', 'Requires Missing Item'),
(35, @GOSSIP_MENU_ID3, 0, 0, 0, 2, 0, @RUBBING_KIT, 3, 0, 0, 0, '', 'Requires Item');
