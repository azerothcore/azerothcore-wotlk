...
UPDATE `gossip_menu_option` SET `OptionText` = 'Gloom`rel, tell me your secrets!', `OptionBroadcastTextID` = 4897 WHERE (`MenuID` = 1945) AND (`OptionID` IN (0));
UPDATE `gossip_menu_option` SET `OptionText` = 'I have paid your price, Gloom´rel.  Now, teach me your secrets!', `OptionBroadcastTextID` = 4900 WHERE (`MenuID` = 1945) AND (`OptionID` IN (1));
