...
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6825, `maxdmg` = 9470, `DamageModifier` = 1.01 WHERE `entry` = 30510;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 3784, `maxdmg` = 4420, `DamageModifier` = 1.01 WHERE `entry` = 26763;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6843, `maxdmg` = 9685, `DamageModifier` = 1.01 WHERE `entry` = 30529;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 3589, `maxdmg` = 4582, `DamageModifier` = 1.01 WHERE `entry` = 26794;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6541, `maxdmg` = 9912, `DamageModifier` = 1.01 WHERE `entry` = 30532;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 3627, `maxdmg` = 4876, `DamageModifier` = 1.01 WHERE `entry` = 26723;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 7583, `maxdmg` = 10106, `DamageModifier` = 1.01 WHERE `entry` = 30540;
