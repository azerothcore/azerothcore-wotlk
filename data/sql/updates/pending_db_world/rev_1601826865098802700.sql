...
UPDATE `creature_template` SET `mindmg` = 3422, `maxdmg` = 4367, `DamageModifier` = 1.01 WHERE `entry` = 26731;
UPDATE `creature_template` SET `mindmg` = 8907, `maxdmg` = 11952, `DamageModifier` = 1.01 WHERE `entry` = 30510;
UPDATE `creature_template` SET `mindmg` = 3784, `maxdmg` = 4420, `DamageModifier` = 1.01 WHERE `entry` = 26763;
UPDATE `creature_template` SET `mindmg` = 8907, `maxdmg` = 11952, `DamageModifier` = 1.01 WHERE `entry` = 30529;
UPDATE `creature_template` SET `mindmg` = 3589, `maxdmg` = 4582, `DamageModifier` = 1.01 WHERE `entry` = 26794;
UPDATE `creature_template` SET `mindmg` = 8907, `maxdmg` = 11952, `DamageModifier` = 1.01 WHERE `entry` = 30532;
UPDATE `creature_template` SET `mindmg` = 3627, `maxdmg` = 4876, `DamageModifier` = 1.01 WHERE `entry` = 26723;
