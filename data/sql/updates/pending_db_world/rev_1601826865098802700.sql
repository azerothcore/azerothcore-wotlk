...
/* BOSS */
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6750, `maxdmg` = 8350, `DamageModifier` = 1.01 WHERE `entry` = 26798;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6750, `maxdmg` = 8350, `DamageModifier` = 1.01 WHERE `entry` = 26796;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 2422, `maxdmg` = 3576, `DamageModifier` = 1.01 WHERE `entry` = 26731;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6875, `maxdmg` = 8260, `DamageModifier` = 1.01 WHERE `entry` = 30510;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 2584, `maxdmg` = 3667, `DamageModifier` = 1.01 WHERE `entry` = 26763;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6853, `maxdmg` = 8268, `DamageModifier` = 1.01 WHERE `entry` = 30529;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 2769, `maxdmg` = 3952, `DamageModifier` = 1.01 WHERE `entry` = 26794;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 7141, `maxdmg` = 9840, `DamageModifier` = 1.01 WHERE `entry` = 30532;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 2747, `maxdmg` = 4121, `DamageModifier` = 1.01 WHERE `entry` = 26723;
UPDATE `creature_template` SET `type_flags`=`type_flags`|4, `mindmg` = 6583, `maxdmg` = 9106, `DamageModifier` = 1.01 WHERE `entry` = 30540;
