DELETE FROM `reference_loot_template` WHERE (`Entry` = 526791);
...
DELETE FROM `reference_loot_template` WHERE (`Entry` = 526792);
INSERT INTO `reference_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
...
DELETE FROM `item_loot_template` WHERE (`Entry` = 25424) AND (`Item` IN (21929, 23077, 23079, 23107, 23112, 23117, 23436, 23437, 23438, 23439, 23440, 23441, 0, 1, 2, 3));
INSERT INTO `item_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
(25424, 0, 526791, 100, 0, 1, 0, 1, 1, ''),
(25424, 1, 526791, 100, 0, 1, 1, 1, 1, ''),
(25424, 2, 526791, 10, 0, 1, 2, 1, 1, ''),
(25424, 3, 526792, 12, 0, 1, 0, 1, 1, '');
...
INSERT INTO `item_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
(25419, 0, 526791, 100, 0, 1, 0, 1, 1, ''),
(25419, 1, 526791, 100, 0, 1, 1, 1, 1, ''),
(25419, 2, 526791, 10, 0, 1, 2, 1, 1, ''),
(25419, 3, 526792, 12, 0, 1, 0, 1, 1, '');
...
INSERT INTO `item_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
(25422, 0, 526791, 100, 0, 1, 0, 1, 1, ''),
(25422, 1, 526791, 100, 0, 1, 1, 1, 1, ''),
(25422, 2, 526791, 34, 0, 1, 2, 1, 1, ''),
(25422, 3, 526792, 66, 0, 1, 0, 1, 1, '');
...
INSERT INTO `item_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
(25423, 0, 526791, 100, 0, 1, 0, 1, 1, ''),
(25423, 1, 526791, 100, 0, 1, 1, 1, 1, ''),
(25423, 2, 526791, 40, 0, 1, 2, 1, 1, ''),
(25423, 3, 526792, 100, 0, 1, 0, 1, 1, ''),
(25423, 4, 526792, 50, 0, 1, 1, 1, 1, '');
