...
UPDATE `creature_template` SET `npcflag` = `npcflag` | 2 WHERE (`entry` IN (16484, 16493, 16495));

DELETE FROM `creature_queststarter` WHERE (`quest` IN (9261, 9262)) AND (`id` IN (16484, 16493, 16495));
INSERT INTO `creature_queststarter` (`id`, `quest`) VALUES
(16484, 9261), -- Lieutenant Nevell
(16495, 9262), -- Lieutenant Beitha
(16493, 9263); -- Lieutenant Dagel

DELETE FROM `creature_questender` WHERE (`quest` IN (9261, 9262)) AND (`id` IN (16484, 16493, 16495));
