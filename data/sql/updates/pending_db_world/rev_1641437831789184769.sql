...
UPDATE `_acore_world`.`smart_scripts` SET `id`='2' WHERE  `entryorguid`=2362200 AND `source_type`=9 AND `id`=3 AND `link`=0;
UPDATE `_acore_world`.`smart_scripts` SET `id`='3' WHERE  `entryorguid`=2362200 AND `source_type`=9 AND `id`=4 AND `link`=0;
