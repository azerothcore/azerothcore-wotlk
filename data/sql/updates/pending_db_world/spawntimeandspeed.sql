...
DELETE FROM `pool_template` WHERE `entry`=1077 AND `description`='Akkrilus (3773)';
INSERT INTO `pool_template` (`entry`, `max_limit`, `description`) VALUES (1077, 1, 'Akkrilus (3773)');
...
(51883,1077,'Akkrilus (3773) - Spawn 1'),
(52022,1077,'Akkrilus (3773) - Spawn 2');
...
DELETE FROM `pool_template` WHERE `entry`=1047 AND `description`='Mugglefin (10643)';
INSERT INTO `pool_template` (`entry`, `max_limit`, `description`) VALUES (1047, 1, 'Mugglefin (10643)');

DELETE FROM `pool_creature` WHERE `pool_entry`=1047 AND `guid` IN (51884, 51887);
INSERT INTO `pool_creature` (`guid`, `pool_entry`, `description`) VALUES
(51884,1047,'Mugglefin (10643) - Spawn 1'),
(51887,1047,'Mugglefin (10643) - Spawn 2');
-- Ursol lok
