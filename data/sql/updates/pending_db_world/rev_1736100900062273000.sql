...
DELETE FROM `conditions` WHERE (`SourceTypeOrReferenceId` = 13) AND (`SourceGroup` = 1) AND (`SourceEntry` = 23359) AND (`SourceId` = 0) AND (`ElseGroup` = null) AND (`ConditionTypeOrReference` = 31) AND (`ConditionTarget` = 0) AND (`ConditionValue1` = 3) AND (`ConditionValue2` = 5359) AND (`ConditionValue3` = 0);
INSERT INTO `conditions` (`SourceTypeOrReferenceId`, `SourceGroup`, `SourceEntry`, `SourceId`, `ElseGroup`, `ConditionTypeOrReference`, `ConditionTarget`, `ConditionValue1`, `ConditionValue2`, `ConditionValue3`, `NegativeCondition`, `ErrorType`, `ErrorTextId`, `ScriptName`, `Comment`) VALUES
(13, 1, 23359, 0, 0, 31, 0, 3, 5359, 0, 0, 0, 0, '', 'Spell 23359 targets Shore Strider'),
(13, 1, 23359, 0, 1, 31, 0, 3, 5360, 0, 0, 0, 0, '', 'Spell 23359 targets Deep Strider'),
(13, 1, 23359, 0, 2, 31, 0, 3, 5357, 0, 0, 0, 0, '', 'Spell 23359 targets Land Walker'),
(13, 1, 23359, 0, 3, 31, 0, 3, 5361, 0, 0, 0, 0, '', 'Spell 23359 targets Wave Strider'),
(13, 1, 23359, 0, 4, 31, 0, 3, 5358, 0, 0, 0, 0, '', 'Spell 23359 targets Cliff Giant');
