...
/* BOSS */ 
UPDATE `creature_template` SET `mindmg` = 27250, `maxdmg` = 36490, `DamageModifier` = 1.01 WHERE `entry` = 10184;
UPDATE `creature_template` SET `mindmg` = 66730, `maxdmg` = 79890, `DamageModifier` = 1.01 WHERE `entry` = 36538;
