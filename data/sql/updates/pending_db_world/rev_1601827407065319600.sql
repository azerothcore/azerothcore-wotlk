...
/* BOSS */ 
UPDATE `creature_template` SET `mindmg` = 26250, `maxdmg` = 35490, `DamageModifier` = 1.01 WHERE `entry` = 10184;
UPDATE `creature_template` SET `mindmg` = 65730, `maxdmg` = 78890, `DamageModifier` = 1.01 WHERE `entry` = 36538;
