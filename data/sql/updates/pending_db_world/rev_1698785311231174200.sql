...
-- set correct default modelids for goblin commoner
UPDATE `creature_template` SET `modelid1`=19340, `modelid2`=19343 WHERE `entry` = 20102;
...
-- dress commoners depending on each event
...
-- TODO: Add (random(?)) mug on brewfest

-- TODO: GOSSIP Children's week
-- TODO: npc_text Children's week

-- TODO: GOSSIP Spirit of Competition (update for all commoners)
-- TODO: npc_text Spirit of Competition
