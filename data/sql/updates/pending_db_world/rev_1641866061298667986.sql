...
-- Maraudon CTM
DELETE FROM `creature_template_movement` WHERE `CreatureId` IN (12223, 12207, 13323, 12216, 12217, 11790, 11791, 11792, 13141, 12236, 13142, 11345, 11685, 11785, 12222, 12221, 13282);
