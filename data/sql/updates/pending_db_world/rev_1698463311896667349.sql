...
-- Update comments
UPDATE `creature_text` SET `comment`='Zealot LorKhan - EMOTE_DIES' WHERE `CreatureID`=11347 AND `GroupID`=0 AND `ID`=0;

-- Zealot Zath (11348)
-- Update comments
UPDATE `creature_text` SET `comment`='Zealot Zath - EMOTE_DIES' WHERE `CreatureID`=11348 AND `GroupID`=0 AND `ID`=0;
