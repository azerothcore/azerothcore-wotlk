...
DELETE FROM `smart_scripts` WHERE `entryorguid` IN (334500, 334600, 334700, 334800, 652300, 652400, 652500, 652600, 652700, 737200, 737300, 737400, 737500, 737600) AND (`source_type` = 9) AND (`id` IN (8, 17));
DELETE FROM `smart_scripts` WHERE `entryorguid` IN (334501, 334601, 334701, 334801, 652301, 652401, 652501, 652601, 652701, 737201, 737301, 737401, 737501, 737601) AND (`source_type` = 9) AND (`id` IN (2, 12, 21));
