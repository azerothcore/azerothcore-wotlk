...
DELETE FROM `smart_scripts` WHERE (`entryorguid` IN (334500, 334501, 334601, 334701, 334801, 652301, 652401, 652501, 652601, 652701, 737201, 737301, 737401, 737501)) AND (`source_type` = 9) AND (`id` IN (2, 12, 21));
