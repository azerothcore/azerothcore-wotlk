INSERT INTO `version_db_world` (`sql_rev`) VALUES ('1547025363587990275');
...
UPDATE creature_template SET ScriptName='npc_chess_square' WHERE entry=17208;
UPDATE creature_template SET ScriptName='npc_chess_square' WHERE entry=17316;