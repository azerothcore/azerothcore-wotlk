INSERT INTO version_db_world (`sql_rev`) VALUES ('1508083549660311600');

-- DB/Misc: Where Kings Walk & Warchief's Blessing Capital SAI
DELETE FROM `creature_text` WHERE `entry` IN (68,1756,1976,3296,14304);
