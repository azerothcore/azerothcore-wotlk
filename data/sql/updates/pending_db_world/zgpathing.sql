...
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`,`point`,`position_x`,`position_y`,`position_z`,`orientation`,`delay`,`move_type`,`action`,`action_chance`,`wpguid`) VALUES
(@PATH,1,-12109.016,-1733.4694,81.128365,0,1,0,0,100,0),
(@PATH,2,-12126.374,-1712.6376,81.54973,0,1,0,0,100,0),
(@PATH,3,-12119.152,-1699.4357,80.19984,0,1,0,0,100,0),
(@PATH,4,-12109.786,-1673.918,81.75428,0,1,0,0,100,0),
(@PATH,5,-12110.596,-1770.8281,80.44503,0,1,0,0,100,0),
(@PATH,6,-12123.266,-1737.255,80.456245,0,1,0,0,100,0),
(@PATH,7,-12113.903,-1710.5658,80.38689,0,1,0,0,100,0),
(@PATH,8,-12121.344,-1698.0533,80.446175,0,1,0,0,100,0),
(@PATH,9,-12121.573,-1669.267,82.0492,0,1,0,0,100,0),
(@PATH,10,-12107.469,-1754.7734,81.48701,0,1,0,0,100,0);
...
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`,`point`,`position_x`,`position_y`,`position_z`,`orientation`,`delay`,`move_type`,`action`,`action_chance`,`wpguid`) VALUES
(@PATH,1,-12138.63,-1670.5779,86.08012,0,1,0,0,100,0),
(@PATH,2,-12178.349,-1671.1046,102.82473,0,1,0,0,100,0),
(@PATH,3,-12181.912,-1689.7715,105.74636,0,1,0,0,100,0),
(@PATH,4,-12201.704,-1690.2086,116.51056,0,1,0,0,100,0),
(@PATH,5,-12221.841,-1669.8362,126.642395,0,1,0,0,100,0),
(@PATH,6,-12234.417,-1679.6523,128.77368,0,1,0,0,100,0),
(@PATH,7,-12243.223,-1672.7603,130.92725,0,1,0,0,100,0),
(@PATH,8,-12206.545,-1672.7595,118.35553,0,1,0,0,100,0),
(@PATH,9,-12192.366,-1692.4174,110.68044,0,1,0,0,100,0),
(@PATH,10,-12178.349,-1671.1046,102.82473,0,1,0,0,100,0),
(@PATH,11,-12150.866,-1670.7789,90.58817,0,1,0,0,100,0),
(@PATH,12,-12158.139,-1691.9014,93.26981,0,1,0,0,100,0);

DELETE FROM `creature_formations` WHERE `leaderguid` IN (49090, 49751, 49752, 49146, 49147, 49132, 49135, 49186, 49189, 52136, 49157, 49158, 49167, 49185, 51452, 49760, 49762, 49763, 49195);
