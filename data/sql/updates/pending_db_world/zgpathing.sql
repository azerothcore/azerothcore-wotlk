...
SET @NPC := 51581;
SET @path := @NPC * 10;
UPDATE `creature` SET `wander_distance`=0,`MovementType`=2,`position_x`=-11804.844,`position_y`=-1841.1769,`position_z`=48.976315 WHERE `guid`=@NPC;
DELETE FROM `creature_addon` WHERE `guid`=@NPC;
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`bytes1`,`bytes2`,`emote`,`visibilityDistanceType`,`auras`) VALUES (@NPC,@PATH,0,0,1,0,0, '');
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`,`point`,`position_x`,`position_y`,`position_z`,`orientation`,`delay`,`move_type`,`action`,`action_chance`,`wpguid`) VALUES
(@PATH,1,-11804.844,-1841.1769,48.976315,0,0,0,0,100,0),
(@PATH,2,-11803.281,-1829.0516,51.93177,0,0,0,0,100,0),
(@PATH,3,-11812.71,-1806.625,51.18641,0,0,0,0,100,0),
(@PATH,4,-11807.114,-1829.4645,51.509163,0,0,0,0,100,0),
(@PATH,5,-11803.139,-1843.1814,48.438473,0,0,0,0,100,0),
(@PATH,6,-11803.338,-1869.3596,45.86874,0,0,0,0,100,0),
(@PATH,7,-11803.68,-1887.6163,46.168545,0,0,0,0,100,0),
(@PATH,8,-11795.631,-1898.4612,49.308937,0,0,0,0,100,0),
(@PATH,9,-11803.338,-1869.3596,45.86874,0,0,0,0,100,0),
(@PATH,10,-11803.139,-1843.1814,48.438473,0,0,0,0,100,0),
(@PATH,11,-11807.114,-1829.4645,51.509163,0,0,0,0,100,0),
(@PATH,12,-11812.71,-1806.625,51.18641,0,0,0,0,100,0),
(@PATH,13,-11810.257,-1822.1285,51.294807,0,0,0,0,100,0),
(@PATH,14,-11803.281,-1829.0516,51.93177,0,0,0,0,100,0),
(@PATH,15,-11823.976,-1865.9132,51.44018,0,0,0,0,100,0),
(@PATH,16,-11820.966,-1879.9275,49.9371,0,0,0,0,100,0),
(@PATH,17,-11823.42,-1891.8147,51.139492,0,0,0,0,100,0),
(@PATH,18,-11811.245,-1899.2338,49.08163,0,0,0,0,100,0),
(@PATH,19,-11790.793,-1896.5391,48.659035,0,0,0,0,100,0),
(@PATH,20,-11787.242,-1882.6423,46.21836,0,0,0,0,100,0),
(@PATH,21,-11811.245,-1899.2338,49.08163,0,0,0,0,100,0),
(@PATH,22,-11823.42,-1891.8147,51.139492,0,0,0,0,100,0),
(@PATH,23,-11820.966,-1879.9275,49.9371,0,0,0,0,100,0),
(@PATH,24,-11823.976,-1865.9132,51.44018,0,0,0,0,100,0);
