...
-- 43 Gameobjects
DELETE FROM `gameobject` WHERE (`zoneId` = 4) AND (`id` IN (2040, 2047, 1734, 150079, 150082, 324));
DELETE FROM `gameobject` WHERE `guid` >= @FREE_GAMEOBJECT AND `guid` <= @FREE_GAMEOBJECT + 43;
