...
(@TOKENENTRY, 31089, 0, 0, 0, 1, 0, 1, 1, 'Chestguard of the Forgotten Conqueror'),
(@TOKENENTRY, 31090, 0, 0, 0, 1, 0, 1, 1, 'Chestguard of the Forgotten Vanquisher'),
(@TOKENENTRY, 31091, 0, 0, 0, 1, 0, 1, 1, 'Chestguard of the Forgotten Protector');

UPDATE `reference_loot_template` SET `GroupID` = 0 WHERE `ENTRY` = 34077;
...
(22917, 90077, @TOKENENTRY, 100, 0, 1, 0, 3, 3, 'Illidan Stormrage - (Tokens)');
