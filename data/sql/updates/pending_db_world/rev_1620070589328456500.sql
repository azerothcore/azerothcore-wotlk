...
-- Better text handling but still not fixed here
-- PENDING: Make Old Town Thug say GroupID 0 and Old Town Thug 1 then walk away then despawn
-- How it should work: https://youtu.be/otbvMtInvNc?t=35
