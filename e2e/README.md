...
| instances/classic/stratholme | Timmy activation; Supply Crate proximity/Open/Disarm lifecycle; linked-chest regressions | P2 | covered (`TestAC_26363_TimmyEmergesAfterSquareCleared`, `TestAC_12285_SupplyCrateProximityConsumesParent`, `TestAC_12285_SupplyCrateOpenAndDisarm`, `TestAC_12285_LinkedChestRegressionMatrix`, `TestAC_12285_PassYourRiteSummonsOneMilton`, `TestAC_12285_LandMineDisarmUsesRespawnDelay`); manual: unloaded-grid/respawn persistence and the three Supply Crate trap spells absent from the 3.3.5a client DBC | #12285 #26363 |
