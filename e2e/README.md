...
| instances/ulduar | named tele; Freya wave interval; Mechanolift combat drop | P2 | covered (`TestAC_27095_*`, `TestAC_27368_*`); Kologarn Charge `blocked-harness` (bridge Z after Charge) | #26266 #27095 #27368 |
