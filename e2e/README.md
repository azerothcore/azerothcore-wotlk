...
| spells/aura | apply/query; CC broken by damage; mount persist; paladin same-aura per-caster + Aura Mastery; Life Tap glyph under Despair | P1 | covered (`TestAC_26130_*`, `TestAC_25765_*`, `TestAC_27279_*`); Life Tap duplicate-proc/Mana Feed and Dark Pact need live coverage | #26130 #25765 #27279 |
