...
| instances/classic/stratholme | Timmy activation; Supply Crate proximity traps consume their parent crates | P2 | covered (`TestAC_26363_TimmyEmergesAfterSquareCleared`, `TestAC_12285_SupplyCrateProximityConsumesParent`); crate Open/Disarm and linked-trap regression matrix `blocked-harness` (gameobject-target casts and loot-release outcome require the next AzerothGhost release) | #12285 #26363 |
