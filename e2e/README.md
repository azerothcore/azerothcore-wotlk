...
| spells/channel | Acid Spray and Acid Geyser follow a moving target while rooted; damage follows the temporary taunter only for Acid Spray, returns after Taunt expires, stops after target death/channel end, and uses the next channel's own target | P1 | added, live execution pending (`TestAC_19917_AcidSprayChannel`, `TestAC_19921_AcidGeyserChannel`); controlled parent casts on a cleanup-owned threat-AI fixture, not boss target-selection or animation tests | #19917 #19921 |
