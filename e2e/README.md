...
| instances/ulduar/XT | Boombots in both raid sizes survive nonlethal hits, explode once on lethal damage or arrival at XT, damage only nearby players, and chain to other bots while retaining Scrapbot kill credit; checks AC's existing damage estimate, not an exact retail value | P2 | covered (`TestAC_27699_XTBoombotExplosion`); live execution pending | #27699 |
