...
- The AzerothCore source is released under the [GNU GPL v2 or later](https://github.com/azerothcore/azerothcore-wotlk/blob/master/LICENSE), the new file created from scratch are released under the GNU GPLv2+.
